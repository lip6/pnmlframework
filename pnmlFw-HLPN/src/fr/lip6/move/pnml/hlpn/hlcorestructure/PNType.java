 ...
 * <!-- end-user-doc -->
 * @see fr.lip6.move.pnml.hlpn.hlcorestructure.HlcorestructurePackage#getPNType()
 * @model
 * @generated
 */
public enum PNType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final PNType[] VALUES_ARRAY = new PNType[] { HLPN, COREMODEL, PTNET, SYMNET, };
