 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.hlpn.hlcorestructure.impl.PageImpl#getObjects <em>Objects</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.hlpn.hlcorestructure.impl.PageImpl#getContainerPetriNet <em>Container Petri Net</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.hlpn.hlcorestructure.impl.PageImpl#getNodegraphics <em>Nodegraphics</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.hlpn.hlcorestructure.impl.PageImpl#getDeclaration <em>Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PageImpl extends PnObjectImpl implements Page {
	...
	public String toPNML() {
		...
		if (getObjects() != null) {
			...
			java.util.List<fr.lip6.move.pnml.hlpn.hlcorestructure.PnObject> items = getObjects();
