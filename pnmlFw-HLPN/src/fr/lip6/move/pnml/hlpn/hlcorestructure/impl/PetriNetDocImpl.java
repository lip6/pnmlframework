 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.hlpn.hlcorestructure.impl.PetriNetDocImpl#getNets <em>Nets</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.hlpn.hlcorestructure.impl.PetriNetDocImpl#getXmlns <em>Xmlns</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PetriNetDocImpl extends MinimalEObjectImpl implements PetriNetDoc {
	...
	public String toPNML() {
		...
		if (getNets() != null) {
			...
			java.util.List<fr.lip6.move.pnml.hlpn.hlcorestructure.PetriNet> items = getNets();
