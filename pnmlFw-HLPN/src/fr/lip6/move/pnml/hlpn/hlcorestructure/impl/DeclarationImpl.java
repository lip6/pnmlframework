 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.hlpn.hlcorestructure.impl.DeclarationImpl#getStructure <em>Structure</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.hlpn.hlcorestructure.impl.DeclarationImpl#getContainerDeclarationPetriNet <em>Container Declaration Petri Net</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.hlpn.hlcorestructure.impl.DeclarationImpl#getContainerDeclarationPage <em>Container Declaration Page</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public void fromPNML(OMElement locRoot, IdRefLinker idr) throws InnerBuildException, InvalidIDException,
		...
		for (Iterator iterator = locRoot.getChildElements(); iterator.hasNext();) {
			...
			if (type.getLocalName().equals("structure")) {
				...
				fr.lip6.move.pnml.hlpn.terms.Declarations item = null;
