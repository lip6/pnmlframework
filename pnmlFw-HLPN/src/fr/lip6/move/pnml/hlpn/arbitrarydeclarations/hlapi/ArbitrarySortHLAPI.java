...
public class ArbitrarySortHLAPI implements HLAPIClass,TermsDeclarationHLAPI,SortDeclHLAPI{
	 ...
	 */
	public ArbitrarySortHLAPI(ArbitrarySort lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public ArbitrarySort getContainedItem(){
		return item;
	}
	...
	//equals method
	public boolean equals(ArbitrarySortHLAPI item){
