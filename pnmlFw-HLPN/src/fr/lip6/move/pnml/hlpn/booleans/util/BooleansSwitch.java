...
public class BooleansSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case BooleansPackage.INEQUALITY: {
			...
			if (result == null)
				result = caseOperator(inequality);
			if (result == null)
				result = caseTerm(inequality);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BooleansPackage.BOOLEAN_CONSTANT: {
			...
			if (result == null)
				result = caseBuiltInConstant(booleanConstant);
			if (result == null)
		...
		case BooleansPackage.BOOLEAN_OPERATOR: {
			...
			if (result == null)
				result = caseBuiltInOperator(booleanOperator);
			if (result == null)
		...
		case BooleansPackage.AND: {
			...
			if (result == null)
				result = caseBuiltInOperator(and);
			if (result == null)
		...
		case BooleansPackage.IMPLY: {
			...
			if (result == null)
				result = caseBooleanOperator(imply);
			if (result == null)
				result = caseBuiltInOperator(imply);
			if (result == null)
				result = caseOperator(imply);
			if (result == null)
				result = caseTerm(imply);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case BooleansPackage.NOT: {
			...
			if (result == null)
				result = caseBuiltInOperator(not);
			if (result == null)
