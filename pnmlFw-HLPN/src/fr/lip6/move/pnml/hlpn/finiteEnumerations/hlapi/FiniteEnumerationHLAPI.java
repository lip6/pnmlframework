...
public class FiniteEnumerationHLAPI implements HLAPIClass,SortHLAPI{

	/**
	 * The contained LLAPI element.
	 */
	private FiniteEnumeration item;
	...
	public FiniteEnumerationHLAPI(){//BEGIN CONSTRUCTOR BODY
		FiniteEnumerationsFactory fact = FiniteEnumerationsFactoryImpl.eINSTANCE;
		synchronized(fact){item = fact.createFiniteEnumeration();}
	 ...
	 */
	public FiniteEnumerationHLAPI(FiniteEnumeration lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public FiniteEnumeration getContainedItem(){
		return item;
	}
	...
	//getters giving HLAPI object
		...
		public java.util.List<FEConstantHLAPI> getElementsHLAPI(){
			java.util.List<FEConstantHLAPI> retour = new ArrayList<FEConstantHLAPI>();
			for (FEConstant elemnt : getElements()) {
				retour.add(new FEConstantHLAPI(elemnt));
			}
			return retour;
		}
	...
	public void addElementsHLAPI(FEConstantHLAPI unit){
	
		item.getElements().add((FEConstant)unit.getContainedItem());
	}

	public void removeElementsHLAPI(FEConstantHLAPI unit){
		item.getElements().remove((FEConstant)unit.getContainedItem());
	}
	

	//equals method
	public boolean equals(FiniteEnumerationHLAPI item){
