 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.hlpn.terms.impl.UserSortImpl#getDeclaration <em>Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UserSortImpl extends SortImpl implements UserSort {
	...
	public void idRefHang(ArrayList<Object> oList) {
		...
		this.setDeclaration((fr.lip6.move.pnml.hlpn.terms.SortDecl) oList.get(0));
