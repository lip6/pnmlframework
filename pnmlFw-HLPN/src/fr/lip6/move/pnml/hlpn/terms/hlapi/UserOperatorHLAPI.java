    ...
    */
	...
	//getters giving HLAPI object
		...
		public OperatorDeclHLAPI getDeclarationHLAPI(){
			...
			if(object.getClass().equals(fr.lip6.move.pnml.hlpn.terms.impl.NamedOperatorImpl.class)){
				return new fr.lip6.move.pnml.hlpn.terms.hlapi.NamedOperatorHLAPI((fr.lip6.move.pnml.hlpn.terms.NamedOperator)object);
			}
			
			if(object.getClass().equals(fr.lip6.move.pnml.hlpn.arbitrarydeclarations.impl.ArbitraryOperatorImpl.class)){
				return new fr.lip6.move.pnml.hlpn.arbitrarydeclarations.hlapi.ArbitraryOperatorHLAPI((fr.lip6.move.pnml.hlpn.arbitrarydeclarations.ArbitraryOperator)object);
			}
			
			if(object.getClass().equals(fr.lip6.move.pnml.hlpn.finiteEnumerations.impl.FEConstantImpl.class)){
				return new fr.lip6.move.pnml.hlpn.finiteEnumerations.hlapi.FEConstantHLAPI((fr.lip6.move.pnml.hlpn.finiteEnumerations.FEConstant)object);
			}
			
			if(object.getClass().equals(fr.lip6.move.pnml.hlpn.partitions.impl.PartitionElementImpl.class)){
				return new fr.lip6.move.pnml.hlpn.partitions.hlapi.PartitionElementHLAPI((fr.lip6.move.pnml.hlpn.partitions.PartitionElement)object);
			}
