 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.hlpn.terms.Operator#getSubterm <em>Subterm</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.hlpn.terms.Operator#getOutput <em>Output</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.hlpn.terms.Operator#getInput <em>Input</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.lip6.move.pnml.hlpn.terms.TermsPackage#getOperator()
 * @model abstract="true"
...
public interface Operator extends Term {
	 ...
	 * It is bidirectional and its opposite is '{@link fr.lip6.move.pnml.hlpn.terms.Term#getContainerOperator <em>Container Operator</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see fr.lip6.move.pnml.hlpn.terms.TermsPackage#getOperator_Subterm()
	 ...
	 * @see #setOutput(Sort)
	 * @see fr.lip6.move.pnml.hlpn.terms.TermsPackage#getOperator_Output()
	...
	/**
	 * Sets the value of the '{@link fr.lip6.move.pnml.hlpn.terms.Operator#getOutput <em>Output</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fr.lip6.move.pnml.hlpn.terms.TermsPackage#getOperator_Input()
	 * @model derived="true"
	 * @generated
	 */
	List<Sort> getInput();
