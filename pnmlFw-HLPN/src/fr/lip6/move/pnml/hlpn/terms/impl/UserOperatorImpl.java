 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.hlpn.terms.impl.UserOperatorImpl#getDeclaration <em>Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UserOperatorImpl extends OperatorImpl implements UserOperator {
	...
	public void idRefHang(ArrayList<Object> oList) {
		...
		this.setDeclaration((fr.lip6.move.pnml.hlpn.terms.OperatorDecl) oList.get(0));
