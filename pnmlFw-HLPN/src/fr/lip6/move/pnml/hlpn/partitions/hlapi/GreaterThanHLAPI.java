...
public class GreaterThanHLAPI implements HLAPIClass,TermHLAPI,OperatorHLAPI{
	 ...
	 */
	private fr.lip6.move.pnml.hlpn.partitions.GreaterThan item;
    ...
    */
	 ...
	 */
	public GreaterThanHLAPI(fr.lip6.move.pnml.hlpn.partitions.GreaterThan lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public fr.lip6.move.pnml.hlpn.partitions.GreaterThan getContainedItem(){
		return item;
	}
