 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.hlpn.lists.impl.MemberAtIndexImpl#getIndex <em>Index</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MemberAtIndexImpl extends ListOperatorImpl implements MemberAtIndex {
	...
	public void fromPNML(OMElement locRoot, IdRefLinker idr) throws InnerBuildException, InvalidIDException,
		...
		if (locRoot.getAttributeValue(new QName("index")) != null) {
			try {
				this.setIndex(new Integer(locRoot.getAttributeValue(new QName("index"))));
			} catch (Exception e) {
