 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.hlpn.lists.impl.EmptyListImpl#getRefsort <em>Refsort</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EmptyListImpl extends BuiltInConstantImpl implements EmptyList {
	/**
	...
	public NotificationChain basicSetRefsort(Sort newRefsort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ListsPackage.EMPTY_LIST__REFSORT, oldRefsort, newRefsort);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setRefsort(Sort newRefsort) {
		if (newRefsort != refsort) {
			...
			if (refsort != null)
				msgs = ((InternalEObject) refsort).eInverseRemove(this, TermsPackage.SORT__CONTAINER_EMPTY_LIST,
						Sort.class, msgs);
			if (newRefsort != null)
				msgs = ((InternalEObject) newRefsort).eInverseAdd(this, TermsPackage.SORT__CONTAINER_EMPTY_LIST,
						Sort.class, msgs);
			msgs = basicSetRefsort(newRefsort, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ListsPackage.EMPTY_LIST__REFSORT, newRefsort,
					newRefsort));
	}
		...
		case ListsPackage.EMPTY_LIST__REFSORT:
			if (refsort != null)
				msgs = ((InternalEObject) refsort).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- ListsPackage.EMPTY_LIST__REFSORT, null, msgs);
