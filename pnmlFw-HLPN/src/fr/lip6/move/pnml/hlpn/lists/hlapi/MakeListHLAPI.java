...
public class MakeListHLAPI implements HLAPIClass,TermHLAPI,OperatorHLAPI{

	/**
	 * The contained LLAPI element.
	 */
	private MakeList item;
	...
	public MakeListHLAPI(
		...
		synchronized(fact){item = fact.createMakeList();}
    ...
    */
	 ...
	 */
	public MakeListHLAPI(MakeList lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public MakeList getContainedItem(){
		return item;
	}
	...
	//equals method
	public boolean equals(MakeListHLAPI item){
