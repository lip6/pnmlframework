...
public class EmptyListHLAPI implements HLAPIClass,TermHLAPI,OperatorHLAPI{

	/**
	 * The contained LLAPI element.
	 */
	private EmptyList item;
	...
	public EmptyListHLAPI(
		...
		synchronized(fact){item = fact.createEmptyList();}
    ...
    */
	 ...
	 */
	public EmptyListHLAPI(EmptyList lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public EmptyList getContainedItem(){
		return item;
	}
	...
	//equals method
	public boolean equals(EmptyListHLAPI item){
