...
public class SublistHLAPI implements HLAPIClass,TermHLAPI,OperatorHLAPI{

	/**
	 * The contained LLAPI element.
	 */
	private Sublist item;
	...
	public SublistHLAPI(
		...
		synchronized(fact){item = fact.createSublist();}
    ...
    */
	 ...
	 */
	public SublistHLAPI(Sublist lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public Sublist getContainedItem(){
		return item;
	}
	...
	//equals method
	public boolean equals(SublistHLAPI item){
