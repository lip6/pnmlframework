...
public class MemberAtIndexHLAPI implements HLAPIClass,TermHLAPI,OperatorHLAPI{

	/**
	 * The contained LLAPI element.
	 */
	private MemberAtIndex item;
	...
	public MemberAtIndexHLAPI(
		...
		synchronized(fact){item = fact.createMemberAtIndex();}
    ...
    */
	 ...
	 */
	public MemberAtIndexHLAPI(MemberAtIndex lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public MemberAtIndex getContainedItem(){
		return item;
	}
	...
	//equals method
	public boolean equals(MemberAtIndexHLAPI item){
