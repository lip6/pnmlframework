 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.hlpn.lists.impl.MakeListImpl#getRefsort <em>Refsort</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MakeListImpl extends ListOperatorImpl implements MakeList {
	...
	public NotificationChain basicSetRefsort(Sort newRefsort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ListsPackage.MAKE_LIST__REFSORT, oldRefsort, newRefsort);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setRefsort(Sort newRefsort) {
		if (newRefsort != refsort) {
			...
			if (refsort != null)
				msgs = ((InternalEObject) refsort).eInverseRemove(this, TermsPackage.SORT__CONTAINER_MAKE_LIST,
						Sort.class, msgs);
			if (newRefsort != null)
				msgs = ((InternalEObject) newRefsort).eInverseAdd(this, TermsPackage.SORT__CONTAINER_MAKE_LIST,
						Sort.class, msgs);
			msgs = basicSetRefsort(newRefsort, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ListsPackage.MAKE_LIST__REFSORT, newRefsort,
					newRefsort));
	}
		...
		case ListsPackage.MAKE_LIST__REFSORT:
			if (refsort != null)
				msgs = ((InternalEObject) refsort).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- ListsPackage.MAKE_LIST__REFSORT, null, msgs);
	...
	public void fromPNML(OMElement locRoot, IdRefLinker idr) throws InnerBuildException, InvalidIDException,
		...
		for (Iterator iterator = locRoot.getChildElements(); iterator.hasNext();) {
			...
			if (type.getLocalName().equals("list")) {
				...
				item.setContainerMakeList(this);
