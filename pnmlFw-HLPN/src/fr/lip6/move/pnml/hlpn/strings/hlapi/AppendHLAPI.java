...
public class AppendHLAPI implements HLAPIClass,TermHLAPI,OperatorHLAPI{

	/**
	 * The contained LLAPI element.
	 */
	private fr.lip6.move.pnml.hlpn.strings.Append item;
	...
	public AppendHLAPI(
		...
		synchronized(fact){item = fact.createAppend();}
    ...
    */
	 ...
	 */
	public AppendHLAPI(fr.lip6.move.pnml.hlpn.strings.Append lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public fr.lip6.move.pnml.hlpn.strings.Append getContainedItem(){
		return item;
	}
	...
	//equals method
	public boolean equals(AppendHLAPI item){
