...
public class SubstringHLAPI implements HLAPIClass,TermHLAPI,OperatorHLAPI{

	/**
	 * The contained LLAPI element.
	 */
	private Substring item;
	...
	public SubstringHLAPI(
		...
		synchronized(fact){item = fact.createSubstring();}
    ...
    */
	 ...
	 */
	public SubstringHLAPI(Substring lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public Substring getContainedItem(){
		return item;
	}
	...
	//equals method
	public boolean equals(SubstringHLAPI item){
