...
public class HLPNStringHLAPI implements HLAPIClass,SortHLAPI{
	...
	public HLPNStringHLAPI(){//BEGIN CONSTRUCTOR BODY
		StringsFactory fact = StringsFactoryImpl.eINSTANCE;
		synchronized(fact){item = fact.createHLPNString();}
	 ...
	 */
	public HLPNStringHLAPI(HLPNString lowLevelAPI){
		item = lowLevelAPI;
	}
	...
	//equals method
	public boolean equals(HLPNStringHLAPI item){
