...
public class ConcatenationHLAPI implements HLAPIClass,TermHLAPI,OperatorHLAPI{

	/**
	 * The contained LLAPI element.
	 */
	private fr.lip6.move.pnml.hlpn.strings.Concatenation item;
	...
	public ConcatenationHLAPI(
		 SortHLAPI sort
	
		, SortHLAPI output
	){//BEGIN CONSTRUCTOR BODY
		StringsFactory fact = StringsFactoryImpl.eINSTANCE;
		synchronized(fact){item = fact.createConcatenation();}
    ...
    */
	 ...
	 */
	public ConcatenationHLAPI(fr.lip6.move.pnml.hlpn.strings.Concatenation lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public fr.lip6.move.pnml.hlpn.strings.Concatenation getContainedItem(){
		return item;
	}
	...
	//equals method
	public boolean equals(ConcatenationHLAPI item){
