...
public class LengthHLAPI implements HLAPIClass,TermHLAPI,OperatorHLAPI{

	/**
	 * The contained LLAPI element.
	 */
	private fr.lip6.move.pnml.hlpn.strings.Length item;
	...
	public LengthHLAPI(
		...
		synchronized(fact){item = fact.createLength();}
    ...
    */
	 ...
	 */
	public LengthHLAPI(fr.lip6.move.pnml.hlpn.strings.Length lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public fr.lip6.move.pnml.hlpn.strings.Length getContainedItem(){
		return item;
	}
	...
	//equals method
	public boolean equals(LengthHLAPI item){
