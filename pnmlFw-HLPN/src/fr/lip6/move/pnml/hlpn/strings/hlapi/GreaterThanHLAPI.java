...
public class GreaterThanHLAPI implements HLAPIClass,TermHLAPI,OperatorHLAPI{
	 ...
	 */
	private fr.lip6.move.pnml.hlpn.strings.GreaterThan item;
    ...
    */
	 ...
	 */
	public GreaterThanHLAPI(fr.lip6.move.pnml.hlpn.strings.GreaterThan lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public fr.lip6.move.pnml.hlpn.strings.GreaterThan getContainedItem(){
		return item;
	}
