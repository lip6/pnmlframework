 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see fr.lip6.move.pnml.hlpn.dots.DotsFactory
 * @model kind="package"
 * @generated
 */
public interface DotsPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http:///hlpn.dots.ecore";
	 ...
	 * @generated
	 */
	DotsPackage eINSTANCE = fr.lip6.move.pnml.hlpn.dots.impl.DotsPackageImpl.init();

	/**
	 * The meta object id for the '{@link fr.lip6.move.pnml.hlpn.dots.impl.DotImpl <em>Dot</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see fr.lip6.move.pnml.hlpn.dots.impl.DotImpl
	 * @see fr.lip6.move.pnml.hlpn.dots.impl.DotsPackageImpl#getDot()
	 * @generated
	 */
	int DOT = 0;
	 ...
	 * @ordered
	 */
	int DOT__CONTAINER_LIST = TermsPackage.BUILT_IN_SORT__CONTAINER_LIST;
	 ...
	 * @ordered
	 */
	int DOT__CONTAINER_EMPTY_LIST = TermsPackage.BUILT_IN_SORT__CONTAINER_EMPTY_LIST;
	 ...
	 * @ordered
	 */
	int DOT__CONTAINER_MAKE_LIST = TermsPackage.BUILT_IN_SORT__CONTAINER_MAKE_LIST;
	...
	/**
	 * The meta object id for the '{@link fr.lip6.move.pnml.hlpn.dots.impl.DotConstantImpl <em>Dot Constant</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see fr.lip6.move.pnml.hlpn.dots.impl.DotConstantImpl
	 * @see fr.lip6.move.pnml.hlpn.dots.impl.DotsPackageImpl#getDotConstant()
	 * @generated
	 */
	int DOT_CONSTANT = 1;
	...
	/**
	 * Returns the meta object for class '{@link fr.lip6.move.pnml.hlpn.dots.Dot <em>Dot</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Dot</em>'.
	 * @see fr.lip6.move.pnml.hlpn.dots.Dot
	 * @generated
	 */
	EClass getDot();

	/**
	 * Returns the meta object for class '{@link fr.lip6.move.pnml.hlpn.dots.DotConstant <em>Dot Constant</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Dot Constant</em>'.
	 * @see fr.lip6.move.pnml.hlpn.dots.DotConstant
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link fr.lip6.move.pnml.hlpn.dots.impl.DotImpl <em>Dot</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see fr.lip6.move.pnml.hlpn.dots.impl.DotImpl
		 * @see fr.lip6.move.pnml.hlpn.dots.impl.DotsPackageImpl#getDot()
		...
		/**
		 * The meta object literal for the '{@link fr.lip6.move.pnml.hlpn.dots.impl.DotConstantImpl <em>Dot Constant</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see fr.lip6.move.pnml.hlpn.dots.impl.DotConstantImpl
		 * @see fr.lip6.move.pnml.hlpn.dots.impl.DotsPackageImpl#getDotConstant()
