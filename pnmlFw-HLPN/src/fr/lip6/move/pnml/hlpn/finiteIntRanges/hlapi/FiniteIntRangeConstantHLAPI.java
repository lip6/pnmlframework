...
public class FiniteIntRangeConstantHLAPI implements HLAPIClass,TermHLAPI,OperatorHLAPI{

	/**
	 * The contained LLAPI element.
	 */
	private FiniteIntRangeConstant item;
	...
	public FiniteIntRangeConstantHLAPI(
		...
		synchronized(fact){item = fact.createFiniteIntRangeConstant();}
 		...
 		if(range!=null)
			item.setRange((FiniteIntRange)range.getContainedItem());
    ...
    */
	 ...
	 */
	public FiniteIntRangeConstantHLAPI(FiniteIntRangeConstant lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public FiniteIntRangeConstant getContainedItem(){
		return item;
	}
	...
	//getters giving HLAPI object
		...
		public FiniteIntRangeHLAPI getRangeHLAPI(){
			if(item.getRange() == null) return null;
			return new FiniteIntRangeHLAPI(item.getRange());
		}
	 ...
	 * set Range
	 */
	public void setRangeHLAPI(
	
	FiniteIntRangeHLAPI elem){
	
	
 		if(elem!=null)
			item.setRange((FiniteIntRange)elem.getContainedItem());
	...
	//equals method
	public boolean equals(FiniteIntRangeConstantHLAPI item){
