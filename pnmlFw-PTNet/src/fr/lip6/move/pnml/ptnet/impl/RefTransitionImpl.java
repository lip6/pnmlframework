 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.ptnet.impl.RefTransitionImpl#getRef <em>Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RefTransitionImpl extends TransitionNodeImpl implements RefTransition {
	...
	protected EClass eStaticClass() {
		return PtnetPackage.Literals.REF_TRANSITION;
	}
		...
		if (ref != null && ref.eIsProxy()) {
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PtnetPackage.REF_TRANSITION__REF, oldRef,
							ref));
			}
		}
		return ref;
	...
	public NotificationChain basicSetRef(TransitionNode newRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PtnetPackage.REF_TRANSITION__REF, oldRef, newRef);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRef != ref) {
			...
			if (ref != null)
				msgs = ((InternalEObject) ref).eInverseRemove(this,
						PtnetPackage.TRANSITION_NODE__REFERENCING_TRANSITIONS, TransitionNode.class, msgs);
			if (newRef != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PtnetPackage.REF_TRANSITION__REF, newRef, newRef));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PtnetPackage.REF_TRANSITION__REF:
			if (ref != null)
				msgs = ((InternalEObject) ref).eInverseRemove(this,
						PtnetPackage.TRANSITION_NODE__REFERENCING_TRANSITIONS, TransitionNode.class, msgs);
	...
	public void idRefHang(ArrayList<Object> oList) {
		...
		this.setRef((fr.lip6.move.pnml.ptnet.TransitionNode) oList.get(0));
