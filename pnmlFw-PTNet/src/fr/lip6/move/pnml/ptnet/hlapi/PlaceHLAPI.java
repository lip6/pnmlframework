...
public class PlaceHLAPI implements HLAPIClass,PnObjectHLAPI,NodeHLAPI,PlaceNodeHLAPI{
	...
	public PlaceHLAPI(
		...
		synchronized(fact){item = fact.createPlace();}
 		...
 		if(initialMarking!=null)
			item.setInitialMarking((PTMarking)initialMarking.getContainedItem());
    ...
    */
	...
	//getters giving HLAPI object
		...
		public PTMarkingHLAPI getInitialMarkingHLAPI(){
			if(item.getInitialMarking() == null) return null;
			return new PTMarkingHLAPI(item.getInitialMarking());
		}
	 ...
	 * set InitialMarking
	 */
	public void setInitialMarkingHLAPI(
	
	PTMarkingHLAPI elem){
	
	
 		if(elem!=null)
			item.setInitialMarking((PTMarking)elem.getContainedItem());
