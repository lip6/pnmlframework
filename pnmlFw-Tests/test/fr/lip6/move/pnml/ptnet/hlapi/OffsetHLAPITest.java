...
public class OffsetHLAPITest {
	...
	public void After() {
	    System.out.println("done for "+"OffsetHLAPI(ptnet)");
	}
    ...
    */
	...
	public void OffsetHLAPI_LLAPI(){
	   Offset llapi = new PtnetFactoryImpl().createOffset();
	   fr.lip6.move.pnml.ptnet.hlapi.OffsetHLAPI hlapi = new OffsetHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getContainerAnnotationGraphicsHLAPITest(){
			OffsetHLAPI elem = new OffsetHLAPI(new PtnetFactoryImpl().createOffset());
	...
	public void equalsTest(){
		Offset a = new PtnetFactoryImpl().createOffset();
		Offset b = new PtnetFactoryImpl().createOffset();
