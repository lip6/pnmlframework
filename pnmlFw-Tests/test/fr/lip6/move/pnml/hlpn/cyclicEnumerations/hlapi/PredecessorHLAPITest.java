...
public class PredecessorHLAPITest {
	...
	mr.createDocumentWorkspace("void");
			...
			itemsort = new fr.lip6.move.pnml.hlpn.cyclicEnumerations.hlapi.CyclicEnumerationHLAPI(
			...
			itemoutput = new fr.lip6.move.pnml.hlpn.cyclicEnumerations.hlapi.CyclicEnumerationHLAPI(
				new CyclicEnumerationsFactoryImpl().createCyclicEnumeration()
			);
		...
		itemcontainerOperator = new fr.lip6.move.pnml.hlpn.cyclicEnumerations.hlapi.SuccessorHLAPI(
   ...
   @Test(groups = { "hlapi", "PredecessorHLAPI"}, dependsOnMethods={"PredecessorHLAPI_LLAPI"})
	...
	public void PredecessorHLAPI_LLAPI(){
	   ...
	   fr.lip6.move.pnml.hlpn.cyclicEnumerations.hlapi.PredecessorHLAPI hlapi = new PredecessorHLAPI(llapi);
