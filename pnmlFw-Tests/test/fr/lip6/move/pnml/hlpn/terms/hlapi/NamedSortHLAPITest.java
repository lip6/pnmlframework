...
public class NamedSortHLAPITest {
	...
	mr.createDocumentWorkspace("void");
			...
			itemsortdef = new fr.lip6.move.pnml.hlpn.terms.hlapi.MultisetSortHLAPI(
    ...
    */
	...
	public void NamedSortHLAPI_LLAPI(){
	   ...
	   fr.lip6.move.pnml.hlpn.terms.hlapi.NamedSortHLAPI hlapi = new NamedSortHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortdefHLAPITest(){
			NamedSortHLAPI elem = new NamedSortHLAPI(new TermsFactoryImpl().createNamedSort());
				...
				elem.setSortdefHLAPI(new fr.lip6.move.pnml.hlpn.terms.hlapi.MultisetSortHLAPI(new TermsFactoryImpl().createMultisetSort()));
				...
				elem.setSortdefHLAPI(new fr.lip6.move.pnml.hlpn.terms.hlapi.ProductSortHLAPI(new TermsFactoryImpl().createProductSort()));
				...
				elem.setSortdefHLAPI(new fr.lip6.move.pnml.hlpn.terms.hlapi.UserSortHLAPI(new TermsFactoryImpl().createUserSort()));
				SortHLAPI totest_terms_UserSort = elem.getSortdefHLAPI();
				assert totest_terms_UserSort.getContainedItem().equals(elem.getSortdef());
			
				elem.setSortdefHLAPI(new fr.lip6.move.pnml.hlpn.arbitrarydeclarations.hlapi.AnySortHLAPI(new ArbitrarydeclarationsFactoryImpl().createAnySort()));
				SortHLAPI totest_arbitrarydeclarations_AnySort = elem.getSortdefHLAPI();
				assert totest_arbitrarydeclarations_AnySort.getContainedItem().equals(elem.getSortdef());
			
				elem.setSortdefHLAPI(new fr.lip6.move.pnml.hlpn.booleans.hlapi.BoolHLAPI(new BooleansFactoryImpl().createBool()));
				SortHLAPI totest_booleans_Bool = elem.getSortdefHLAPI();
				assert totest_booleans_Bool.getContainedItem().equals(elem.getSortdef());
			
				elem.setSortdefHLAPI(new fr.lip6.move.pnml.hlpn.cyclicEnumerations.hlapi.CyclicEnumerationHLAPI(new CyclicEnumerationsFactoryImpl().createCyclicEnumeration()));
				...
				elem.setSortdefHLAPI(new fr.lip6.move.pnml.hlpn.dots.hlapi.DotHLAPI(new DotsFactoryImpl().createDot()));
				SortHLAPI totest_dots_Dot = elem.getSortdefHLAPI();
				assert totest_dots_Dot.getContainedItem().equals(elem.getSortdef());
			
				elem.setSortdefHLAPI(new fr.lip6.move.pnml.hlpn.finiteEnumerations.hlapi.FiniteEnumerationHLAPI(new FiniteEnumerationsFactoryImpl().createFiniteEnumeration()));
				...
				elem.setSortdefHLAPI(new fr.lip6.move.pnml.hlpn.finiteIntRanges.hlapi.FiniteIntRangeHLAPI(new FiniteIntRangesFactoryImpl().createFiniteIntRange()));
				...
				elem.setSortdefHLAPI(new fr.lip6.move.pnml.hlpn.integers.hlapi.NaturalHLAPI(new IntegersFactoryImpl().createNatural()));
				...
				elem.setSortdefHLAPI(new fr.lip6.move.pnml.hlpn.integers.hlapi.PositiveHLAPI(new IntegersFactoryImpl().createPositive()));
				...
				elem.setSortdefHLAPI(new fr.lip6.move.pnml.hlpn.integers.hlapi.HLIntegerHLAPI(new IntegersFactoryImpl().createHLInteger()));
				...
				elem.setSortdefHLAPI(new fr.lip6.move.pnml.hlpn.lists.hlapi.HLPNListHLAPI(new ListsFactoryImpl().createHLPNList()));
				SortHLAPI totest_lists_HLPNList = elem.getSortdefHLAPI();
				assert totest_lists_HLPNList.getContainedItem().equals(elem.getSortdef());
			
				elem.setSortdefHLAPI(new fr.lip6.move.pnml.hlpn.strings.hlapi.HLPNStringHLAPI(new StringsFactoryImpl().createHLPNString()));
				SortHLAPI totest_strings_HLPNString = elem.getSortdefHLAPI();
				assert totest_strings_HLPNString.getContainedItem().equals(elem.getSortdef());
