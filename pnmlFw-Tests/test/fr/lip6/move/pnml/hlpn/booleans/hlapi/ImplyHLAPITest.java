...
public class ImplyHLAPITest {
	...
	@AfterTest(groups = { "ImplyHLAPI", "hlapi" })
	public void After() {
	    System.out.println("done for "+"ImplyHLAPI(booleans)");
	}


	@BeforeMethod(groups = { "ImplyHLAPI", "hlapi" })
	 ...
	 * excepted container.
	 */
	@Test(groups = { "hlapi", "ImplyHLAPI"}, dependsOnMethods={"ImplyHLAPI_LLAPI"})
	public void ImplyHLAPI_1(){//BEGIN CONSTRUCTOR BODY
   @SuppressWarnings("unused")
	ImplyHLAPI totest = new ImplyHLAPI(
		itemsort
		,	
		itemoutput
	);
	 ...
	 */
	@Test(groups = { "hlapi", "ImplyHLAPI"}, dependsOnMethods={"ImplyHLAPI_LLAPI"})
	public void ImplyHLAPI_2_containerOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ImplyHLAPI"}, dependsOnMethods={"ImplyHLAPI_LLAPI"})
	public void ImplyHLAPI_2_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ImplyHLAPI"}, dependsOnMethods={"ImplyHLAPI_LLAPI"})
	public void ImplyHLAPI_2_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ImplyHLAPI"}, dependsOnMethods={"ImplyHLAPI_LLAPI"})
	public void ImplyHLAPI_2_containerCondition(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ImplyHLAPI"}, dependsOnMethods={"ImplyHLAPI_LLAPI"})
	public void ImplyHLAPI_2_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ImplyHLAPI"}, dependsOnMethods={"ImplyHLAPI_LLAPI"})
	public void ImplyHLAPI_2_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ImplyHLAPI"}, dependsOnMethods={"ImplyHLAPI_LLAPI"})
	public void ImplyHLAPI_4_containerOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ImplyHLAPI"}, dependsOnMethods={"ImplyHLAPI_LLAPI"})
	public void ImplyHLAPI_4_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ImplyHLAPI"}, dependsOnMethods={"ImplyHLAPI_LLAPI"})
	public void ImplyHLAPI_4_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ImplyHLAPI"}, dependsOnMethods={"ImplyHLAPI_LLAPI"})
	public void ImplyHLAPI_4_containerCondition(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ImplyHLAPI"}, dependsOnMethods={"ImplyHLAPI_LLAPI"})
	public void ImplyHLAPI_4_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ImplyHLAPI"}, dependsOnMethods={"ImplyHLAPI_LLAPI"})
	public void ImplyHLAPI_4_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ImplyHLAPI"})
	public void ImplyHLAPI_LLAPI(){
	   Imply llapi = new BooleansFactoryImpl().createImply();
	   fr.lip6.move.pnml.hlpn.booleans.hlapi.ImplyHLAPI hlapi = new ImplyHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			ImplyHLAPI elem = new ImplyHLAPI(new BooleansFactoryImpl().createImply());
		...
		public void getSubtermHLAPITest(){
			...
			ImplyHLAPI elem = new ImplyHLAPI(llapi);
	...
	public void equalsTest(){
		Imply a = new BooleansFactoryImpl().createImply();
		Imply b = new BooleansFactoryImpl().createImply();
		ImplyHLAPI aprime = new ImplyHLAPI(a);
		ImplyHLAPI asecond = new ImplyHLAPI(a);
		ImplyHLAPI bprime = new ImplyHLAPI(b);
	...
	//cloning method
	//public ImplyHLAPI clone(){
	//	return new ImplyHLAPI(this);
	//}
