...
public class AndHLAPITest {
	...
	@AfterTest(groups = { "AndHLAPI", "hlapi" })
	public void After() {
	    System.out.println("done for "+"AndHLAPI(booleans)");
	}
	 ...
	 * excepted container.
	 */
	@Test(groups = { "hlapi", "AndHLAPI"}, dependsOnMethods={"AndHLAPI_LLAPI"})
	public void AndHLAPI_1(){//BEGIN CONSTRUCTOR BODY
   @SuppressWarnings("unused")
	AndHLAPI totest = new AndHLAPI(
		itemsort
		,	
		itemoutput
	);
	 ...
	 */
	@Test(groups = { "hlapi", "AndHLAPI"}, dependsOnMethods={"AndHLAPI_LLAPI"})
	public void AndHLAPI_2_containerOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AndHLAPI"}, dependsOnMethods={"AndHLAPI_LLAPI"})
	public void AndHLAPI_2_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AndHLAPI"}, dependsOnMethods={"AndHLAPI_LLAPI"})
	public void AndHLAPI_2_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AndHLAPI"}, dependsOnMethods={"AndHLAPI_LLAPI"})
	public void AndHLAPI_2_containerCondition(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AndHLAPI"}, dependsOnMethods={"AndHLAPI_LLAPI"})
	public void AndHLAPI_2_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AndHLAPI"}, dependsOnMethods={"AndHLAPI_LLAPI"})
	public void AndHLAPI_2_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AndHLAPI"}, dependsOnMethods={"AndHLAPI_LLAPI"})
	public void AndHLAPI_4_containerOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AndHLAPI"}, dependsOnMethods={"AndHLAPI_LLAPI"})
	public void AndHLAPI_4_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AndHLAPI"}, dependsOnMethods={"AndHLAPI_LLAPI"})
	public void AndHLAPI_4_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AndHLAPI"}, dependsOnMethods={"AndHLAPI_LLAPI"})
	public void AndHLAPI_4_containerCondition(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AndHLAPI"}, dependsOnMethods={"AndHLAPI_LLAPI"})
	public void AndHLAPI_4_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AndHLAPI"}, dependsOnMethods={"AndHLAPI_LLAPI"})
	public void AndHLAPI_4_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AndHLAPI"})
	public void AndHLAPI_LLAPI(){
	   And llapi = new BooleansFactoryImpl().createAnd();
	   fr.lip6.move.pnml.hlpn.booleans.hlapi.AndHLAPI hlapi = new AndHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			AndHLAPI elem = new AndHLAPI(new BooleansFactoryImpl().createAnd());
		...
		public void getSubtermHLAPITest(){
			...
			AndHLAPI elem = new AndHLAPI(llapi);
	...
	public void equalsTest(){
		And a = new BooleansFactoryImpl().createAnd();
		And b = new BooleansFactoryImpl().createAnd();
		AndHLAPI aprime = new AndHLAPI(a);
		AndHLAPI asecond = new AndHLAPI(a);
		AndHLAPI bprime = new AndHLAPI(b);
	...
	//cloning method
	//public AndHLAPI clone(){
	//	return new AndHLAPI(this);
	//}
