...
public class LessThanHLAPITest {
   ...
   @Test(groups = { "hlapi", "LessThanHLAPI"}, dependsOnMethods={"LessThanHLAPI_LLAPI"})
	...
	public void LessThanHLAPI_LLAPI(){
	   fr.lip6.move.pnml.hlpn.integers.LessThan llapi = new IntegersFactoryImpl().createLessThan();
	   fr.lip6.move.pnml.hlpn.integers.hlapi.LessThanHLAPI hlapi = new LessThanHLAPI(llapi);
	...
	public void equalsTest(){
		fr.lip6.move.pnml.hlpn.integers.LessThan a = new IntegersFactoryImpl().createLessThan();
		fr.lip6.move.pnml.hlpn.integers.LessThan b = new IntegersFactoryImpl().createLessThan();
