...
public class LessThanOrEqualHLAPITest {
   ...
   @Test(groups = { "hlapi", "LessThanOrEqualHLAPI"}, dependsOnMethods={"LessThanOrEqualHLAPI_LLAPI"})
	...
	public void LessThanOrEqualHLAPI_LLAPI(){
	   fr.lip6.move.pnml.hlpn.integers.LessThanOrEqual llapi = new IntegersFactoryImpl().createLessThanOrEqual();
	   fr.lip6.move.pnml.hlpn.integers.hlapi.LessThanOrEqualHLAPI hlapi = new LessThanOrEqualHLAPI(llapi);
	...
	public void equalsTest(){
		fr.lip6.move.pnml.hlpn.integers.LessThanOrEqual a = new IntegersFactoryImpl().createLessThanOrEqual();
		fr.lip6.move.pnml.hlpn.integers.LessThanOrEqual b = new IntegersFactoryImpl().createLessThanOrEqual();
