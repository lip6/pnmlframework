...
public class GreaterThanHLAPITest {
   ...
   @Test(groups = { "hlapi", "GreaterThanHLAPI"}, dependsOnMethods={"GreaterThanHLAPI_LLAPI"})
	...
	public void GreaterThanHLAPI_LLAPI(){
	   fr.lip6.move.pnml.hlpn.integers.GreaterThan llapi = new IntegersFactoryImpl().createGreaterThan();
	   fr.lip6.move.pnml.hlpn.integers.hlapi.GreaterThanHLAPI hlapi = new GreaterThanHLAPI(llapi);
	...
	public void equalsTest(){
		fr.lip6.move.pnml.hlpn.integers.GreaterThan a = new IntegersFactoryImpl().createGreaterThan();
		fr.lip6.move.pnml.hlpn.integers.GreaterThan b = new IntegersFactoryImpl().createGreaterThan();
