...
public class GreaterThanOrEqualHLAPITest {
   ...
   @Test(groups = { "hlapi", "GreaterThanOrEqualHLAPI"}, dependsOnMethods={"GreaterThanOrEqualHLAPI_LLAPI"})
	...
	public void GreaterThanOrEqualHLAPI_LLAPI(){
	   fr.lip6.move.pnml.hlpn.integers.GreaterThanOrEqual llapi = new IntegersFactoryImpl().createGreaterThanOrEqual();
	   fr.lip6.move.pnml.hlpn.integers.hlapi.GreaterThanOrEqualHLAPI hlapi = new GreaterThanOrEqualHLAPI(llapi);
	...
	public void equalsTest(){
		fr.lip6.move.pnml.hlpn.integers.GreaterThanOrEqual a = new IntegersFactoryImpl().createGreaterThanOrEqual();
		fr.lip6.move.pnml.hlpn.integers.GreaterThanOrEqual b = new IntegersFactoryImpl().createGreaterThanOrEqual();
