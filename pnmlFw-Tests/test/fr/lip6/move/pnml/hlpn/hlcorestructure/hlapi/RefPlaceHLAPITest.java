...
public class RefPlaceHLAPITest {
	...
	mr.createDocumentWorkspace("void");
			...
			itemref = new fr.lip6.move.pnml.hlpn.hlcorestructure.hlapi.PlaceHLAPI(
   ...
   @Test(groups = { "hlapi", "RefPlaceHLAPI"}, dependsOnMethods={"RefPlaceHLAPI_LLAPI"})
	...
	public void RefPlaceHLAPI_LLAPI(){
	   ...
	   fr.lip6.move.pnml.hlpn.hlcorestructure.hlapi.RefPlaceHLAPI hlapi = new RefPlaceHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getRefHLAPITest(){
			RefPlaceHLAPI elem = new RefPlaceHLAPI(new HlcorestructureFactoryImpl().createRefPlace());
				...
				elem.setRefHLAPI(new fr.lip6.move.pnml.hlpn.hlcorestructure.hlapi.PlaceHLAPI(new HlcorestructureFactoryImpl().createPlace()));
				...
				elem.setRefHLAPI(new fr.lip6.move.pnml.hlpn.hlcorestructure.hlapi.RefPlaceHLAPI(new HlcorestructureFactoryImpl().createRefPlace()));
