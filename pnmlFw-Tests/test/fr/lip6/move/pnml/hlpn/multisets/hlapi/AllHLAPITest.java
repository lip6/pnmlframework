...
public class AllHLAPITest {
	...
	@AfterTest(groups = { "AllHLAPI", "hlapi" })
	public void After() {
	    System.out.println("done for "+"AllHLAPI(multisets)");
	}
	 ...
	 * excepted container.
	 */
	@Test(groups = { "hlapi", "AllHLAPI"}, dependsOnMethods={"AllHLAPI_LLAPI"})
	public void AllHLAPI_1(){//BEGIN CONSTRUCTOR BODY
   @SuppressWarnings("unused")
	AllHLAPI totest = new AllHLAPI(
		itemsort
		,	
		itemoutput
		,	
	 ...
	 */
	@Test(groups = { "hlapi", "AllHLAPI"}, dependsOnMethods={"AllHLAPI_LLAPI"})
	public void AllHLAPI_2_containerOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AllHLAPI"}, dependsOnMethods={"AllHLAPI_LLAPI"})
	public void AllHLAPI_2_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AllHLAPI"}, dependsOnMethods={"AllHLAPI_LLAPI"})
	public void AllHLAPI_2_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AllHLAPI"}, dependsOnMethods={"AllHLAPI_LLAPI"})
	public void AllHLAPI_2_containerCondition(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AllHLAPI"}, dependsOnMethods={"AllHLAPI_LLAPI"})
	public void AllHLAPI_2_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AllHLAPI"}, dependsOnMethods={"AllHLAPI_LLAPI"})
	public void AllHLAPI_2_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AllHLAPI"}, dependsOnMethods={"AllHLAPI_LLAPI"})
	public void AllHLAPI_3(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AllHLAPI"}, dependsOnMethods={"AllHLAPI_LLAPI"})
	public void AllHLAPI_4_containerOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AllHLAPI"}, dependsOnMethods={"AllHLAPI_LLAPI"})
	public void AllHLAPI_4_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AllHLAPI"}, dependsOnMethods={"AllHLAPI_LLAPI"})
	public void AllHLAPI_4_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AllHLAPI"}, dependsOnMethods={"AllHLAPI_LLAPI"})
	public void AllHLAPI_4_containerCondition(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AllHLAPI"}, dependsOnMethods={"AllHLAPI_LLAPI"})
	public void AllHLAPI_4_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AllHLAPI"}, dependsOnMethods={"AllHLAPI_LLAPI"})
	public void AllHLAPI_4_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
	...
	public void AllHLAPI_LLAPI(){
	   All llapi = new MultisetsFactoryImpl().createAll();
	   fr.lip6.move.pnml.hlpn.multisets.hlapi.AllHLAPI hlapi = new AllHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			AllHLAPI elem = new AllHLAPI(new MultisetsFactoryImpl().createAll());
	...
	public void equalsTest(){
		All a = new MultisetsFactoryImpl().createAll();
		All b = new MultisetsFactoryImpl().createAll();
		AllHLAPI aprime = new AllHLAPI(a);
		AllHLAPI asecond = new AllHLAPI(a);
		AllHLAPI bprime = new AllHLAPI(b);
	...
	//cloning method
	//public AllHLAPI clone(){
	//	return new AllHLAPI(this);
	//}
