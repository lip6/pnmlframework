...
public class MakeListHLAPITest {
	...
	@AfterTest(groups = { "MakeListHLAPI", "hlapi" })
	public void After() {
	    System.out.println("done for "+"MakeListHLAPI(lists)");
	}


	@BeforeMethod(groups = { "MakeListHLAPI", "hlapi" })
	 ...
	 * excepted container.
	 */
	@Test(groups = { "hlapi", "MakeListHLAPI"}, dependsOnMethods={"MakeListHLAPI_LLAPI"})
	public void MakeListHLAPI_1(){//BEGIN CONSTRUCTOR BODY
   @SuppressWarnings("unused")
	MakeListHLAPI totest = new MakeListHLAPI(
		itemsort
		,	
		itemoutput
		,	
	 ...
	 */
	@Test(groups = { "hlapi", "MakeListHLAPI"}, dependsOnMethods={"MakeListHLAPI_LLAPI"})
	public void MakeListHLAPI_2_containerOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "MakeListHLAPI"}, dependsOnMethods={"MakeListHLAPI_LLAPI"})
	public void MakeListHLAPI_2_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "MakeListHLAPI"}, dependsOnMethods={"MakeListHLAPI_LLAPI"})
	public void MakeListHLAPI_2_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "MakeListHLAPI"}, dependsOnMethods={"MakeListHLAPI_LLAPI"})
	public void MakeListHLAPI_2_containerCondition(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "MakeListHLAPI"}, dependsOnMethods={"MakeListHLAPI_LLAPI"})
	public void MakeListHLAPI_2_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "MakeListHLAPI"}, dependsOnMethods={"MakeListHLAPI_LLAPI"})
	public void MakeListHLAPI_2_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "MakeListHLAPI"}, dependsOnMethods={"MakeListHLAPI_LLAPI"})
	public void MakeListHLAPI_3(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "MakeListHLAPI"}, dependsOnMethods={"MakeListHLAPI_LLAPI"})
	public void MakeListHLAPI_4_containerOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "MakeListHLAPI"}, dependsOnMethods={"MakeListHLAPI_LLAPI"})
	public void MakeListHLAPI_4_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "MakeListHLAPI"}, dependsOnMethods={"MakeListHLAPI_LLAPI"})
	public void MakeListHLAPI_4_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "MakeListHLAPI"}, dependsOnMethods={"MakeListHLAPI_LLAPI"})
	public void MakeListHLAPI_4_containerCondition(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "MakeListHLAPI"}, dependsOnMethods={"MakeListHLAPI_LLAPI"})
	public void MakeListHLAPI_4_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "MakeListHLAPI"}, dependsOnMethods={"MakeListHLAPI_LLAPI"})
	public void MakeListHLAPI_4_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "MakeListHLAPI"})
	public void MakeListHLAPI_LLAPI(){
	   MakeList llapi = new ListsFactoryImpl().createMakeList();
	   fr.lip6.move.pnml.hlpn.lists.hlapi.MakeListHLAPI hlapi = new MakeListHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			MakeListHLAPI elem = new MakeListHLAPI(new ListsFactoryImpl().createMakeList());
		...
		public void getSubtermHLAPITest(){
			...
			MakeListHLAPI elem = new MakeListHLAPI(llapi);
	...
	public void equalsTest(){
		MakeList a = new ListsFactoryImpl().createMakeList();
		MakeList b = new ListsFactoryImpl().createMakeList();
		MakeListHLAPI aprime = new MakeListHLAPI(a);
		MakeListHLAPI asecond = new MakeListHLAPI(a);
		MakeListHLAPI bprime = new MakeListHLAPI(b);
	...
	//cloning method
	//public MakeListHLAPI clone(){
	//	return new MakeListHLAPI(this);
	//}
