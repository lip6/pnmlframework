...
public class EmptyListHLAPITest {
	...
	@AfterTest(groups = { "EmptyListHLAPI", "hlapi" })
	public void After() {
	    System.out.println("done for "+"EmptyListHLAPI(lists)");
	}


	@BeforeMethod(groups = { "EmptyListHLAPI", "hlapi" })
	...
	mr.createDocumentWorkspace("void");
			...
			itemrefsort = new fr.lip6.move.pnml.hlpn.lists.hlapi.HLPNListHLAPI(
				new ListsFactoryImpl().createHLPNList()
			);
	 ...
	 * excepted container.
	 */
	@Test(groups = { "hlapi", "EmptyListHLAPI"}, dependsOnMethods={"EmptyListHLAPI_LLAPI"})
	public void EmptyListHLAPI_1(){//BEGIN CONSTRUCTOR BODY
   @SuppressWarnings("unused")
	EmptyListHLAPI totest = new EmptyListHLAPI(
		itemsort
		,	
		itemoutput
		,	
	...
	assert totest.getRefsort().equals(itemrefsort.getContainedItem());
	 ...
	 */
	@Test(groups = { "hlapi", "EmptyListHLAPI"}, dependsOnMethods={"EmptyListHLAPI_LLAPI"})
	public void EmptyListHLAPI_2_containerOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "EmptyListHLAPI"}, dependsOnMethods={"EmptyListHLAPI_LLAPI"})
	public void EmptyListHLAPI_2_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "EmptyListHLAPI"}, dependsOnMethods={"EmptyListHLAPI_LLAPI"})
	public void EmptyListHLAPI_2_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "EmptyListHLAPI"}, dependsOnMethods={"EmptyListHLAPI_LLAPI"})
	public void EmptyListHLAPI_2_containerCondition(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "EmptyListHLAPI"}, dependsOnMethods={"EmptyListHLAPI_LLAPI"})
	public void EmptyListHLAPI_2_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "EmptyListHLAPI"}, dependsOnMethods={"EmptyListHLAPI_LLAPI"})
	public void EmptyListHLAPI_2_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "EmptyListHLAPI"}, dependsOnMethods={"EmptyListHLAPI_LLAPI"})
	public void EmptyListHLAPI_3(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "EmptyListHLAPI"}, dependsOnMethods={"EmptyListHLAPI_LLAPI"})
	public void EmptyListHLAPI_4_containerOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "EmptyListHLAPI"}, dependsOnMethods={"EmptyListHLAPI_LLAPI"})
	public void EmptyListHLAPI_4_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "EmptyListHLAPI"}, dependsOnMethods={"EmptyListHLAPI_LLAPI"})
	public void EmptyListHLAPI_4_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "EmptyListHLAPI"}, dependsOnMethods={"EmptyListHLAPI_LLAPI"})
	public void EmptyListHLAPI_4_containerCondition(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "EmptyListHLAPI"}, dependsOnMethods={"EmptyListHLAPI_LLAPI"})
	public void EmptyListHLAPI_4_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "EmptyListHLAPI"}, dependsOnMethods={"EmptyListHLAPI_LLAPI"})
	public void EmptyListHLAPI_4_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "EmptyListHLAPI"})
	public void EmptyListHLAPI_LLAPI(){
	   EmptyList llapi = new ListsFactoryImpl().createEmptyList();
	   fr.lip6.move.pnml.hlpn.lists.hlapi.EmptyListHLAPI hlapi = new EmptyListHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			EmptyListHLAPI elem = new EmptyListHLAPI(new ListsFactoryImpl().createEmptyList());
		...
		public void getSubtermHLAPITest(){
			...
			EmptyListHLAPI elem = new EmptyListHLAPI(llapi);
		 ...
		 */
		@Test(groups = { "hlapi", "EmptyListHLAPI"})
		public void getRefsortHLAPITest(){
			EmptyListHLAPI elem = new EmptyListHLAPI(new ListsFactoryImpl().createEmptyList());

			
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.hlpn.lists.hlapi.HLPNListHLAPI(new ListsFactoryImpl().createHLPNList()));
				SortHLAPI totest_lists_HLPNList = elem.getRefsortHLAPI();
				assert totest_lists_HLPNList.getContainedItem().equals(elem.getRefsort());
			
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.hlpn.arbitrarydeclarations.hlapi.AnySortHLAPI(new ArbitrarydeclarationsFactoryImpl().createAnySort()));
				SortHLAPI totest_arbitrarydeclarations_AnySort = elem.getRefsortHLAPI();
				assert totest_arbitrarydeclarations_AnySort.getContainedItem().equals(elem.getRefsort());
			
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.hlpn.booleans.hlapi.BoolHLAPI(new BooleansFactoryImpl().createBool()));
				SortHLAPI totest_booleans_Bool = elem.getRefsortHLAPI();
				assert totest_booleans_Bool.getContainedItem().equals(elem.getRefsort());
			
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.hlpn.cyclicEnumerations.hlapi.CyclicEnumerationHLAPI(new CyclicEnumerationsFactoryImpl().createCyclicEnumeration()));
				SortHLAPI totest_cyclicEnumerations_CyclicEnumeration = elem.getRefsortHLAPI();
				assert totest_cyclicEnumerations_CyclicEnumeration.getContainedItem().equals(elem.getRefsort());
			
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.hlpn.dots.hlapi.DotHLAPI(new DotsFactoryImpl().createDot()));
				SortHLAPI totest_dots_Dot = elem.getRefsortHLAPI();
				assert totest_dots_Dot.getContainedItem().equals(elem.getRefsort());
			
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.hlpn.finiteEnumerations.hlapi.FiniteEnumerationHLAPI(new FiniteEnumerationsFactoryImpl().createFiniteEnumeration()));
				SortHLAPI totest_finiteEnumerations_FiniteEnumeration = elem.getRefsortHLAPI();
				assert totest_finiteEnumerations_FiniteEnumeration.getContainedItem().equals(elem.getRefsort());
			
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.hlpn.finiteIntRanges.hlapi.FiniteIntRangeHLAPI(new FiniteIntRangesFactoryImpl().createFiniteIntRange()));
				SortHLAPI totest_finiteIntRanges_FiniteIntRange = elem.getRefsortHLAPI();
				assert totest_finiteIntRanges_FiniteIntRange.getContainedItem().equals(elem.getRefsort());
			
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.hlpn.integers.hlapi.NaturalHLAPI(new IntegersFactoryImpl().createNatural()));
				...
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.hlpn.integers.hlapi.PositiveHLAPI(new IntegersFactoryImpl().createPositive()));
				...
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.hlpn.integers.hlapi.HLIntegerHLAPI(new IntegersFactoryImpl().createHLInteger()));
				...
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.hlpn.strings.hlapi.HLPNStringHLAPI(new StringsFactoryImpl().createHLPNString()));
				SortHLAPI totest_strings_HLPNString = elem.getRefsortHLAPI();
				assert totest_strings_HLPNString.getContainedItem().equals(elem.getRefsort());
			
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.hlpn.terms.hlapi.MultisetSortHLAPI(new TermsFactoryImpl().createMultisetSort()));
				SortHLAPI totest_terms_MultisetSort = elem.getRefsortHLAPI();
				assert totest_terms_MultisetSort.getContainedItem().equals(elem.getRefsort());
			
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.hlpn.terms.hlapi.ProductSortHLAPI(new TermsFactoryImpl().createProductSort()));
				SortHLAPI totest_terms_ProductSort = elem.getRefsortHLAPI();
				assert totest_terms_ProductSort.getContainedItem().equals(elem.getRefsort());
			
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.hlpn.terms.hlapi.UserSortHLAPI(new TermsFactoryImpl().createUserSort()));
				SortHLAPI totest_terms_UserSort = elem.getRefsortHLAPI();
				assert totest_terms_UserSort.getContainedItem().equals(elem.getRefsort());
	...
	public void equalsTest(){
		EmptyList a = new ListsFactoryImpl().createEmptyList();
		EmptyList b = new ListsFactoryImpl().createEmptyList();
		EmptyListHLAPI aprime = new EmptyListHLAPI(a);
		EmptyListHLAPI asecond = new EmptyListHLAPI(a);
		EmptyListHLAPI bprime = new EmptyListHLAPI(b);
	...
	//cloning method
	//public EmptyListHLAPI clone(){
	//	return new EmptyListHLAPI(this);
	//}
