...
public class ConcatenationHLAPITest {
	...
	public void After() {
	    System.out.println("done for "+"ConcatenationHLAPI(lists)");
	}
   ...
   @Test(groups = { "hlapi", "ConcatenationHLAPI"}, dependsOnMethods={"ConcatenationHLAPI_LLAPI"})
	...
	public void ConcatenationHLAPI_LLAPI(){
	   Concatenation llapi = new ListsFactoryImpl().createConcatenation();
	   fr.lip6.move.pnml.hlpn.lists.hlapi.ConcatenationHLAPI hlapi = new ConcatenationHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			ConcatenationHLAPI elem = new ConcatenationHLAPI(new ListsFactoryImpl().createConcatenation());
	...
	public void equalsTest(){
		Concatenation a = new ListsFactoryImpl().createConcatenation();
		Concatenation b = new ListsFactoryImpl().createConcatenation();
