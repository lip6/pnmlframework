...
public class LessThanOrEqualHLAPITest {
	...
	public void After() {
	    System.out.println("done for "+"LessThanOrEqualHLAPI(strings)");
	}
   ...
   @Test(groups = { "hlapi", "LessThanOrEqualHLAPI"}, dependsOnMethods={"LessThanOrEqualHLAPI_LLAPI"})
	...
	public void LessThanOrEqualHLAPI_LLAPI(){
	   fr.lip6.move.pnml.hlpn.strings.LessThanOrEqual llapi = new StringsFactoryImpl().createLessThanOrEqual();
	   fr.lip6.move.pnml.hlpn.strings.hlapi.LessThanOrEqualHLAPI hlapi = new LessThanOrEqualHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			LessThanOrEqualHLAPI elem = new LessThanOrEqualHLAPI(new StringsFactoryImpl().createLessThanOrEqual());
	...
	public void equalsTest(){
		fr.lip6.move.pnml.hlpn.strings.LessThanOrEqual a = new StringsFactoryImpl().createLessThanOrEqual();
		fr.lip6.move.pnml.hlpn.strings.LessThanOrEqual b = new StringsFactoryImpl().createLessThanOrEqual();
