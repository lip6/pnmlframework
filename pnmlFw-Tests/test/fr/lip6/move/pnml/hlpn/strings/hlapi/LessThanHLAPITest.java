...
public class LessThanHLAPITest {
	...
	public void After() {
	    System.out.println("done for "+"LessThanHLAPI(strings)");
	}
   ...
   @Test(groups = { "hlapi", "LessThanHLAPI"}, dependsOnMethods={"LessThanHLAPI_LLAPI"})
	...
	public void LessThanHLAPI_LLAPI(){
	   fr.lip6.move.pnml.hlpn.strings.LessThan llapi = new StringsFactoryImpl().createLessThan();
	   fr.lip6.move.pnml.hlpn.strings.hlapi.LessThanHLAPI hlapi = new LessThanHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			LessThanHLAPI elem = new LessThanHLAPI(new StringsFactoryImpl().createLessThan());
	...
	public void equalsTest(){
		fr.lip6.move.pnml.hlpn.strings.LessThan a = new StringsFactoryImpl().createLessThan();
		fr.lip6.move.pnml.hlpn.strings.LessThan b = new StringsFactoryImpl().createLessThan();
