...
public class ConcatenationHLAPITest {
	...
	@AfterTest(groups = { "ConcatenationHLAPI", "hlapi" })
	public void After() {
	    System.out.println("done for "+"ConcatenationHLAPI(strings)");
	}


	@BeforeMethod(groups = { "ConcatenationHLAPI", "hlapi" })
	 ...
	 * excepted container.
	 */
	@Test(groups = { "hlapi", "ConcatenationHLAPI"}, dependsOnMethods={"ConcatenationHLAPI_LLAPI"})
	public void ConcatenationHLAPI_1(){//BEGIN CONSTRUCTOR BODY
   @SuppressWarnings("unused")
	ConcatenationHLAPI totest = new ConcatenationHLAPI(
		itemsort
		,	
		itemoutput
	);
	 ...
	 */
	@Test(groups = { "hlapi", "ConcatenationHLAPI"}, dependsOnMethods={"ConcatenationHLAPI_LLAPI"})
	public void ConcatenationHLAPI_2_containerOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ConcatenationHLAPI"}, dependsOnMethods={"ConcatenationHLAPI_LLAPI"})
	public void ConcatenationHLAPI_2_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ConcatenationHLAPI"}, dependsOnMethods={"ConcatenationHLAPI_LLAPI"})
	public void ConcatenationHLAPI_2_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ConcatenationHLAPI"}, dependsOnMethods={"ConcatenationHLAPI_LLAPI"})
	public void ConcatenationHLAPI_2_containerCondition(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ConcatenationHLAPI"}, dependsOnMethods={"ConcatenationHLAPI_LLAPI"})
	public void ConcatenationHLAPI_2_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ConcatenationHLAPI"}, dependsOnMethods={"ConcatenationHLAPI_LLAPI"})
	public void ConcatenationHLAPI_2_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ConcatenationHLAPI"}, dependsOnMethods={"ConcatenationHLAPI_LLAPI"})
	public void ConcatenationHLAPI_4_containerOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ConcatenationHLAPI"}, dependsOnMethods={"ConcatenationHLAPI_LLAPI"})
	public void ConcatenationHLAPI_4_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ConcatenationHLAPI"}, dependsOnMethods={"ConcatenationHLAPI_LLAPI"})
	public void ConcatenationHLAPI_4_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ConcatenationHLAPI"}, dependsOnMethods={"ConcatenationHLAPI_LLAPI"})
	public void ConcatenationHLAPI_4_containerCondition(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ConcatenationHLAPI"}, dependsOnMethods={"ConcatenationHLAPI_LLAPI"})
	public void ConcatenationHLAPI_4_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ConcatenationHLAPI"}, dependsOnMethods={"ConcatenationHLAPI_LLAPI"})
	public void ConcatenationHLAPI_4_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ConcatenationHLAPI"})
	public void ConcatenationHLAPI_LLAPI(){
	   fr.lip6.move.pnml.hlpn.strings.Concatenation llapi = new StringsFactoryImpl().createConcatenation();
	   fr.lip6.move.pnml.hlpn.strings.hlapi.ConcatenationHLAPI hlapi = new ConcatenationHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			ConcatenationHLAPI elem = new ConcatenationHLAPI(new StringsFactoryImpl().createConcatenation());
		...
		public void getSubtermHLAPITest(){
			...
			ConcatenationHLAPI elem = new ConcatenationHLAPI(llapi);
	...
	public void equalsTest(){
		fr.lip6.move.pnml.hlpn.strings.Concatenation a = new StringsFactoryImpl().createConcatenation();
		fr.lip6.move.pnml.hlpn.strings.Concatenation b = new StringsFactoryImpl().createConcatenation();
		ConcatenationHLAPI aprime = new ConcatenationHLAPI(a);
		ConcatenationHLAPI asecond = new ConcatenationHLAPI(a);
		ConcatenationHLAPI bprime = new ConcatenationHLAPI(b);
	...
	//cloning method
	//public ConcatenationHLAPI clone(){
	//	return new ConcatenationHLAPI(this);
	//}
