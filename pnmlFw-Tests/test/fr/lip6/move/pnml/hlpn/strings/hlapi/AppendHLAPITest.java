...
public class AppendHLAPITest {
	...
	public void After() {
	    System.out.println("done for "+"AppendHLAPI(strings)");
	}
   ...
   @Test(groups = { "hlapi", "AppendHLAPI"}, dependsOnMethods={"AppendHLAPI_LLAPI"})
	...
	public void AppendHLAPI_LLAPI(){
	   fr.lip6.move.pnml.hlpn.strings.Append llapi = new StringsFactoryImpl().createAppend();
	   fr.lip6.move.pnml.hlpn.strings.hlapi.AppendHLAPI hlapi = new AppendHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			AppendHLAPI elem = new AppendHLAPI(new StringsFactoryImpl().createAppend());
	...
	public void equalsTest(){
		fr.lip6.move.pnml.hlpn.strings.Append a = new StringsFactoryImpl().createAppend();
		fr.lip6.move.pnml.hlpn.strings.Append b = new StringsFactoryImpl().createAppend();
