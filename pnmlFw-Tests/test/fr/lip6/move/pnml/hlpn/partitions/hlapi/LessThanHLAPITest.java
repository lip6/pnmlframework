...
public class LessThanHLAPITest {
   ...
   @Test(groups = { "hlapi", "LessThanHLAPI"}, dependsOnMethods={"LessThanHLAPI_LLAPI"})
	...
	public void LessThanHLAPI_LLAPI(){
	   fr.lip6.move.pnml.hlpn.partitions.LessThan llapi = new PartitionsFactoryImpl().createLessThan();
	   fr.lip6.move.pnml.hlpn.partitions.hlapi.LessThanHLAPI hlapi = new LessThanHLAPI(llapi);
	...
	public void equalsTest(){
		fr.lip6.move.pnml.hlpn.partitions.LessThan a = new PartitionsFactoryImpl().createLessThan();
		fr.lip6.move.pnml.hlpn.partitions.LessThan b = new PartitionsFactoryImpl().createLessThan();
