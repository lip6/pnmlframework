...
public class GreaterThanHLAPITest {
	...
	public void After() {
	    System.out.println("done for "+"GreaterThanHLAPI(finiteIntRanges)");
	}
   ...
   @Test(groups = { "hlapi", "GreaterThanHLAPI"}, dependsOnMethods={"GreaterThanHLAPI_LLAPI"})
	...
	public void GreaterThanHLAPI_LLAPI(){
	   GreaterThan llapi = new FiniteIntRangesFactoryImpl().createGreaterThan();
	   fr.lip6.move.pnml.hlpn.finiteIntRanges.hlapi.GreaterThanHLAPI hlapi = new GreaterThanHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			GreaterThanHLAPI elem = new GreaterThanHLAPI(new FiniteIntRangesFactoryImpl().createGreaterThan());
	...
	public void equalsTest(){
		GreaterThan a = new FiniteIntRangesFactoryImpl().createGreaterThan();
		GreaterThan b = new FiniteIntRangesFactoryImpl().createGreaterThan();
