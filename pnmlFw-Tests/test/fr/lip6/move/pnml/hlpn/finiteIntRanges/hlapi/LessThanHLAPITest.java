...
public class LessThanHLAPITest {
	...
	public void After() {
	    System.out.println("done for "+"LessThanHLAPI(finiteIntRanges)");
	}
   ...
   @Test(groups = { "hlapi", "LessThanHLAPI"}, dependsOnMethods={"LessThanHLAPI_LLAPI"})
	...
	public void LessThanHLAPI_LLAPI(){
	   LessThan llapi = new FiniteIntRangesFactoryImpl().createLessThan();
	   fr.lip6.move.pnml.hlpn.finiteIntRanges.hlapi.LessThanHLAPI hlapi = new LessThanHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			LessThanHLAPI elem = new LessThanHLAPI(new FiniteIntRangesFactoryImpl().createLessThan());
	...
	public void equalsTest(){
		LessThan a = new FiniteIntRangesFactoryImpl().createLessThan();
		LessThan b = new FiniteIntRangesFactoryImpl().createLessThan();
