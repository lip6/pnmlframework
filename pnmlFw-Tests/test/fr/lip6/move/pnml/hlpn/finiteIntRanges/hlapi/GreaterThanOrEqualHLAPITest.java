...
public class GreaterThanOrEqualHLAPITest {
	...
	public void After() {
	    System.out.println("done for "+"GreaterThanOrEqualHLAPI(finiteIntRanges)");
	}
   ...
   @Test(groups = { "hlapi", "GreaterThanOrEqualHLAPI"}, dependsOnMethods={"GreaterThanOrEqualHLAPI_LLAPI"})
	...
	public void GreaterThanOrEqualHLAPI_LLAPI(){
	   GreaterThanOrEqual llapi = new FiniteIntRangesFactoryImpl().createGreaterThanOrEqual();
	   fr.lip6.move.pnml.hlpn.finiteIntRanges.hlapi.GreaterThanOrEqualHLAPI hlapi = new GreaterThanOrEqualHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			GreaterThanOrEqualHLAPI elem = new GreaterThanOrEqualHLAPI(new FiniteIntRangesFactoryImpl().createGreaterThanOrEqual());
	...
	public void equalsTest(){
		GreaterThanOrEqual a = new FiniteIntRangesFactoryImpl().createGreaterThanOrEqual();
		GreaterThanOrEqual b = new FiniteIntRangesFactoryImpl().createGreaterThanOrEqual();
