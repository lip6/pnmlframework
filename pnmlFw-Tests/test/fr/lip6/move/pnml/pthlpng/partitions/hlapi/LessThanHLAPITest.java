...
public class LessThanHLAPITest {
   ...
   @Test(groups = { "hlapi", "LessThanHLAPI"}, dependsOnMethods={"LessThanHLAPI_LLAPI"})
	...
	public void LessThanHLAPI_LLAPI(){
	   LessThan llapi = new PartitionsFactoryImpl().createLessThan();
	...
	public void equalsTest(){
		LessThan a = new PartitionsFactoryImpl().createLessThan();
		LessThan b = new PartitionsFactoryImpl().createLessThan();
