...
public class PartitionElementOfHLAPITest {
	...
	@AfterTest(groups = { "PartitionElementOfHLAPI", "hlapi" })
	public void After() {
	    System.out.println("done for "+"PartitionElementOfHLAPI(partitions)");
	}


	@BeforeMethod(groups = { "PartitionElementOfHLAPI", "hlapi" })
	...
	mr.createDocumentWorkspace("void");
		...
		itemcontainerOperator = new fr.lip6.move.pnml.pthlpng.partitions.hlapi.GreaterThanHLAPI(
	 ...
	 * excepted container.
	 */
	@Test(groups = { "hlapi", "PartitionElementOfHLAPI"}, dependsOnMethods={"PartitionElementOfHLAPI_LLAPI"})
	public void PartitionElementOfHLAPI_1(){//BEGIN CONSTRUCTOR BODY
   @SuppressWarnings("unused")
	PartitionElementOfHLAPI totest = new PartitionElementOfHLAPI(
		itemsort
		,	
		itemoutput
		,	
	 ...
	 */
	@Test(groups = { "hlapi", "PartitionElementOfHLAPI"}, dependsOnMethods={"PartitionElementOfHLAPI_LLAPI"})
	public void PartitionElementOfHLAPI_2_containerOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "PartitionElementOfHLAPI"}, dependsOnMethods={"PartitionElementOfHLAPI_LLAPI"})
	public void PartitionElementOfHLAPI_2_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "PartitionElementOfHLAPI"}, dependsOnMethods={"PartitionElementOfHLAPI_LLAPI"})
	public void PartitionElementOfHLAPI_2_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "PartitionElementOfHLAPI"}, dependsOnMethods={"PartitionElementOfHLAPI_LLAPI"})
	public void PartitionElementOfHLAPI_2_containerCondition(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "PartitionElementOfHLAPI"}, dependsOnMethods={"PartitionElementOfHLAPI_LLAPI"})
	public void PartitionElementOfHLAPI_2_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "PartitionElementOfHLAPI"}, dependsOnMethods={"PartitionElementOfHLAPI_LLAPI"})
	public void PartitionElementOfHLAPI_2_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "PartitionElementOfHLAPI"}, dependsOnMethods={"PartitionElementOfHLAPI_LLAPI"})
	public void PartitionElementOfHLAPI_3(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "PartitionElementOfHLAPI"}, dependsOnMethods={"PartitionElementOfHLAPI_LLAPI"})
	public void PartitionElementOfHLAPI_4_containerOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "PartitionElementOfHLAPI"}, dependsOnMethods={"PartitionElementOfHLAPI_LLAPI"})
	public void PartitionElementOfHLAPI_4_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "PartitionElementOfHLAPI"}, dependsOnMethods={"PartitionElementOfHLAPI_LLAPI"})
	public void PartitionElementOfHLAPI_4_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "PartitionElementOfHLAPI"}, dependsOnMethods={"PartitionElementOfHLAPI_LLAPI"})
	public void PartitionElementOfHLAPI_4_containerCondition(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "PartitionElementOfHLAPI"}, dependsOnMethods={"PartitionElementOfHLAPI_LLAPI"})
	public void PartitionElementOfHLAPI_4_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "PartitionElementOfHLAPI"}, dependsOnMethods={"PartitionElementOfHLAPI_LLAPI"})
	public void PartitionElementOfHLAPI_4_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "PartitionElementOfHLAPI"})
	public void PartitionElementOfHLAPI_LLAPI(){
	   PartitionElementOf llapi = new PartitionsFactoryImpl().createPartitionElementOf();
	   fr.lip6.move.pnml.pthlpng.partitions.hlapi.PartitionElementOfHLAPI hlapi = new PartitionElementOfHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			PartitionElementOfHLAPI elem = new PartitionElementOfHLAPI(new PartitionsFactoryImpl().createPartitionElementOf());
		...
		public void getSubtermHLAPITest(){
			...
			PartitionElementOfHLAPI elem = new PartitionElementOfHLAPI(llapi);
	...
	public void equalsTest(){
		PartitionElementOf a = new PartitionsFactoryImpl().createPartitionElementOf();
		PartitionElementOf b = new PartitionsFactoryImpl().createPartitionElementOf();
		PartitionElementOfHLAPI aprime = new PartitionElementOfHLAPI(a);
		PartitionElementOfHLAPI asecond = new PartitionElementOfHLAPI(a);
		PartitionElementOfHLAPI bprime = new PartitionElementOfHLAPI(b);
	...
	//cloning method
	//public PartitionElementOfHLAPI clone(){
	//	return new PartitionElementOfHLAPI(this);
	//}
