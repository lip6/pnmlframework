...
public class GreaterThanHLAPITest {
	...
	public void After() {
	    System.out.println("done for "+"GreaterThanHLAPI(partitions)");
	}
   ...
   @Test(groups = { "hlapi", "GreaterThanHLAPI"}, dependsOnMethods={"GreaterThanHLAPI_LLAPI"})
	...
	public void GreaterThanHLAPI_LLAPI(){
	   fr.lip6.move.pnml.pthlpng.partitions.GreaterThan llapi = new PartitionsFactoryImpl().createGreaterThan();
	   fr.lip6.move.pnml.pthlpng.partitions.hlapi.GreaterThanHLAPI hlapi = new GreaterThanHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			GreaterThanHLAPI elem = new GreaterThanHLAPI(new PartitionsFactoryImpl().createGreaterThan());
	...
	public void equalsTest(){
		fr.lip6.move.pnml.pthlpng.partitions.GreaterThan a = new PartitionsFactoryImpl().createGreaterThan();
		fr.lip6.move.pnml.pthlpng.partitions.GreaterThan b = new PartitionsFactoryImpl().createGreaterThan();
