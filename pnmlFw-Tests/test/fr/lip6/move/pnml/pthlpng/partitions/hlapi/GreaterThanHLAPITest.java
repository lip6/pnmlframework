...
public class GreaterThanHLAPITest {
   ...
   @Test(groups = { "hlapi", "GreaterThanHLAPI"}, dependsOnMethods={"GreaterThanHLAPI_LLAPI"})
	...
	public void GreaterThanHLAPI_LLAPI(){
	   GreaterThan llapi = new PartitionsFactoryImpl().createGreaterThan();
	...
	public void equalsTest(){
		GreaterThan a = new PartitionsFactoryImpl().createGreaterThan();
		GreaterThan b = new PartitionsFactoryImpl().createGreaterThan();
