 ...
 *
 * $Id ggiffo, Thu Jan 02 00:08:31 CET 2014$
 */
...
public class EmptyHLAPITest {
	...
	mr.createDocumentWorkspace("void");
			...
			itemrefsort = new fr.lip6.move.pnml.pthlpng.booleans.hlapi.BoolHLAPI(
				new BooleansFactoryImpl().createBool()
			);
   ...
   @Test(groups = { "hlapi", "EmptyHLAPI"}, dependsOnMethods={"EmptyHLAPI_LLAPI"})
	...
	public void EmptyHLAPI_LLAPI(){
	   ...
	   fr.lip6.move.pnml.pthlpng.multisets.hlapi.EmptyHLAPI hlapi = new EmptyHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getRefsortHLAPITest(){
			EmptyHLAPI elem = new EmptyHLAPI(new MultisetsFactoryImpl().createEmpty());
				...
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.pthlpng.booleans.hlapi.BoolHLAPI(new BooleansFactoryImpl().createBool()));
				...
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.pthlpng.terms.hlapi.ProductSortHLAPI(new TermsFactoryImpl().createProductSort()));
				...
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.pthlpng.terms.hlapi.UserSortHLAPI(new TermsFactoryImpl().createUserSort()));
