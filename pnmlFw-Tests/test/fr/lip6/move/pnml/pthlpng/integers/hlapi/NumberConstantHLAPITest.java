...
public class NumberConstantHLAPITest {
	...
	mr.createDocumentWorkspace("void");
			...
			itemtype = new fr.lip6.move.pnml.pthlpng.integers.hlapi.NaturalHLAPI(
				new IntegersFactoryImpl().createNatural()
			);
   ...
   @Test(groups = { "hlapi", "NumberConstantHLAPI"}, dependsOnMethods={"NumberConstantHLAPI_LLAPI"})
	...
	public void NumberConstantHLAPI_LLAPI(){
	   ...
	   fr.lip6.move.pnml.pthlpng.integers.hlapi.NumberConstantHLAPI hlapi = new NumberConstantHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getTypeHLAPITest(){
			NumberConstantHLAPI elem = new NumberConstantHLAPI(new IntegersFactoryImpl().createNumberConstant());
				...
				elem.setTypeHLAPI(new fr.lip6.move.pnml.pthlpng.integers.hlapi.NaturalHLAPI(new IntegersFactoryImpl().createNatural()));
				...
				elem.setTypeHLAPI(new fr.lip6.move.pnml.pthlpng.integers.hlapi.PositiveHLAPI(new IntegersFactoryImpl().createPositive()));
				...
				elem.setTypeHLAPI(new fr.lip6.move.pnml.pthlpng.integers.hlapi.HLIntegerHLAPI(new IntegersFactoryImpl().createHLInteger()));
