...
public class LessThanOrEqualHLAPITest {
   ...
   @Test(groups = { "hlapi", "LessThanOrEqualHLAPI"}, dependsOnMethods={"LessThanOrEqualHLAPI_LLAPI"})
	...
	public void LessThanOrEqualHLAPI_LLAPI(){
	   LessThanOrEqual llapi = new IntegersFactoryImpl().createLessThanOrEqual();
	   fr.lip6.move.pnml.pthlpng.integers.hlapi.LessThanOrEqualHLAPI hlapi = new LessThanOrEqualHLAPI(llapi);
	...
	public void equalsTest(){
		LessThanOrEqual a = new IntegersFactoryImpl().createLessThanOrEqual();
		LessThanOrEqual b = new IntegersFactoryImpl().createLessThanOrEqual();
