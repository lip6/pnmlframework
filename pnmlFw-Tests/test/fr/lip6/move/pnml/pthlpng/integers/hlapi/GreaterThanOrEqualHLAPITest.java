...
public class GreaterThanOrEqualHLAPITest {
   ...
   @Test(groups = { "hlapi", "GreaterThanOrEqualHLAPI"}, dependsOnMethods={"GreaterThanOrEqualHLAPI_LLAPI"})
	...
	public void GreaterThanOrEqualHLAPI_LLAPI(){
	   GreaterThanOrEqual llapi = new IntegersFactoryImpl().createGreaterThanOrEqual();
	   fr.lip6.move.pnml.pthlpng.integers.hlapi.GreaterThanOrEqualHLAPI hlapi = new GreaterThanOrEqualHLAPI(llapi);
	...
	public void equalsTest(){
		GreaterThanOrEqual a = new IntegersFactoryImpl().createGreaterThanOrEqual();
		GreaterThanOrEqual b = new IntegersFactoryImpl().createGreaterThanOrEqual();
