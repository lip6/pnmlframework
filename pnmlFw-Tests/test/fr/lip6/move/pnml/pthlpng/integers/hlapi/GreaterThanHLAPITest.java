...
public class GreaterThanHLAPITest {
   ...
   @Test(groups = { "hlapi", "GreaterThanHLAPI"}, dependsOnMethods={"GreaterThanHLAPI_LLAPI"})
	...
	public void GreaterThanHLAPI_LLAPI(){
	   GreaterThan llapi = new IntegersFactoryImpl().createGreaterThan();
	   fr.lip6.move.pnml.pthlpng.integers.hlapi.GreaterThanHLAPI hlapi = new GreaterThanHLAPI(llapi);
	...
	public void equalsTest(){
		GreaterThan a = new IntegersFactoryImpl().createGreaterThan();
		GreaterThan b = new IntegersFactoryImpl().createGreaterThan();
