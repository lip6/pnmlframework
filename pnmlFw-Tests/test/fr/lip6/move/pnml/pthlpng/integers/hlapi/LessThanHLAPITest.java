...
public class LessThanHLAPITest {
   ...
   @Test(groups = { "hlapi", "LessThanHLAPI"}, dependsOnMethods={"LessThanHLAPI_LLAPI"})
	...
	public void LessThanHLAPI_LLAPI(){
	   LessThan llapi = new IntegersFactoryImpl().createLessThan();
	   fr.lip6.move.pnml.pthlpng.integers.hlapi.LessThanHLAPI hlapi = new LessThanHLAPI(llapi);
	...
	public void equalsTest(){
		LessThan a = new IntegersFactoryImpl().createLessThan();
		LessThan b = new IntegersFactoryImpl().createLessThan();
