...
public class PageHLAPITest {
   ...
   @Test(groups = { "hlapi", "PageHLAPI"}, dependsOnMethods={"PageHLAPI_LLAPI"})
	...
	public void PageHLAPI_LLAPI(){
	   ...
	   fr.lip6.move.pnml.pthlpng.hlcorestructure.hlapi.PageHLAPI hlapi = new PageHLAPI(llapi);
	...
	//Special getter for list of generics object, return only one object type.
		...
		public void getObjects_hlcorestructure_PageHLAPITest(){
			...
			PageHLAPI elem = new PageHLAPI(llapi);
			List<fr.lip6.move.pnml.pthlpng.hlcorestructure.hlapi.PageHLAPI> totest = elem.getObjects_hlcorestructure_PageHLAPI();
		...
		public void getObjects_hlcorestructure_ArcHLAPITest(){
			...
			PageHLAPI elem = new PageHLAPI(llapi);
			List<fr.lip6.move.pnml.pthlpng.hlcorestructure.hlapi.ArcHLAPI> totest = elem.getObjects_hlcorestructure_ArcHLAPI();
		...
		public void getObjects_hlcorestructure_PlaceHLAPITest(){
			...
			PageHLAPI elem = new PageHLAPI(llapi);
			List<fr.lip6.move.pnml.pthlpng.hlcorestructure.hlapi.PlaceHLAPI> totest = elem.getObjects_hlcorestructure_PlaceHLAPI();
		...
		public void getObjects_hlcorestructure_RefTransitionHLAPITest(){
			...
			PageHLAPI elem = new PageHLAPI(llapi);
			List<fr.lip6.move.pnml.pthlpng.hlcorestructure.hlapi.RefTransitionHLAPI> totest = elem.getObjects_hlcorestructure_RefTransitionHLAPI();
		...
		public void getObjects_hlcorestructure_TransitionHLAPITest(){
			...
			PageHLAPI elem = new PageHLAPI(llapi);
			List<fr.lip6.move.pnml.pthlpng.hlcorestructure.hlapi.TransitionHLAPI> totest = elem.getObjects_hlcorestructure_TransitionHLAPI();
		...
		public void getObjects_hlcorestructure_RefPlaceHLAPITest(){
			...
			PageHLAPI elem = new PageHLAPI(llapi);
			List<fr.lip6.move.pnml.pthlpng.hlcorestructure.hlapi.RefPlaceHLAPI> totest = elem.getObjects_hlcorestructure_RefPlaceHLAPI();
