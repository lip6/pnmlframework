...
public class NameHLAPITest {
	...
	mr.createDocumentWorkspace("void");
		...
		itemcontainerNamePnObject = new fr.lip6.move.pnml.pthlpng.hlcorestructure.hlapi.PageHLAPI(
   ...
   @Test(groups = { "hlapi", "NameHLAPI"}, dependsOnMethods={"NameHLAPI_LLAPI"})
	...
	public void NameHLAPI_LLAPI(){
	   ...
	   fr.lip6.move.pnml.pthlpng.hlcorestructure.hlapi.NameHLAPI hlapi = new NameHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getContainerNamePnObjectHLAPITest(){
			NameHLAPI elem = new NameHLAPI(new HlcorestructureFactoryImpl().createName());
				...
				elem.setContainerNamePnObjectHLAPI(new fr.lip6.move.pnml.pthlpng.hlcorestructure.hlapi.PageHLAPI(new HlcorestructureFactoryImpl().createPage()));
				...
				elem.setContainerNamePnObjectHLAPI(new fr.lip6.move.pnml.pthlpng.hlcorestructure.hlapi.ArcHLAPI(new HlcorestructureFactoryImpl().createArc()));
				...
				elem.setContainerNamePnObjectHLAPI(new fr.lip6.move.pnml.pthlpng.hlcorestructure.hlapi.PlaceHLAPI(new HlcorestructureFactoryImpl().createPlace()));
				...
				elem.setContainerNamePnObjectHLAPI(new fr.lip6.move.pnml.pthlpng.hlcorestructure.hlapi.RefTransitionHLAPI(new HlcorestructureFactoryImpl().createRefTransition()));
				...
				elem.setContainerNamePnObjectHLAPI(new fr.lip6.move.pnml.pthlpng.hlcorestructure.hlapi.TransitionHLAPI(new HlcorestructureFactoryImpl().createTransition()));
				...
				elem.setContainerNamePnObjectHLAPI(new fr.lip6.move.pnml.pthlpng.hlcorestructure.hlapi.RefPlaceHLAPI(new HlcorestructureFactoryImpl().createRefPlace()));
