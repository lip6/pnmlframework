...
public class PlaceHLAPITest {
	...
	public void After() {
	    System.out.println("done for "+"PlaceHLAPI(pnmlcoremodel)");
	}
   ...
   @Test(groups = { "hlapi", "PlaceHLAPI"}, dependsOnMethods={"PlaceHLAPI_LLAPI"})
	...
	public void PlaceHLAPI_LLAPI(){
	   Place llapi = new PnmlcoremodelFactoryImpl().createPlace();
	   fr.lip6.move.pnml.pnmlcoremodel.hlapi.PlaceHLAPI hlapi = new PlaceHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getNameHLAPITest(){
			PlaceHLAPI elem = new PlaceHLAPI(new PnmlcoremodelFactoryImpl().createPlace());
	...
	public void equalsTest(){
		Place a = new PnmlcoremodelFactoryImpl().createPlace();
		Place b = new PnmlcoremodelFactoryImpl().createPlace();
