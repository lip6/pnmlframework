...
public class UserOperatorHLAPITest {
	...
	mr.createDocumentWorkspace("void");
			...
			itemoutput = new fr.lip6.move.pnml.symmetricnet.terms.hlapi.MultisetSortHLAPI(
				new TermsFactoryImpl().createMultisetSort()
			);
			...
			itemdeclaration = new fr.lip6.move.pnml.symmetricnet.terms.hlapi.NamedOperatorHLAPI(
		...
		itemcontainerOperator = new fr.lip6.move.pnml.symmetricnet.terms.hlapi.TupleHLAPI(
   ...
   @Test(groups = { "hlapi", "UserOperatorHLAPI"}, dependsOnMethods={"UserOperatorHLAPI_LLAPI"})
	...
	public void UserOperatorHLAPI_LLAPI(){
	   ...
	   fr.lip6.move.pnml.symmetricnet.terms.hlapi.UserOperatorHLAPI hlapi = new UserOperatorHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getDeclarationHLAPITest(){
			UserOperatorHLAPI elem = new UserOperatorHLAPI(new TermsFactoryImpl().createUserOperator());
				...
				elem.setDeclarationHLAPI(new fr.lip6.move.pnml.symmetricnet.terms.hlapi.NamedOperatorHLAPI(new TermsFactoryImpl().createNamedOperator()));
				...
				elem.setDeclarationHLAPI(new fr.lip6.move.pnml.symmetricnet.finiteEnumerations.hlapi.FEConstantHLAPI(new FiniteEnumerationsFactoryImpl().createFEConstant()));
				...
				elem.setDeclarationHLAPI(new fr.lip6.move.pnml.symmetricnet.partitions.hlapi.PartitionElementHLAPI(new PartitionsFactoryImpl().createPartitionElement()));
