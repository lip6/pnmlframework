...
public class PredecessorHLAPITest {
	...
	@AfterTest(groups = { "PredecessorHLAPI", "hlapi" })
	public void After() {
	    System.out.println("done for "+"PredecessorHLAPI(cyclicEnumerations)");
	}


	@BeforeMethod(groups = { "PredecessorHLAPI", "hlapi" })
	...
	mr.createDocumentWorkspace("void");
			...
			itemsort = new fr.lip6.move.pnml.symmetricnet.cyclicEnumerations.hlapi.CyclicEnumerationHLAPI(
			...
			itemoutput = new fr.lip6.move.pnml.symmetricnet.cyclicEnumerations.hlapi.CyclicEnumerationHLAPI(
				new CyclicEnumerationsFactoryImpl().createCyclicEnumeration()
			);
		...
		itemcontainerOperator = new fr.lip6.move.pnml.symmetricnet.cyclicEnumerations.hlapi.SuccessorHLAPI(
	 ...
	 * excepted container.
	 */
	@Test(groups = { "hlapi", "PredecessorHLAPI"}, dependsOnMethods={"PredecessorHLAPI_LLAPI"})
	public void PredecessorHLAPI_1(){//BEGIN CONSTRUCTOR BODY
   @SuppressWarnings("unused")
	PredecessorHLAPI totest = new PredecessorHLAPI(
		itemsort
		,	
		itemoutput
	);
	 ...
	 */
	@Test(groups = { "hlapi", "PredecessorHLAPI"}, dependsOnMethods={"PredecessorHLAPI_LLAPI"})
	public void PredecessorHLAPI_2_containerOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "PredecessorHLAPI"}, dependsOnMethods={"PredecessorHLAPI_LLAPI"})
	public void PredecessorHLAPI_2_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "PredecessorHLAPI"}, dependsOnMethods={"PredecessorHLAPI_LLAPI"})
	public void PredecessorHLAPI_2_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "PredecessorHLAPI"}, dependsOnMethods={"PredecessorHLAPI_LLAPI"})
	public void PredecessorHLAPI_2_containerCondition(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "PredecessorHLAPI"}, dependsOnMethods={"PredecessorHLAPI_LLAPI"})
	public void PredecessorHLAPI_2_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "PredecessorHLAPI"}, dependsOnMethods={"PredecessorHLAPI_LLAPI"})
	public void PredecessorHLAPI_2_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "PredecessorHLAPI"}, dependsOnMethods={"PredecessorHLAPI_LLAPI"})
	public void PredecessorHLAPI_4_containerOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "PredecessorHLAPI"}, dependsOnMethods={"PredecessorHLAPI_LLAPI"})
	public void PredecessorHLAPI_4_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "PredecessorHLAPI"}, dependsOnMethods={"PredecessorHLAPI_LLAPI"})
	public void PredecessorHLAPI_4_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "PredecessorHLAPI"}, dependsOnMethods={"PredecessorHLAPI_LLAPI"})
	public void PredecessorHLAPI_4_containerCondition(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "PredecessorHLAPI"}, dependsOnMethods={"PredecessorHLAPI_LLAPI"})
	public void PredecessorHLAPI_4_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "PredecessorHLAPI"}, dependsOnMethods={"PredecessorHLAPI_LLAPI"})
	public void PredecessorHLAPI_4_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "PredecessorHLAPI"})
	public void PredecessorHLAPI_LLAPI(){
	   Predecessor llapi = new CyclicEnumerationsFactoryImpl().createPredecessor();
	   fr.lip6.move.pnml.symmetricnet.cyclicEnumerations.hlapi.PredecessorHLAPI hlapi = new PredecessorHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			PredecessorHLAPI elem = new PredecessorHLAPI(new CyclicEnumerationsFactoryImpl().createPredecessor());
		...
		public void getSubtermHLAPITest(){
			...
			PredecessorHLAPI elem = new PredecessorHLAPI(llapi);
	...
	public void equalsTest(){
		Predecessor a = new CyclicEnumerationsFactoryImpl().createPredecessor();
		Predecessor b = new CyclicEnumerationsFactoryImpl().createPredecessor();
		PredecessorHLAPI aprime = new PredecessorHLAPI(a);
		PredecessorHLAPI asecond = new PredecessorHLAPI(a);
		PredecessorHLAPI bprime = new PredecessorHLAPI(b);
	...
	//cloning method
	//public PredecessorHLAPI clone(){
	//	return new PredecessorHLAPI(this);
	//}
