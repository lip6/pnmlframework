...
public class SuccessorHLAPITest {
	...
	@AfterTest(groups = { "SuccessorHLAPI", "hlapi" })
	public void After() {
	    System.out.println("done for "+"SuccessorHLAPI(cyclicEnumerations)");
	}


	@BeforeMethod(groups = { "SuccessorHLAPI", "hlapi" })
	 ...
	 * excepted container.
	 */
	@Test(groups = { "hlapi", "SuccessorHLAPI"}, dependsOnMethods={"SuccessorHLAPI_LLAPI"})
	public void SuccessorHLAPI_1(){//BEGIN CONSTRUCTOR BODY
   @SuppressWarnings("unused")
	SuccessorHLAPI totest = new SuccessorHLAPI(
		itemsort
		,	
		itemoutput
	);
	 ...
	 */
	@Test(groups = { "hlapi", "SuccessorHLAPI"}, dependsOnMethods={"SuccessorHLAPI_LLAPI"})
	public void SuccessorHLAPI_2_containerOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "SuccessorHLAPI"}, dependsOnMethods={"SuccessorHLAPI_LLAPI"})
	public void SuccessorHLAPI_2_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "SuccessorHLAPI"}, dependsOnMethods={"SuccessorHLAPI_LLAPI"})
	public void SuccessorHLAPI_2_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "SuccessorHLAPI"}, dependsOnMethods={"SuccessorHLAPI_LLAPI"})
	public void SuccessorHLAPI_2_containerCondition(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "SuccessorHLAPI"}, dependsOnMethods={"SuccessorHLAPI_LLAPI"})
	public void SuccessorHLAPI_2_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "SuccessorHLAPI"}, dependsOnMethods={"SuccessorHLAPI_LLAPI"})
	public void SuccessorHLAPI_2_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "SuccessorHLAPI"}, dependsOnMethods={"SuccessorHLAPI_LLAPI"})
	public void SuccessorHLAPI_4_containerOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "SuccessorHLAPI"}, dependsOnMethods={"SuccessorHLAPI_LLAPI"})
	public void SuccessorHLAPI_4_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "SuccessorHLAPI"}, dependsOnMethods={"SuccessorHLAPI_LLAPI"})
	public void SuccessorHLAPI_4_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "SuccessorHLAPI"}, dependsOnMethods={"SuccessorHLAPI_LLAPI"})
	public void SuccessorHLAPI_4_containerCondition(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "SuccessorHLAPI"}, dependsOnMethods={"SuccessorHLAPI_LLAPI"})
	public void SuccessorHLAPI_4_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "SuccessorHLAPI"}, dependsOnMethods={"SuccessorHLAPI_LLAPI"})
	public void SuccessorHLAPI_4_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "SuccessorHLAPI"})
	public void SuccessorHLAPI_LLAPI(){
	   Successor llapi = new CyclicEnumerationsFactoryImpl().createSuccessor();
	   fr.lip6.move.pnml.symmetricnet.cyclicEnumerations.hlapi.SuccessorHLAPI hlapi = new SuccessorHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			SuccessorHLAPI elem = new SuccessorHLAPI(new CyclicEnumerationsFactoryImpl().createSuccessor());
		...
		public void getSubtermHLAPITest(){
			...
			SuccessorHLAPI elem = new SuccessorHLAPI(llapi);
	...
	public void equalsTest(){
		Successor a = new CyclicEnumerationsFactoryImpl().createSuccessor();
		Successor b = new CyclicEnumerationsFactoryImpl().createSuccessor();
		SuccessorHLAPI aprime = new SuccessorHLAPI(a);
		SuccessorHLAPI asecond = new SuccessorHLAPI(a);
		SuccessorHLAPI bprime = new SuccessorHLAPI(b);
	...
	//cloning method
	//public SuccessorHLAPI clone(){
	//	return new SuccessorHLAPI(this);
	//}
