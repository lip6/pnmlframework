...
public class RefTransitionHLAPITest {
	...
	mr.createDocumentWorkspace("void");
			...
			itemref = new fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.RefTransitionHLAPI(
   ...
   @Test(groups = { "hlapi", "RefTransitionHLAPI"}, dependsOnMethods={"RefTransitionHLAPI_LLAPI"})
	...
	public void RefTransitionHLAPI_LLAPI(){
	   ...
	   fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.RefTransitionHLAPI hlapi = new RefTransitionHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getRefHLAPITest(){
			RefTransitionHLAPI elem = new RefTransitionHLAPI(new HlcorestructureFactoryImpl().createRefTransition());
				...
				elem.setRefHLAPI(new fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.RefTransitionHLAPI(new HlcorestructureFactoryImpl().createRefTransition()));
				...
				elem.setRefHLAPI(new fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.TransitionHLAPI(new HlcorestructureFactoryImpl().createTransition()));
