...
public class SubtractionHLAPITest {
	...
	@AfterTest(groups = { "SubtractionHLAPI", "hlapi" })
	public void After() {
	    System.out.println("done for "+"SubtractionHLAPI(integers)");
	}


	@BeforeMethod(groups = { "SubtractionHLAPI", "hlapi" })
	 ...
	 * excepted container.
	 */
	@Test(groups = { "hlapi", "SubtractionHLAPI"}, dependsOnMethods={"SubtractionHLAPI_LLAPI"})
	public void SubtractionHLAPI_1(){//BEGIN CONSTRUCTOR BODY
   @SuppressWarnings("unused")
	SubtractionHLAPI totest = new SubtractionHLAPI(
		itemsort
		,	
		itemoutput
	);
	 ...
	 */
	@Test(groups = { "hlapi", "SubtractionHLAPI"}, dependsOnMethods={"SubtractionHLAPI_LLAPI"})
	public void SubtractionHLAPI_2_containerOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "SubtractionHLAPI"}, dependsOnMethods={"SubtractionHLAPI_LLAPI"})
	public void SubtractionHLAPI_2_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "SubtractionHLAPI"}, dependsOnMethods={"SubtractionHLAPI_LLAPI"})
	public void SubtractionHLAPI_2_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "SubtractionHLAPI"}, dependsOnMethods={"SubtractionHLAPI_LLAPI"})
	public void SubtractionHLAPI_2_containerCondition(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "SubtractionHLAPI"}, dependsOnMethods={"SubtractionHLAPI_LLAPI"})
	public void SubtractionHLAPI_2_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "SubtractionHLAPI"}, dependsOnMethods={"SubtractionHLAPI_LLAPI"})
	public void SubtractionHLAPI_2_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "SubtractionHLAPI"}, dependsOnMethods={"SubtractionHLAPI_LLAPI"})
	public void SubtractionHLAPI_4_containerOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "SubtractionHLAPI"}, dependsOnMethods={"SubtractionHLAPI_LLAPI"})
	public void SubtractionHLAPI_4_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "SubtractionHLAPI"}, dependsOnMethods={"SubtractionHLAPI_LLAPI"})
	public void SubtractionHLAPI_4_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "SubtractionHLAPI"}, dependsOnMethods={"SubtractionHLAPI_LLAPI"})
	public void SubtractionHLAPI_4_containerCondition(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "SubtractionHLAPI"}, dependsOnMethods={"SubtractionHLAPI_LLAPI"})
	public void SubtractionHLAPI_4_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "SubtractionHLAPI"}, dependsOnMethods={"SubtractionHLAPI_LLAPI"})
	public void SubtractionHLAPI_4_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "SubtractionHLAPI"})
	public void SubtractionHLAPI_LLAPI(){
	   Subtraction llapi = new IntegersFactoryImpl().createSubtraction();
	   fr.lip6.move.pnml.symmetricnet.integers.hlapi.SubtractionHLAPI hlapi = new SubtractionHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			SubtractionHLAPI elem = new SubtractionHLAPI(new IntegersFactoryImpl().createSubtraction());
		...
		public void getSubtermHLAPITest(){
			...
			SubtractionHLAPI elem = new SubtractionHLAPI(llapi);
	...
	public void equalsTest(){
		Subtraction a = new IntegersFactoryImpl().createSubtraction();
		Subtraction b = new IntegersFactoryImpl().createSubtraction();
		SubtractionHLAPI aprime = new SubtractionHLAPI(a);
		SubtractionHLAPI asecond = new SubtractionHLAPI(a);
		SubtractionHLAPI bprime = new SubtractionHLAPI(b);
	...
	//cloning method
	//public SubtractionHLAPI clone(){
	//	return new SubtractionHLAPI(this);
	//}
