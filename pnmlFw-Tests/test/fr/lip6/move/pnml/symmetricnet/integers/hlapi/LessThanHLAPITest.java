...
public class LessThanHLAPITest {
	...
	public void After() {
	    System.out.println("done for "+"LessThanHLAPI(integers)");
	}
   ...
   @Test(groups = { "hlapi", "LessThanHLAPI"}, dependsOnMethods={"LessThanHLAPI_LLAPI"})
	...
	public void LessThanHLAPI_LLAPI(){
	   fr.lip6.move.pnml.symmetricnet.integers.LessThan llapi = new IntegersFactoryImpl().createLessThan();
	   fr.lip6.move.pnml.symmetricnet.integers.hlapi.LessThanHLAPI hlapi = new LessThanHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			LessThanHLAPI elem = new LessThanHLAPI(new IntegersFactoryImpl().createLessThan());
	...
	public void equalsTest(){
		fr.lip6.move.pnml.symmetricnet.integers.LessThan a = new IntegersFactoryImpl().createLessThan();
		fr.lip6.move.pnml.symmetricnet.integers.LessThan b = new IntegersFactoryImpl().createLessThan();
