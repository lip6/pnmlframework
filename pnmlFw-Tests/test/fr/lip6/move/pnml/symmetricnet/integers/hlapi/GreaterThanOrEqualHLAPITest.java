...
public class GreaterThanOrEqualHLAPITest {
	...
	public void After() {
	    System.out.println("done for "+"GreaterThanOrEqualHLAPI(integers)");
	}
   ...
   @Test(groups = { "hlapi", "GreaterThanOrEqualHLAPI"}, dependsOnMethods={"GreaterThanOrEqualHLAPI_LLAPI"})
	...
	public void GreaterThanOrEqualHLAPI_LLAPI(){
	   fr.lip6.move.pnml.symmetricnet.integers.GreaterThanOrEqual llapi = new IntegersFactoryImpl().createGreaterThanOrEqual();
	   fr.lip6.move.pnml.symmetricnet.integers.hlapi.GreaterThanOrEqualHLAPI hlapi = new GreaterThanOrEqualHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			GreaterThanOrEqualHLAPI elem = new GreaterThanOrEqualHLAPI(new IntegersFactoryImpl().createGreaterThanOrEqual());
	...
	public void equalsTest(){
		fr.lip6.move.pnml.symmetricnet.integers.GreaterThanOrEqual a = new IntegersFactoryImpl().createGreaterThanOrEqual();
		fr.lip6.move.pnml.symmetricnet.integers.GreaterThanOrEqual b = new IntegersFactoryImpl().createGreaterThanOrEqual();
