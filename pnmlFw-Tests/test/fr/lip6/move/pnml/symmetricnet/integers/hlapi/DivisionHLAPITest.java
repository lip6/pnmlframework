...
public class DivisionHLAPITest {
	...
	@AfterTest(groups = { "DivisionHLAPI", "hlapi" })
	public void After() {
	    System.out.println("done for "+"DivisionHLAPI(integers)");
	}


	@BeforeMethod(groups = { "DivisionHLAPI", "hlapi" })
	 ...
	 * excepted container.
	 */
	@Test(groups = { "hlapi", "DivisionHLAPI"}, dependsOnMethods={"DivisionHLAPI_LLAPI"})
	public void DivisionHLAPI_1(){//BEGIN CONSTRUCTOR BODY
   @SuppressWarnings("unused")
	DivisionHLAPI totest = new DivisionHLAPI(
		itemsort
		,	
		itemoutput
	);
	 ...
	 */
	@Test(groups = { "hlapi", "DivisionHLAPI"}, dependsOnMethods={"DivisionHLAPI_LLAPI"})
	public void DivisionHLAPI_2_containerOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "DivisionHLAPI"}, dependsOnMethods={"DivisionHLAPI_LLAPI"})
	public void DivisionHLAPI_2_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "DivisionHLAPI"}, dependsOnMethods={"DivisionHLAPI_LLAPI"})
	public void DivisionHLAPI_2_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "DivisionHLAPI"}, dependsOnMethods={"DivisionHLAPI_LLAPI"})
	public void DivisionHLAPI_2_containerCondition(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "DivisionHLAPI"}, dependsOnMethods={"DivisionHLAPI_LLAPI"})
	public void DivisionHLAPI_2_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "DivisionHLAPI"}, dependsOnMethods={"DivisionHLAPI_LLAPI"})
	public void DivisionHLAPI_2_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "DivisionHLAPI"}, dependsOnMethods={"DivisionHLAPI_LLAPI"})
	public void DivisionHLAPI_4_containerOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "DivisionHLAPI"}, dependsOnMethods={"DivisionHLAPI_LLAPI"})
	public void DivisionHLAPI_4_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "DivisionHLAPI"}, dependsOnMethods={"DivisionHLAPI_LLAPI"})
	public void DivisionHLAPI_4_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "DivisionHLAPI"}, dependsOnMethods={"DivisionHLAPI_LLAPI"})
	public void DivisionHLAPI_4_containerCondition(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "DivisionHLAPI"}, dependsOnMethods={"DivisionHLAPI_LLAPI"})
	public void DivisionHLAPI_4_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "DivisionHLAPI"}, dependsOnMethods={"DivisionHLAPI_LLAPI"})
	public void DivisionHLAPI_4_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "DivisionHLAPI"})
	public void DivisionHLAPI_LLAPI(){
	   Division llapi = new IntegersFactoryImpl().createDivision();
	   fr.lip6.move.pnml.symmetricnet.integers.hlapi.DivisionHLAPI hlapi = new DivisionHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			DivisionHLAPI elem = new DivisionHLAPI(new IntegersFactoryImpl().createDivision());
		...
		public void getSubtermHLAPITest(){
			...
			DivisionHLAPI elem = new DivisionHLAPI(llapi);
	...
	public void equalsTest(){
		Division a = new IntegersFactoryImpl().createDivision();
		Division b = new IntegersFactoryImpl().createDivision();
		DivisionHLAPI aprime = new DivisionHLAPI(a);
		DivisionHLAPI asecond = new DivisionHLAPI(a);
		DivisionHLAPI bprime = new DivisionHLAPI(b);
	...
	//cloning method
	//public DivisionHLAPI clone(){
	//	return new DivisionHLAPI(this);
	//}
