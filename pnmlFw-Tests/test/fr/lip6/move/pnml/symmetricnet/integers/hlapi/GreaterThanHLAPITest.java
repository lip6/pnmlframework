...
public class GreaterThanHLAPITest {
	...
	public void After() {
	    System.out.println("done for "+"GreaterThanHLAPI(integers)");
	}
   ...
   @Test(groups = { "hlapi", "GreaterThanHLAPI"}, dependsOnMethods={"GreaterThanHLAPI_LLAPI"})
	...
	public void GreaterThanHLAPI_LLAPI(){
	   fr.lip6.move.pnml.symmetricnet.integers.GreaterThan llapi = new IntegersFactoryImpl().createGreaterThan();
	   fr.lip6.move.pnml.symmetricnet.integers.hlapi.GreaterThanHLAPI hlapi = new GreaterThanHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			GreaterThanHLAPI elem = new GreaterThanHLAPI(new IntegersFactoryImpl().createGreaterThan());
	...
	public void equalsTest(){
		fr.lip6.move.pnml.symmetricnet.integers.GreaterThan a = new IntegersFactoryImpl().createGreaterThan();
		fr.lip6.move.pnml.symmetricnet.integers.GreaterThan b = new IntegersFactoryImpl().createGreaterThan();
