...
public class LessThanOrEqualHLAPITest {
	...
	public void After() {
	    System.out.println("done for "+"LessThanOrEqualHLAPI(integers)");
	}
   ...
   @Test(groups = { "hlapi", "LessThanOrEqualHLAPI"}, dependsOnMethods={"LessThanOrEqualHLAPI_LLAPI"})
	...
	public void LessThanOrEqualHLAPI_LLAPI(){
	   fr.lip6.move.pnml.symmetricnet.integers.LessThanOrEqual llapi = new IntegersFactoryImpl().createLessThanOrEqual();
	   fr.lip6.move.pnml.symmetricnet.integers.hlapi.LessThanOrEqualHLAPI hlapi = new LessThanOrEqualHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			LessThanOrEqualHLAPI elem = new LessThanOrEqualHLAPI(new IntegersFactoryImpl().createLessThanOrEqual());
	...
	public void equalsTest(){
		fr.lip6.move.pnml.symmetricnet.integers.LessThanOrEqual a = new IntegersFactoryImpl().createLessThanOrEqual();
		fr.lip6.move.pnml.symmetricnet.integers.LessThanOrEqual b = new IntegersFactoryImpl().createLessThanOrEqual();
