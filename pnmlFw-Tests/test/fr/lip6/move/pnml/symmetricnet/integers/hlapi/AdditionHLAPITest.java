...
public class AdditionHLAPITest {
	...
	@AfterTest(groups = { "AdditionHLAPI", "hlapi" })
	public void After() {
	    System.out.println("done for "+"AdditionHLAPI(integers)");
	}
	 ...
	 * excepted container.
	 */
	@Test(groups = { "hlapi", "AdditionHLAPI"}, dependsOnMethods={"AdditionHLAPI_LLAPI"})
	public void AdditionHLAPI_1(){//BEGIN CONSTRUCTOR BODY
   @SuppressWarnings("unused")
	AdditionHLAPI totest = new AdditionHLAPI(
		itemsort
		,	
		itemoutput
	);
	 ...
	 */
	@Test(groups = { "hlapi", "AdditionHLAPI"}, dependsOnMethods={"AdditionHLAPI_LLAPI"})
	public void AdditionHLAPI_2_containerOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AdditionHLAPI"}, dependsOnMethods={"AdditionHLAPI_LLAPI"})
	public void AdditionHLAPI_2_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AdditionHLAPI"}, dependsOnMethods={"AdditionHLAPI_LLAPI"})
	public void AdditionHLAPI_2_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AdditionHLAPI"}, dependsOnMethods={"AdditionHLAPI_LLAPI"})
	public void AdditionHLAPI_2_containerCondition(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AdditionHLAPI"}, dependsOnMethods={"AdditionHLAPI_LLAPI"})
	public void AdditionHLAPI_2_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AdditionHLAPI"}, dependsOnMethods={"AdditionHLAPI_LLAPI"})
	public void AdditionHLAPI_2_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AdditionHLAPI"}, dependsOnMethods={"AdditionHLAPI_LLAPI"})
	public void AdditionHLAPI_4_containerOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AdditionHLAPI"}, dependsOnMethods={"AdditionHLAPI_LLAPI"})
	public void AdditionHLAPI_4_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AdditionHLAPI"}, dependsOnMethods={"AdditionHLAPI_LLAPI"})
	public void AdditionHLAPI_4_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AdditionHLAPI"}, dependsOnMethods={"AdditionHLAPI_LLAPI"})
	public void AdditionHLAPI_4_containerCondition(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AdditionHLAPI"}, dependsOnMethods={"AdditionHLAPI_LLAPI"})
	public void AdditionHLAPI_4_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AdditionHLAPI"}, dependsOnMethods={"AdditionHLAPI_LLAPI"})
	public void AdditionHLAPI_4_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AdditionHLAPI"})
	public void AdditionHLAPI_LLAPI(){
	   Addition llapi = new IntegersFactoryImpl().createAddition();
	   fr.lip6.move.pnml.symmetricnet.integers.hlapi.AdditionHLAPI hlapi = new AdditionHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			AdditionHLAPI elem = new AdditionHLAPI(new IntegersFactoryImpl().createAddition());
		...
		public void getSubtermHLAPITest(){
			...
			AdditionHLAPI elem = new AdditionHLAPI(llapi);
	...
	public void equalsTest(){
		Addition a = new IntegersFactoryImpl().createAddition();
		Addition b = new IntegersFactoryImpl().createAddition();
		AdditionHLAPI aprime = new AdditionHLAPI(a);
		AdditionHLAPI asecond = new AdditionHLAPI(a);
		AdditionHLAPI bprime = new AdditionHLAPI(b);
	...
	//cloning method
	//public AdditionHLAPI clone(){
	//	return new AdditionHLAPI(this);
	//}
