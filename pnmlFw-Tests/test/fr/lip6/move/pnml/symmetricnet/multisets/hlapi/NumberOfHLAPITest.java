...
public class NumberOfHLAPITest {
	...
	@AfterTest(groups = { "NumberOfHLAPI", "hlapi" })
	public void After() {
	    System.out.println("done for "+"NumberOfHLAPI(multisets)");
	}
	 ...
	 * excepted container.
	 */
	@Test(groups = { "hlapi", "NumberOfHLAPI"}, dependsOnMethods={"NumberOfHLAPI_LLAPI"})
	public void NumberOfHLAPI_1(){//BEGIN CONSTRUCTOR BODY
   @SuppressWarnings("unused")
	NumberOfHLAPI totest = new NumberOfHLAPI(
		itemsort
		,	
		itemoutput
	);
	 ...
	 */
	@Test(groups = { "hlapi", "NumberOfHLAPI"}, dependsOnMethods={"NumberOfHLAPI_LLAPI"})
	public void NumberOfHLAPI_2_containerOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "NumberOfHLAPI"}, dependsOnMethods={"NumberOfHLAPI_LLAPI"})
	public void NumberOfHLAPI_2_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "NumberOfHLAPI"}, dependsOnMethods={"NumberOfHLAPI_LLAPI"})
	public void NumberOfHLAPI_2_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "NumberOfHLAPI"}, dependsOnMethods={"NumberOfHLAPI_LLAPI"})
	public void NumberOfHLAPI_2_containerCondition(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "NumberOfHLAPI"}, dependsOnMethods={"NumberOfHLAPI_LLAPI"})
	public void NumberOfHLAPI_2_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "NumberOfHLAPI"}, dependsOnMethods={"NumberOfHLAPI_LLAPI"})
	public void NumberOfHLAPI_2_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "NumberOfHLAPI"}, dependsOnMethods={"NumberOfHLAPI_LLAPI"})
	public void NumberOfHLAPI_4_containerOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "NumberOfHLAPI"}, dependsOnMethods={"NumberOfHLAPI_LLAPI"})
	public void NumberOfHLAPI_4_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "NumberOfHLAPI"}, dependsOnMethods={"NumberOfHLAPI_LLAPI"})
	public void NumberOfHLAPI_4_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "NumberOfHLAPI"}, dependsOnMethods={"NumberOfHLAPI_LLAPI"})
	public void NumberOfHLAPI_4_containerCondition(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "NumberOfHLAPI"}, dependsOnMethods={"NumberOfHLAPI_LLAPI"})
	public void NumberOfHLAPI_4_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "NumberOfHLAPI"}, dependsOnMethods={"NumberOfHLAPI_LLAPI"})
	public void NumberOfHLAPI_4_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "NumberOfHLAPI"})
	public void NumberOfHLAPI_LLAPI(){
	   NumberOf llapi = new MultisetsFactoryImpl().createNumberOf();
	   fr.lip6.move.pnml.symmetricnet.multisets.hlapi.NumberOfHLAPI hlapi = new NumberOfHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			NumberOfHLAPI elem = new NumberOfHLAPI(new MultisetsFactoryImpl().createNumberOf());
		...
		public void getSubtermHLAPITest(){
			...
			NumberOfHLAPI elem = new NumberOfHLAPI(llapi);
	...
	public void equalsTest(){
		NumberOf a = new MultisetsFactoryImpl().createNumberOf();
		NumberOf b = new MultisetsFactoryImpl().createNumberOf();
		NumberOfHLAPI aprime = new NumberOfHLAPI(a);
		NumberOfHLAPI asecond = new NumberOfHLAPI(a);
		NumberOfHLAPI bprime = new NumberOfHLAPI(b);
	...
	//cloning method
	//public NumberOfHLAPI clone(){
	//	return new NumberOfHLAPI(this);
	//}
