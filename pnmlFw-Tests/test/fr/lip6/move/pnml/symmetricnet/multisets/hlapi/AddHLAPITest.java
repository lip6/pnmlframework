...
public class AddHLAPITest {
	...
	@AfterTest(groups = { "AddHLAPI", "hlapi" })
	public void After() {
	    System.out.println("done for "+"AddHLAPI(multisets)");
	}


	@BeforeMethod(groups = { "AddHLAPI", "hlapi" })
	 ...
	 * excepted container.
	 */
	@Test(groups = { "hlapi", "AddHLAPI"}, dependsOnMethods={"AddHLAPI_LLAPI"})
	public void AddHLAPI_1(){//BEGIN CONSTRUCTOR BODY
   @SuppressWarnings("unused")
	AddHLAPI totest = new AddHLAPI(
		itemsort
		,	
		itemoutput
	);
	 ...
	 */
	@Test(groups = { "hlapi", "AddHLAPI"}, dependsOnMethods={"AddHLAPI_LLAPI"})
	public void AddHLAPI_2_containerOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AddHLAPI"}, dependsOnMethods={"AddHLAPI_LLAPI"})
	public void AddHLAPI_2_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AddHLAPI"}, dependsOnMethods={"AddHLAPI_LLAPI"})
	public void AddHLAPI_2_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AddHLAPI"}, dependsOnMethods={"AddHLAPI_LLAPI"})
	public void AddHLAPI_2_containerCondition(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AddHLAPI"}, dependsOnMethods={"AddHLAPI_LLAPI"})
	public void AddHLAPI_2_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AddHLAPI"}, dependsOnMethods={"AddHLAPI_LLAPI"})
	public void AddHLAPI_2_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AddHLAPI"}, dependsOnMethods={"AddHLAPI_LLAPI"})
	public void AddHLAPI_4_containerOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AddHLAPI"}, dependsOnMethods={"AddHLAPI_LLAPI"})
	public void AddHLAPI_4_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AddHLAPI"}, dependsOnMethods={"AddHLAPI_LLAPI"})
	public void AddHLAPI_4_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AddHLAPI"}, dependsOnMethods={"AddHLAPI_LLAPI"})
	public void AddHLAPI_4_containerCondition(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AddHLAPI"}, dependsOnMethods={"AddHLAPI_LLAPI"})
	public void AddHLAPI_4_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "AddHLAPI"}, dependsOnMethods={"AddHLAPI_LLAPI"})
	public void AddHLAPI_4_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "AddHLAPI"})
	public void AddHLAPI_LLAPI(){
	   Add llapi = new MultisetsFactoryImpl().createAdd();
	   fr.lip6.move.pnml.symmetricnet.multisets.hlapi.AddHLAPI hlapi = new AddHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			AddHLAPI elem = new AddHLAPI(new MultisetsFactoryImpl().createAdd());
		...
		public void getSubtermHLAPITest(){
			...
			AddHLAPI elem = new AddHLAPI(llapi);
	...
	public void equalsTest(){
		Add a = new MultisetsFactoryImpl().createAdd();
		Add b = new MultisetsFactoryImpl().createAdd();
		AddHLAPI aprime = new AddHLAPI(a);
		AddHLAPI asecond = new AddHLAPI(a);
		AddHLAPI bprime = new AddHLAPI(b);
	...
	//cloning method
	//public AddHLAPI clone(){
	//	return new AddHLAPI(this);
	//}
