...
public class CardinalityHLAPITest {
	...
	@AfterTest(groups = { "CardinalityHLAPI", "hlapi" })
	public void After() {
	    System.out.println("done for "+"CardinalityHLAPI(multisets)");
	}


	@BeforeMethod(groups = { "CardinalityHLAPI", "hlapi" })
	 ...
	 * excepted container.
	 */
	@Test(groups = { "hlapi", "CardinalityHLAPI"}, dependsOnMethods={"CardinalityHLAPI_LLAPI"})
	public void CardinalityHLAPI_1(){//BEGIN CONSTRUCTOR BODY
   @SuppressWarnings("unused")
	CardinalityHLAPI totest = new CardinalityHLAPI(
		itemsort
		,	
		itemoutput
	);
	 ...
	 */
	@Test(groups = { "hlapi", "CardinalityHLAPI"}, dependsOnMethods={"CardinalityHLAPI_LLAPI"})
	public void CardinalityHLAPI_2_containerOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "CardinalityHLAPI"}, dependsOnMethods={"CardinalityHLAPI_LLAPI"})
	public void CardinalityHLAPI_2_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "CardinalityHLAPI"}, dependsOnMethods={"CardinalityHLAPI_LLAPI"})
	public void CardinalityHLAPI_2_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "CardinalityHLAPI"}, dependsOnMethods={"CardinalityHLAPI_LLAPI"})
	public void CardinalityHLAPI_2_containerCondition(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "CardinalityHLAPI"}, dependsOnMethods={"CardinalityHLAPI_LLAPI"})
	public void CardinalityHLAPI_2_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "CardinalityHLAPI"}, dependsOnMethods={"CardinalityHLAPI_LLAPI"})
	public void CardinalityHLAPI_2_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "CardinalityHLAPI"}, dependsOnMethods={"CardinalityHLAPI_LLAPI"})
	public void CardinalityHLAPI_4_containerOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "CardinalityHLAPI"}, dependsOnMethods={"CardinalityHLAPI_LLAPI"})
	public void CardinalityHLAPI_4_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "CardinalityHLAPI"}, dependsOnMethods={"CardinalityHLAPI_LLAPI"})
	public void CardinalityHLAPI_4_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "CardinalityHLAPI"}, dependsOnMethods={"CardinalityHLAPI_LLAPI"})
	public void CardinalityHLAPI_4_containerCondition(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "CardinalityHLAPI"}, dependsOnMethods={"CardinalityHLAPI_LLAPI"})
	public void CardinalityHLAPI_4_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "CardinalityHLAPI"}, dependsOnMethods={"CardinalityHLAPI_LLAPI"})
	public void CardinalityHLAPI_4_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "CardinalityHLAPI"})
	public void CardinalityHLAPI_LLAPI(){
	   Cardinality llapi = new MultisetsFactoryImpl().createCardinality();
	   fr.lip6.move.pnml.symmetricnet.multisets.hlapi.CardinalityHLAPI hlapi = new CardinalityHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			CardinalityHLAPI elem = new CardinalityHLAPI(new MultisetsFactoryImpl().createCardinality());
		...
		public void getSubtermHLAPITest(){
			...
			CardinalityHLAPI elem = new CardinalityHLAPI(llapi);
	...
	public void equalsTest(){
		Cardinality a = new MultisetsFactoryImpl().createCardinality();
		Cardinality b = new MultisetsFactoryImpl().createCardinality();
		CardinalityHLAPI aprime = new CardinalityHLAPI(a);
		CardinalityHLAPI asecond = new CardinalityHLAPI(a);
		CardinalityHLAPI bprime = new CardinalityHLAPI(b);
	...
	//cloning method
	//public CardinalityHLAPI clone(){
	//	return new CardinalityHLAPI(this);
	//}
