...
public class CardinalityOfHLAPITest {
	...
	@AfterTest(groups = { "CardinalityOfHLAPI", "hlapi" })
	public void After() {
	    System.out.println("done for "+"CardinalityOfHLAPI(multisets)");
	}


	@BeforeMethod(groups = { "CardinalityOfHLAPI", "hlapi" })
	 ...
	 * excepted container.
	 */
	@Test(groups = { "hlapi", "CardinalityOfHLAPI"}, dependsOnMethods={"CardinalityOfHLAPI_LLAPI"})
	public void CardinalityOfHLAPI_1(){//BEGIN CONSTRUCTOR BODY
   @SuppressWarnings("unused")
	CardinalityOfHLAPI totest = new CardinalityOfHLAPI(
		itemsort
		,	
		itemoutput
	);
	 ...
	 */
	@Test(groups = { "hlapi", "CardinalityOfHLAPI"}, dependsOnMethods={"CardinalityOfHLAPI_LLAPI"})
	public void CardinalityOfHLAPI_2_containerOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "CardinalityOfHLAPI"}, dependsOnMethods={"CardinalityOfHLAPI_LLAPI"})
	public void CardinalityOfHLAPI_2_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "CardinalityOfHLAPI"}, dependsOnMethods={"CardinalityOfHLAPI_LLAPI"})
	public void CardinalityOfHLAPI_2_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "CardinalityOfHLAPI"}, dependsOnMethods={"CardinalityOfHLAPI_LLAPI"})
	public void CardinalityOfHLAPI_2_containerCondition(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "CardinalityOfHLAPI"}, dependsOnMethods={"CardinalityOfHLAPI_LLAPI"})
	public void CardinalityOfHLAPI_2_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "CardinalityOfHLAPI"}, dependsOnMethods={"CardinalityOfHLAPI_LLAPI"})
	public void CardinalityOfHLAPI_2_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "CardinalityOfHLAPI"}, dependsOnMethods={"CardinalityOfHLAPI_LLAPI"})
	public void CardinalityOfHLAPI_4_containerOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "CardinalityOfHLAPI"}, dependsOnMethods={"CardinalityOfHLAPI_LLAPI"})
	public void CardinalityOfHLAPI_4_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "CardinalityOfHLAPI"}, dependsOnMethods={"CardinalityOfHLAPI_LLAPI"})
	public void CardinalityOfHLAPI_4_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "CardinalityOfHLAPI"}, dependsOnMethods={"CardinalityOfHLAPI_LLAPI"})
	public void CardinalityOfHLAPI_4_containerCondition(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "CardinalityOfHLAPI"}, dependsOnMethods={"CardinalityOfHLAPI_LLAPI"})
	public void CardinalityOfHLAPI_4_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "CardinalityOfHLAPI"}, dependsOnMethods={"CardinalityOfHLAPI_LLAPI"})
	public void CardinalityOfHLAPI_4_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "CardinalityOfHLAPI"})
	public void CardinalityOfHLAPI_LLAPI(){
	   CardinalityOf llapi = new MultisetsFactoryImpl().createCardinalityOf();
	   fr.lip6.move.pnml.symmetricnet.multisets.hlapi.CardinalityOfHLAPI hlapi = new CardinalityOfHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			CardinalityOfHLAPI elem = new CardinalityOfHLAPI(new MultisetsFactoryImpl().createCardinalityOf());
		...
		public void getSubtermHLAPITest(){
			...
			CardinalityOfHLAPI elem = new CardinalityOfHLAPI(llapi);
	...
	public void equalsTest(){
		CardinalityOf a = new MultisetsFactoryImpl().createCardinalityOf();
		CardinalityOf b = new MultisetsFactoryImpl().createCardinalityOf();
		CardinalityOfHLAPI aprime = new CardinalityOfHLAPI(a);
		CardinalityOfHLAPI asecond = new CardinalityOfHLAPI(a);
		CardinalityOfHLAPI bprime = new CardinalityOfHLAPI(b);
	...
	//cloning method
	//public CardinalityOfHLAPI clone(){
	//	return new CardinalityOfHLAPI(this);
	//}
