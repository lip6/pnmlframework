...
public class ScalarProductHLAPITest {
	...
	@AfterTest(groups = { "ScalarProductHLAPI", "hlapi" })
	public void After() {
	    System.out.println("done for "+"ScalarProductHLAPI(multisets)");
	}


	@BeforeMethod(groups = { "ScalarProductHLAPI", "hlapi" })
	 ...
	 * excepted container.
	 */
	@Test(groups = { "hlapi", "ScalarProductHLAPI"}, dependsOnMethods={"ScalarProductHLAPI_LLAPI"})
	public void ScalarProductHLAPI_1(){//BEGIN CONSTRUCTOR BODY
   @SuppressWarnings("unused")
	ScalarProductHLAPI totest = new ScalarProductHLAPI(
		itemsort
		,	
		itemoutput
	);
	 ...
	 */
	@Test(groups = { "hlapi", "ScalarProductHLAPI"}, dependsOnMethods={"ScalarProductHLAPI_LLAPI"})
	public void ScalarProductHLAPI_2_containerOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ScalarProductHLAPI"}, dependsOnMethods={"ScalarProductHLAPI_LLAPI"})
	public void ScalarProductHLAPI_2_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ScalarProductHLAPI"}, dependsOnMethods={"ScalarProductHLAPI_LLAPI"})
	public void ScalarProductHLAPI_2_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ScalarProductHLAPI"}, dependsOnMethods={"ScalarProductHLAPI_LLAPI"})
	public void ScalarProductHLAPI_2_containerCondition(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ScalarProductHLAPI"}, dependsOnMethods={"ScalarProductHLAPI_LLAPI"})
	public void ScalarProductHLAPI_2_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ScalarProductHLAPI"}, dependsOnMethods={"ScalarProductHLAPI_LLAPI"})
	public void ScalarProductHLAPI_2_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ScalarProductHLAPI"}, dependsOnMethods={"ScalarProductHLAPI_LLAPI"})
	public void ScalarProductHLAPI_4_containerOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ScalarProductHLAPI"}, dependsOnMethods={"ScalarProductHLAPI_LLAPI"})
	public void ScalarProductHLAPI_4_containerNamedOperator(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ScalarProductHLAPI"}, dependsOnMethods={"ScalarProductHLAPI_LLAPI"})
	public void ScalarProductHLAPI_4_containerHLMarking(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ScalarProductHLAPI"}, dependsOnMethods={"ScalarProductHLAPI_LLAPI"})
	public void ScalarProductHLAPI_4_containerCondition(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ScalarProductHLAPI"}, dependsOnMethods={"ScalarProductHLAPI_LLAPI"})
	public void ScalarProductHLAPI_4_containerHLAnnotation(){//BEGIN CONSTRUCTOR BODY
    ...
    */
   @Test(groups = { "hlapi", "ScalarProductHLAPI"}, dependsOnMethods={"ScalarProductHLAPI_LLAPI"})
	public void ScalarProductHLAPI_4_containerPartitionElement(){//BEGIN CONSTRUCTOR BODY
	 ...
	 */
	@Test(groups = { "hlapi", "ScalarProductHLAPI"})
	public void ScalarProductHLAPI_LLAPI(){
	   ScalarProduct llapi = new MultisetsFactoryImpl().createScalarProduct();
	   fr.lip6.move.pnml.symmetricnet.multisets.hlapi.ScalarProductHLAPI hlapi = new ScalarProductHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getSortHLAPITest(){
			ScalarProductHLAPI elem = new ScalarProductHLAPI(new MultisetsFactoryImpl().createScalarProduct());
		...
		public void getSubtermHLAPITest(){
			...
			ScalarProductHLAPI elem = new ScalarProductHLAPI(llapi);
	...
	public void equalsTest(){
		ScalarProduct a = new MultisetsFactoryImpl().createScalarProduct();
		ScalarProduct b = new MultisetsFactoryImpl().createScalarProduct();
		ScalarProductHLAPI aprime = new ScalarProductHLAPI(a);
		ScalarProductHLAPI asecond = new ScalarProductHLAPI(a);
		ScalarProductHLAPI bprime = new ScalarProductHLAPI(b);
	...
	//cloning method
	//public ScalarProductHLAPI clone(){
	//	return new ScalarProductHLAPI(this);
	//}
