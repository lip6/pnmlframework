 ...
 */
package fr.lip6.move.pnml.symmetricnet.multisets.hlapi;
...
import fr.lip6.move.pnml.symmetricnet.multisets.*;
import fr.lip6.move.pnml.symmetricnet.multisets.impl.*;
...
public class EmptyHLAPITest {
	...
	mr.createDocumentWorkspace("void");
			...
			itemrefsort = new fr.lip6.move.pnml.symmetricnet.booleans.hlapi.BoolHLAPI(
				new BooleansFactoryImpl().createBool()
			);
   ...
   @Test(groups = { "hlapi", "EmptyHLAPI"}, dependsOnMethods={"EmptyHLAPI_LLAPI"})
	...
	public void EmptyHLAPI_LLAPI(){
	   ...
	   fr.lip6.move.pnml.symmetricnet.multisets.hlapi.EmptyHLAPI hlapi = new EmptyHLAPI(llapi);
	...
	//getters giving HLAPI object
		...
		public void getRefsortHLAPITest(){
			EmptyHLAPI elem = new EmptyHLAPI(new MultisetsFactoryImpl().createEmpty());
				...
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.symmetricnet.booleans.hlapi.BoolHLAPI(new BooleansFactoryImpl().createBool()));
				SortHLAPI totest_booleans_Bool = elem.getRefsortHLAPI();
				assert totest_booleans_Bool.getContainedItem().equals(elem.getRefsort());
			
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.symmetricnet.cyclicEnumerations.hlapi.CyclicEnumerationHLAPI(new CyclicEnumerationsFactoryImpl().createCyclicEnumeration()));
				...
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.symmetricnet.dots.hlapi.DotHLAPI(new DotsFactoryImpl().createDot()));
				SortHLAPI totest_dots_Dot = elem.getRefsortHLAPI();
				assert totest_dots_Dot.getContainedItem().equals(elem.getRefsort());
			
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.symmetricnet.finiteEnumerations.hlapi.FiniteEnumerationHLAPI(new FiniteEnumerationsFactoryImpl().createFiniteEnumeration()));
				...
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.symmetricnet.finiteIntRanges.hlapi.FiniteIntRangeHLAPI(new FiniteIntRangesFactoryImpl().createFiniteIntRange()));
				...
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.symmetricnet.integers.hlapi.NaturalHLAPI(new IntegersFactoryImpl().createNatural()));
				...
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.symmetricnet.integers.hlapi.PositiveHLAPI(new IntegersFactoryImpl().createPositive()));
				...
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.symmetricnet.integers.hlapi.HLIntegerHLAPI(new IntegersFactoryImpl().createHLInteger()));
				...
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.symmetricnet.terms.hlapi.MultisetSortHLAPI(new TermsFactoryImpl().createMultisetSort()));
				...
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.symmetricnet.terms.hlapi.ProductSortHLAPI(new TermsFactoryImpl().createProductSort()));
				...
				elem.setRefsortHLAPI(new fr.lip6.move.pnml.symmetricnet.terms.hlapi.UserSortHLAPI(new TermsFactoryImpl().createUserSort()));
