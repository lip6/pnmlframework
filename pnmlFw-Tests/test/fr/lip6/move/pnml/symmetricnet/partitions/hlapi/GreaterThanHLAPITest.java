...
public class GreaterThanHLAPITest {
   ...
   @Test(groups = { "hlapi", "GreaterThanHLAPI"}, dependsOnMethods={"GreaterThanHLAPI_LLAPI"})
	...
	public void GreaterThanHLAPI_LLAPI(){
	   fr.lip6.move.pnml.symmetricnet.partitions.GreaterThan llapi = new PartitionsFactoryImpl().createGreaterThan();
	   fr.lip6.move.pnml.symmetricnet.partitions.hlapi.GreaterThanHLAPI hlapi = new GreaterThanHLAPI(llapi);
	...
	public void equalsTest(){
		fr.lip6.move.pnml.symmetricnet.partitions.GreaterThan a = new PartitionsFactoryImpl().createGreaterThan();
		fr.lip6.move.pnml.symmetricnet.partitions.GreaterThan b = new PartitionsFactoryImpl().createGreaterThan();
