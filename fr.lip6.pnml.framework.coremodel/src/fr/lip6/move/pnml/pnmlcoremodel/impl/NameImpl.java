 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.NameImpl#getText <em>Text</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.NameImpl#getContainerNamePetriNet <em>Container Name Petri Net</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.NameImpl#getContainerNamePnObject <em>Container Name Pn Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NameImpl extends AnnotationImpl implements Name {
	...
	public NotificationChain basicSetContainerNamePetriNet(PetriNet newContainerNamePetriNet, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerNamePetriNet,
				PnmlcoremodelPackage.NAME__CONTAINER_NAME_PETRI_NET, msgs);
		return msgs;
	}
		...
		if (newContainerNamePetriNet != eInternalContainer()
			...
			if (newContainerNamePetriNet != null)
				msgs = ((InternalEObject) newContainerNamePetriNet).eInverseAdd(this,
						PnmlcoremodelPackage.PETRI_NET__NAME, PetriNet.class, msgs);
			msgs = basicSetContainerNamePetriNet(newContainerNamePetriNet, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.NAME__CONTAINER_NAME_PETRI_NET,
	...
	public NotificationChain basicSetContainerNamePnObject(PnObject newContainerNamePnObject, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerNamePnObject,
				PnmlcoremodelPackage.NAME__CONTAINER_NAME_PN_OBJECT, msgs);
		return msgs;
	}
		...
		if (newContainerNamePnObject != eInternalContainer()
			...
			if (newContainerNamePnObject != null)
				msgs = ((InternalEObject) newContainerNamePnObject).eInverseAdd(this,
						PnmlcoremodelPackage.PN_OBJECT__NAME, PnObject.class, msgs);
			msgs = basicSetContainerNamePnObject(newContainerNamePnObject, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.NAME__CONTAINER_NAME_PN_OBJECT,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PnmlcoremodelPackage.NAME__CONTAINER_NAME_PETRI_NET:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetContainerNamePetriNet((PetriNet) otherEnd, msgs);
		case PnmlcoremodelPackage.NAME__CONTAINER_NAME_PN_OBJECT:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case PnmlcoremodelPackage.NAME__CONTAINER_NAME_PETRI_NET:
			return eInternalContainer()
					.eInverseRemove(this, PnmlcoremodelPackage.PETRI_NET__NAME, PetriNet.class, msgs);
		case PnmlcoremodelPackage.NAME__CONTAINER_NAME_PN_OBJECT:
			return eInternalContainer()
					.eInverseRemove(this, PnmlcoremodelPackage.PN_OBJECT__NAME, PnObject.class, msgs);
		}
