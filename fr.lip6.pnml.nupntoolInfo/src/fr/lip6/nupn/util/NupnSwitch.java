...
public class NupnSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case NupnPackage.NUPN_TOOLSPECIFIC_TYPE: {
			NUPNToolspecificType nupnToolspecificType = (NUPNToolspecificType) theEObject;
			T result = caseNUPNToolspecificType(nupnToolspecificType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>NUPN Toolspecific Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>NUPN Toolspecific Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNUPNToolspecificType(NUPNToolspecificType object) {
		return null;
	}
