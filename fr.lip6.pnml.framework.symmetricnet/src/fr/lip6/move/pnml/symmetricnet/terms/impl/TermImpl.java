 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.terms.impl.TermImpl#getSort <em>Sort</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.terms.impl.TermImpl#getContainerOperator <em>Container Operator</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.terms.impl.TermImpl#getContainerNamedOperator <em>Container Named Operator</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.terms.impl.TermImpl#getContainerHLMarking <em>Container HL Marking</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.terms.impl.TermImpl#getContainerCondition <em>Container Condition</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.terms.impl.TermImpl#getContainerHLAnnotation <em>Container HL Annotation</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.terms.impl.TermImpl#getContainerPartitionElement <em>Container Partition Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
