 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.AnnotationImpl#getAnnotationgraphics <em>Annotationgraphics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
		...
		if (newAnnotationgraphics != annotationgraphics) {
			...
			if (annotationgraphics != null)
				msgs = ((InternalEObject) annotationgraphics).eInverseRemove(this,
						HlcorestructurePackage.ANNOTATION_GRAPHICS__CONTAINER_ANNOTATION, AnnotationGraphics.class,
						msgs);
