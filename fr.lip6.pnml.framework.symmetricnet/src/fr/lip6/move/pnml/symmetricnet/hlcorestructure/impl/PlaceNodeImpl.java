 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PlaceNodeImpl#getReferencingPlaces <em>Referencing Places</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public List<RefPlace> getReferencingPlaces() {
		if (referencingPlaces == null) {
			referencingPlaces = new EObjectWithInverseResolvingEList<RefPlace>(RefPlace.class, this,
					HlcorestructurePackage.PLACE_NODE__REFERENCING_PLACES, HlcorestructurePackage.REF_PLACE__REF);
		}
