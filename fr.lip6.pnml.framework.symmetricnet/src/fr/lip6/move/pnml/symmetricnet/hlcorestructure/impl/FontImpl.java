 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.FontImpl#getAlign <em>Align</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.FontImpl#getDecoration <em>Decoration</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.FontImpl#getFamily <em>Family</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.FontImpl#getRotation <em>Rotation</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.FontImpl#getSize <em>Size</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.FontImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.FontImpl#getWeight <em>Weight</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.FontImpl#getContainerAnnotationGraphics <em>Container Annotation Graphics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FontImpl extends MinimalEObjectImpl implements Font {
	...
	protected EClass eStaticClass() {
		return HlcorestructurePackage.Literals.FONT;
	}
	...
	public void setAlign(FontAlign newAlign) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.FONT__ALIGN, oldAlign, align));
	}
	...
	public void setDecoration(FontDecoration newDecoration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.FONT__DECORATION,
	...
	public void setFamily(CSS2FontFamily newFamily) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.FONT__FAMILY, oldFamily,
					family));
	}
	...
	public void setRotation(BigDecimal newRotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.FONT__ROTATION, oldRotation,
					rotation));
	}
	...
	public void setSize(CSS2FontSize newSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.FONT__SIZE, oldSize, size));
	}
	...
	public void setStyle(CSS2FontStyle newStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.FONT__STYLE, oldStyle, style));
	}
	...
	public void setWeight(CSS2FontWeight newWeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.FONT__WEIGHT, oldWeight,
					weight));
	}
	...
	public AnnotationGraphics getContainerAnnotationGraphics() {
		if (eContainerFeatureID() != HlcorestructurePackage.FONT__CONTAINER_ANNOTATION_GRAPHICS)
			return null;
	...
	public NotificationChain basicSetContainerAnnotationGraphics(AnnotationGraphics newContainerAnnotationGraphics,
		...
		msgs = eBasicSetContainer((InternalEObject) newContainerAnnotationGraphics,
				HlcorestructurePackage.FONT__CONTAINER_ANNOTATION_GRAPHICS, msgs);
		return msgs;
	}
		...
		if (newContainerAnnotationGraphics != eInternalContainer()
			...
			if (newContainerAnnotationGraphics != null)
				msgs = ((InternalEObject) newContainerAnnotationGraphics).eInverseAdd(this,
						HlcorestructurePackage.ANNOTATION_GRAPHICS__FONT, AnnotationGraphics.class, msgs);
			msgs = basicSetContainerAnnotationGraphics(newContainerAnnotationGraphics, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.FONT__CONTAINER_ANNOTATION_GRAPHICS, newContainerAnnotationGraphics,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case HlcorestructurePackage.FONT__CONTAINER_ANNOTATION_GRAPHICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case HlcorestructurePackage.FONT__CONTAINER_ANNOTATION_GRAPHICS:
			return eInternalContainer().eInverseRemove(this, HlcorestructurePackage.ANNOTATION_GRAPHICS__FONT,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case HlcorestructurePackage.FONT__ALIGN:
			return getAlign();
		case HlcorestructurePackage.FONT__DECORATION:
			return getDecoration();
		case HlcorestructurePackage.FONT__FAMILY:
			return getFamily();
		case HlcorestructurePackage.FONT__ROTATION:
			return getRotation();
		case HlcorestructurePackage.FONT__SIZE:
			return getSize();
		case HlcorestructurePackage.FONT__STYLE:
			return getStyle();
		case HlcorestructurePackage.FONT__WEIGHT:
			return getWeight();
		case HlcorestructurePackage.FONT__CONTAINER_ANNOTATION_GRAPHICS:
