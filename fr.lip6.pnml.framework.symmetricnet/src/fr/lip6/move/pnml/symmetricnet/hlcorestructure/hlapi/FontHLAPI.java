...
public class FontHLAPI implements HLAPIClass{
    ...
    */
	...
	fr.lip6.move.pnml.symmetricnet.hlcorestructure.FontAlign elem){
	...
	fr.lip6.move.pnml.symmetricnet.hlcorestructure.FontDecoration elem){
	...
	fr.lip6.move.pnml.symmetricnet.hlcorestructure.CSS2FontFamily elem){
	...
	fr.lip6.move.pnml.symmetricnet.hlcorestructure.CSS2FontSize elem){
	...
	fr.lip6.move.pnml.symmetricnet.hlcorestructure.CSS2FontStyle elem){
	...
	fr.lip6.move.pnml.symmetricnet.hlcorestructure.CSS2FontWeight elem){
