...
public class HlcorestructurePackageImpl extends EPackageImpl implements HlcorestructurePackage {
	 ...
	 * @see fr.lip6.move.pnml.hlpn.hlcorestructure.HlcorestructurePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getAnyObject_ContainerUnparsed() {
		return (EReference) anyObjectEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getAnyObject_ContainerAnySort() {
		return (EReference) anyObjectEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getAnyObject_ContainerArbitrarySort() {
	...
	public void createPackageContents() {
		...
		createEReference(anyObjectEClass, ANY_OBJECT__CONTAINER_UNPARSED);
		createEReference(anyObjectEClass, ANY_OBJECT__CONTAINER_ANY_SORT);
		createEReference(anyObjectEClass, ANY_OBJECT__CONTAINER_ARBITRARY_SORT);
	...
	public void initializePackageContents() {
		...
		ArbitrarydeclarationsPackage theArbitrarydeclarationsPackage = (ArbitrarydeclarationsPackage) EPackage.Registry.INSTANCE
		...
		initEAttribute(getPetriNet_Type(), this.getPNType(), "type",
				"http://www.pnml.org/version-2009/grammar/highlevelnet", 1, 1, PetriNet.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getAnyObject_ContainerToolInfo(), this.getToolInfo(), this.getToolInfo_ToolInfoModel(),
				...
				!IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAnyObject_ContainerUnparsed(), theArbitrarydeclarationsPackage.getUnparsed(),
				theArbitrarydeclarationsPackage.getUnparsed_UnparsedModel(), "containerUnparsed", null, 0, 1,
				AnyObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAnyObject_ContainerAnySort(), theArbitrarydeclarationsPackage.getAnySort(),
				theArbitrarydeclarationsPackage.getAnySort_AnySortModel(), "containerAnySort", null, 0, 1,
				AnyObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAnyObject_ContainerArbitrarySort(), theArbitrarydeclarationsPackage.getArbitrarySort(), null,
				"containerArbitrarySort", null, 0, 1, AnyObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
