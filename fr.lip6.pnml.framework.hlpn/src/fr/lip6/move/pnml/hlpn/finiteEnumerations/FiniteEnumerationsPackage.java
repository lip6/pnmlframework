 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see fr.lip6.move.pnml.hlpn.finiteEnumerations.FiniteEnumerationsFactory
 * @model kind="package"
 * @generated
 */
public interface FiniteEnumerationsPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http:///hlpn.finiteEnumerations.ecore";
	 ...
	 * @generated
	 */
	FiniteEnumerationsPackage eINSTANCE = fr.lip6.move.pnml.hlpn.finiteEnumerations.impl.FiniteEnumerationsPackageImpl
			.init();

	/**
	 * The meta object id for the '{@link fr.lip6.move.pnml.hlpn.finiteEnumerations.impl.FiniteEnumerationImpl <em>Finite Enumeration</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see fr.lip6.move.pnml.hlpn.finiteEnumerations.impl.FiniteEnumerationImpl
	 * @see fr.lip6.move.pnml.hlpn.finiteEnumerations.impl.FiniteEnumerationsPackageImpl#getFiniteEnumeration()
	 * @generated
	 */
	 ...
	 * @ordered
	 */
	int FINITE_ENUMERATION__CONTAINER_LIST = TermsPackage.BUILT_IN_SORT__CONTAINER_LIST;
	 ...
	 * @ordered
	 */
	int FINITE_ENUMERATION__CONTAINER_EMPTY_LIST = TermsPackage.BUILT_IN_SORT__CONTAINER_EMPTY_LIST;
	 ...
	 * @ordered
	 */
	int FINITE_ENUMERATION__CONTAINER_MAKE_LIST = TermsPackage.BUILT_IN_SORT__CONTAINER_MAKE_LIST;
	...
	/**
	 * The meta object id for the '{@link fr.lip6.move.pnml.hlpn.finiteEnumerations.impl.FEConstantImpl <em>FE Constant</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see fr.lip6.move.pnml.hlpn.finiteEnumerations.impl.FEConstantImpl
	 * @see fr.lip6.move.pnml.hlpn.finiteEnumerations.impl.FiniteEnumerationsPackageImpl#getFEConstant()
	 * @generated
	 */
	int FE_CONSTANT = 1;
	...
	/**
	 * Returns the meta object for class '{@link fr.lip6.move.pnml.hlpn.finiteEnumerations.FiniteEnumeration <em>Finite Enumeration</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link fr.lip6.move.pnml.hlpn.finiteEnumerations.FiniteEnumeration#getElements <em>Elements</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link fr.lip6.move.pnml.hlpn.finiteEnumerations.FEConstant <em>FE Constant</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>FE Constant</em>'.
	 * @see fr.lip6.move.pnml.hlpn.finiteEnumerations.FEConstant
	 * @generated
	 */
	EClass getFEConstant();

	/**
	 * Returns the meta object for the container reference '{@link fr.lip6.move.pnml.hlpn.finiteEnumerations.FEConstant#getSort <em>Sort</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Sort</em>'.
	 * @see fr.lip6.move.pnml.hlpn.finiteEnumerations.FEConstant#getSort()
	 * @see #getFEConstant()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link fr.lip6.move.pnml.hlpn.finiteEnumerations.impl.FiniteEnumerationImpl <em>Finite Enumeration</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see fr.lip6.move.pnml.hlpn.finiteEnumerations.impl.FiniteEnumerationImpl
		 * @see fr.lip6.move.pnml.hlpn.finiteEnumerations.impl.FiniteEnumerationsPackageImpl#getFiniteEnumeration()
		...
		/**
		 * The meta object literal for the '{@link fr.lip6.move.pnml.hlpn.finiteEnumerations.impl.FEConstantImpl <em>FE Constant</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see fr.lip6.move.pnml.hlpn.finiteEnumerations.impl.FEConstantImpl
		 * @see fr.lip6.move.pnml.hlpn.finiteEnumerations.impl.FiniteEnumerationsPackageImpl#getFEConstant()
