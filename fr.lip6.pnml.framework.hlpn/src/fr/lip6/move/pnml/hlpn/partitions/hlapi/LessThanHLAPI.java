...
public class LessThanHLAPI implements HLAPIClass,TermHLAPI,OperatorHLAPI{
	 ...
	 */
	private fr.lip6.move.pnml.hlpn.partitions.LessThan item;
    ...
    */
	 ...
	 */
	public LessThanHLAPI(fr.lip6.move.pnml.hlpn.partitions.LessThan lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public fr.lip6.move.pnml.hlpn.partitions.LessThan getContainedItem(){
		return item;
	}
