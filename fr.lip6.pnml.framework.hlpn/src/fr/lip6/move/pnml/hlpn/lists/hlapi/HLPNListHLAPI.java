...
public class HLPNListHLAPI implements HLAPIClass,SortHLAPI{

	/**
	 * The contained LLAPI element.
	 */
	private HLPNList item;
	...
	public HLPNListHLAPI(
		 SortHLAPI basis
	){//BEGIN CONSTRUCTOR BODY
		ListsFactory fact = ListsFactoryImpl.eINSTANCE;
		synchronized(fact){item = fact.createHLPNList();}
	 ...
	 */
	public HLPNListHLAPI(HLPNList lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public HLPNList getContainedItem(){
		return item;
	}
	...
	//equals method
	public boolean equals(HLPNListHLAPI item){
