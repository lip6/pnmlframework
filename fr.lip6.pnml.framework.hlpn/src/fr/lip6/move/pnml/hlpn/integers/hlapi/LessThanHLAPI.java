...
public class LessThanHLAPI implements HLAPIClass,TermHLAPI,OperatorHLAPI{
	 ...
	 */
	private fr.lip6.move.pnml.hlpn.integers.LessThan item;
    ...
    */
	 ...
	 */
	public LessThanHLAPI(fr.lip6.move.pnml.hlpn.integers.LessThan lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public fr.lip6.move.pnml.hlpn.integers.LessThan getContainedItem(){
		return item;
	}
