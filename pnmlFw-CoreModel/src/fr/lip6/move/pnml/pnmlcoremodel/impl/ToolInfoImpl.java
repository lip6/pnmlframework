 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.ToolInfoImpl#getTool <em>Tool</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.ToolInfoImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.ToolInfoImpl#getFormattedXMLBuffer <em>Formatted XML Buffer</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.ToolInfoImpl#getToolInfoGrammarURI <em>Tool Info Grammar URI</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.ToolInfoImpl#getContainerPetriNet <em>Container Petri Net</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.ToolInfoImpl#getContainerPnObject <em>Container Pn Object</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.ToolInfoImpl#getContainerLabel <em>Container Label</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.ToolInfoImpl#getToolInfoModel <em>Tool Info Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ToolInfoImpl extends MinimalEObjectImpl implements ToolInfo {
	...
	protected EClass eStaticClass() {
		return PnmlcoremodelPackage.Literals.TOOL_INFO;
	}
	...
	public void setTool(String newTool) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.TOOL_INFO__TOOL, oldTool, tool));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.TOOL_INFO__VERSION, oldVersion,
					version));
	}
	...
	public void setFormattedXMLBuffer(StringBuffer newFormattedXMLBuffer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.TOOL_INFO__FORMATTED_XML_BUFFER,
	...
	public void setToolInfoGrammarURI(URI newToolInfoGrammarURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.TOOL_INFO__TOOL_INFO_GRAMMAR_URI, oldToolInfoGrammarURI, toolInfoGrammarURI));
	}
	...
	public NotificationChain basicSetContainerPetriNet(PetriNet newContainerPetriNet, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerPetriNet,
				PnmlcoremodelPackage.TOOL_INFO__CONTAINER_PETRI_NET, msgs);
		return msgs;
	}
		...
		if (newContainerPetriNet != eInternalContainer()
			...
			if (newContainerPetriNet != null)
				msgs = ((InternalEObject) newContainerPetriNet).eInverseAdd(this,
						PnmlcoremodelPackage.PETRI_NET__TOOLSPECIFICS, PetriNet.class, msgs);
			msgs = basicSetContainerPetriNet(newContainerPetriNet, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.TOOL_INFO__CONTAINER_PETRI_NET,
	...
	public NotificationChain basicSetContainerPnObject(PnObject newContainerPnObject, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerPnObject,
				PnmlcoremodelPackage.TOOL_INFO__CONTAINER_PN_OBJECT, msgs);
		return msgs;
	}
		...
		if (newContainerPnObject != eInternalContainer()
			...
			if (newContainerPnObject != null)
				msgs = ((InternalEObject) newContainerPnObject).eInverseAdd(this,
						PnmlcoremodelPackage.PN_OBJECT__TOOLSPECIFICS, PnObject.class, msgs);
			msgs = basicSetContainerPnObject(newContainerPnObject, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.TOOL_INFO__CONTAINER_PN_OBJECT,
	...
	public NotificationChain basicSetContainerLabel(Label newContainerLabel, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerLabel, PnmlcoremodelPackage.TOOL_INFO__CONTAINER_LABEL,
				msgs);
		return msgs;
	}
	...
	public void setContainerLabel(Label newContainerLabel) {
		if (newContainerLabel != eInternalContainer()
			...
			if (newContainerLabel != null)
				msgs = ((InternalEObject) newContainerLabel).eInverseAdd(this,
						PnmlcoremodelPackage.LABEL__TOOLSPECIFICS, Label.class, msgs);
			msgs = basicSetContainerLabel(newContainerLabel, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.TOOL_INFO__CONTAINER_LABEL,
	...
	public NotificationChain basicSetToolInfoModel(AnyObject newToolInfoModel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.TOOL_INFO__TOOL_INFO_MODEL, oldToolInfoModel, newToolInfoModel);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newToolInfoModel != toolInfoModel) {
			...
			if (toolInfoModel != null)
				msgs = ((InternalEObject) toolInfoModel).eInverseRemove(this,
						PnmlcoremodelPackage.ANY_OBJECT__CONTAINER_TOOL_INFO, AnyObject.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.TOOL_INFO__TOOL_INFO_MODEL,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PnmlcoremodelPackage.TOOL_INFO__CONTAINER_PETRI_NET:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetContainerPetriNet((PetriNet) otherEnd, msgs);
		case PnmlcoremodelPackage.TOOL_INFO__CONTAINER_PN_OBJECT:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetContainerPnObject((PnObject) otherEnd, msgs);
		case PnmlcoremodelPackage.TOOL_INFO__CONTAINER_LABEL:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetContainerLabel((Label) otherEnd, msgs);
		case PnmlcoremodelPackage.TOOL_INFO__TOOL_INFO_MODEL:
			if (toolInfoModel != null)
				msgs = ((InternalEObject) toolInfoModel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PnmlcoremodelPackage.TOOL_INFO__TOOL_INFO_MODEL, null, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case PnmlcoremodelPackage.TOOL_INFO__CONTAINER_PETRI_NET:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.PETRI_NET__TOOLSPECIFICS,
					PetriNet.class, msgs);
		case PnmlcoremodelPackage.TOOL_INFO__CONTAINER_PN_OBJECT:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.PN_OBJECT__TOOLSPECIFICS,
					PnObject.class, msgs);
		case PnmlcoremodelPackage.TOOL_INFO__CONTAINER_LABEL:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.LABEL__TOOLSPECIFICS, Label.class,
					msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PnmlcoremodelPackage.TOOL_INFO__TOOL:
			return getTool();
		case PnmlcoremodelPackage.TOOL_INFO__VERSION:
			return getVersion();
		case PnmlcoremodelPackage.TOOL_INFO__FORMATTED_XML_BUFFER:
			return getFormattedXMLBuffer();
		case PnmlcoremodelPackage.TOOL_INFO__TOOL_INFO_GRAMMAR_URI:
