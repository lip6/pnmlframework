 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.PositionImpl#getContainerPNodeGraphics <em>Container PNode Graphics</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.PositionImpl#getContainerArcGraphics <em>Container Arc Graphics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PositionImpl extends CoordinateImpl implements Position {
	...
	public NotificationChain basicSetContainerPNodeGraphics(NodeGraphics newContainerPNodeGraphics,
		...
		msgs = eBasicSetContainer((InternalEObject) newContainerPNodeGraphics,
				PnmlcoremodelPackage.POSITION__CONTAINER_PNODE_GRAPHICS, msgs);
		return msgs;
	}
		...
		if (newContainerPNodeGraphics != eInternalContainer()
			...
			if (newContainerPNodeGraphics != null)
				msgs = ((InternalEObject) newContainerPNodeGraphics).eInverseAdd(this,
						PnmlcoremodelPackage.NODE_GRAPHICS__POSITION, NodeGraphics.class, msgs);
			msgs = basicSetContainerPNodeGraphics(newContainerPNodeGraphics, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.POSITION__CONTAINER_PNODE_GRAPHICS, newContainerPNodeGraphics,
	...
	public NotificationChain basicSetContainerArcGraphics(ArcGraphics newContainerArcGraphics, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerArcGraphics,
				PnmlcoremodelPackage.POSITION__CONTAINER_ARC_GRAPHICS, msgs);
		return msgs;
	}
		...
		if (newContainerArcGraphics != eInternalContainer()
			...
			if (newContainerArcGraphics != null)
				msgs = ((InternalEObject) newContainerArcGraphics).eInverseAdd(this,
						PnmlcoremodelPackage.ARC_GRAPHICS__POSITIONS, ArcGraphics.class, msgs);
			msgs = basicSetContainerArcGraphics(newContainerArcGraphics, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.POSITION__CONTAINER_ARC_GRAPHICS, newContainerArcGraphics,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PnmlcoremodelPackage.POSITION__CONTAINER_PNODE_GRAPHICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetContainerPNodeGraphics((NodeGraphics) otherEnd, msgs);
		case PnmlcoremodelPackage.POSITION__CONTAINER_ARC_GRAPHICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case PnmlcoremodelPackage.POSITION__CONTAINER_PNODE_GRAPHICS:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.NODE_GRAPHICS__POSITION,
					NodeGraphics.class, msgs);
		case PnmlcoremodelPackage.POSITION__CONTAINER_ARC_GRAPHICS:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.ARC_GRAPHICS__POSITIONS,
