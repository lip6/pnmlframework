 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.PageImpl#getObjects <em>Objects</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.PageImpl#getContainerPetriNet <em>Container Petri Net</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.PageImpl#getNodegraphics <em>Nodegraphics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PageImpl extends PnObjectImpl implements Page {
	...
	public List<PnObject> getObjects() {
		if (objects == null) {
			objects = new EObjectContainmentWithInverseEList<PnObject>(PnObject.class, this,
					PnmlcoremodelPackage.PAGE__OBJECTS, PnmlcoremodelPackage.PN_OBJECT__CONTAINER_PAGE);
		}
		return objects;
	}
	...
	public PetriNet getContainerPetriNet() {
		if (eContainerFeatureID() != PnmlcoremodelPackage.PAGE__CONTAINER_PETRI_NET)
			return null;
	...
	public NotificationChain basicSetContainerPetriNet(PetriNet newContainerPetriNet, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerPetriNet,
				PnmlcoremodelPackage.PAGE__CONTAINER_PETRI_NET, msgs);
		return msgs;
	}
	...
	public void setContainerPetriNet(PetriNet newContainerPetriNet) {
		if (newContainerPetriNet != eInternalContainer()
				|| (eContainerFeatureID() != PnmlcoremodelPackage.PAGE__CONTAINER_PETRI_NET && newContainerPetriNet != null)) {
			...
			if (newContainerPetriNet != null)
				msgs = ((InternalEObject) newContainerPetriNet).eInverseAdd(this,
						PnmlcoremodelPackage.PETRI_NET__PAGES, PetriNet.class, msgs);
			msgs = basicSetContainerPetriNet(newContainerPetriNet, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.PAGE__CONTAINER_PETRI_NET,
	...
	public NotificationChain basicSetNodegraphics(NodeGraphics newNodegraphics, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.PAGE__NODEGRAPHICS, oldNodegraphics, newNodegraphics);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newNodegraphics != nodegraphics) {
			...
			if (nodegraphics != null)
				msgs = ((InternalEObject) nodegraphics).eInverseRemove(this,
						PnmlcoremodelPackage.NODE_GRAPHICS__CONTAINER_PAGE, NodeGraphics.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.PAGE__NODEGRAPHICS,
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case PnmlcoremodelPackage.PAGE__CONTAINER_PETRI_NET:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.PETRI_NET__PAGES, PetriNet.class,
					msgs);
		}
	...
	public String toPNML() {
		...
		if (getObjects() != null) {
			...
			java.util.List<fr.lip6.move.pnml.pnmlcoremodel.PnObject> items = getObjects();
	...
	public void fromPNML(OMElement locRoot, IdRefLinker idr) throws InnerBuildException, InvalidIDException,
		...
		for (Iterator iterator = locRoot.getChildElements(); iterator.hasNext();) {
			...
			if (type.getLocalName().equals("arc")) {
				Arc item;
				item = PnmlcoremodelFactoryImpl.eINSTANCE.createArc();
				item.fromPNML(type, idr);
			...
			if (type.getLocalName().equals("place")) {
				Place item;
				item = PnmlcoremodelFactoryImpl.eINSTANCE.createPlace();
				item.fromPNML(type, idr);
			...
			if (type.getLocalName().equals("referenceTransition")) {
				RefTransition item;
				item = PnmlcoremodelFactoryImpl.eINSTANCE.createRefTransition();
				item.fromPNML(type, idr);
			...
			if (type.getLocalName().equals("transition")) {
				Transition item;
				item = PnmlcoremodelFactoryImpl.eINSTANCE.createTransition();
				item.fromPNML(type, idr);
			...
			if (type.getLocalName().equals("referencePlace")) {
				RefPlace item;
				item = PnmlcoremodelFactoryImpl.eINSTANCE.createRefPlace();
				item.fromPNML(type, idr);
			...
			if (type.getLocalName().equals("graphics")) {
				NodeGraphics item;
				item = PnmlcoremodelFactoryImpl.eINSTANCE.createNodeGraphics();
				item.fromPNML(type, idr);
