 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.ArcGraphicsImpl#getPositions <em>Positions</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.ArcGraphicsImpl#getLine <em>Line</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.ArcGraphicsImpl#getContainerArc <em>Container Arc</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArcGraphicsImpl extends GraphicsImpl implements ArcGraphics {
	...
	public List<Position> getPositions() {
		if (positions == null) {
			positions = new EObjectContainmentWithInverseEList<Position>(Position.class, this,
					PnmlcoremodelPackage.ARC_GRAPHICS__POSITIONS, PnmlcoremodelPackage.POSITION__CONTAINER_ARC_GRAPHICS);
		}
		return positions;
	}
	...
	public NotificationChain basicSetLine(Line newLine, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.ARC_GRAPHICS__LINE, oldLine, newLine);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setLine(Line newLine) {
		if (newLine != line) {
			...
			if (line != null)
				msgs = ((InternalEObject) line).eInverseRemove(this, PnmlcoremodelPackage.LINE__CONTAINER_ARC_GRAPHICS,
						Line.class, msgs);
			if (newLine != null)
				msgs = ((InternalEObject) newLine).eInverseAdd(this, PnmlcoremodelPackage.LINE__CONTAINER_ARC_GRAPHICS,
						Line.class, msgs);
			msgs = basicSetLine(newLine, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.ARC_GRAPHICS__LINE, newLine,
					newLine));
	}
	...
	public NotificationChain basicSetContainerArc(Arc newContainerArc, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerArc, PnmlcoremodelPackage.ARC_GRAPHICS__CONTAINER_ARC,
				msgs);
		return msgs;
	}
	...
	public void setContainerArc(Arc newContainerArc) {
		if (newContainerArc != eInternalContainer()
			...
			if (newContainerArc != null)
				msgs = ((InternalEObject) newContainerArc).eInverseAdd(this, PnmlcoremodelPackage.ARC__ARCGRAPHICS,
						Arc.class, msgs);
			msgs = basicSetContainerArc(newContainerArc, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.ARC_GRAPHICS__CONTAINER_ARC,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PnmlcoremodelPackage.ARC_GRAPHICS__POSITIONS:
		...
		case PnmlcoremodelPackage.ARC_GRAPHICS__LINE:
			if (line != null)
				msgs = ((InternalEObject) line).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PnmlcoremodelPackage.ARC_GRAPHICS__LINE, null, msgs);
			return basicSetLine((Line) otherEnd, msgs);
		case PnmlcoremodelPackage.ARC_GRAPHICS__CONTAINER_ARC:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case PnmlcoremodelPackage.ARC_GRAPHICS__CONTAINER_ARC:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.ARC__ARCGRAPHICS, Arc.class, msgs);
		}
