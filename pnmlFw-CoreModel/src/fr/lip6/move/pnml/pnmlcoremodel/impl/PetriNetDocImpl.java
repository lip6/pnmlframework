 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.PetriNetDocImpl#getNets <em>Nets</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.PetriNetDocImpl#getXmlns <em>Xmlns</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PetriNetDocImpl extends MinimalEObjectImpl implements PetriNetDoc {
	...
	public List<PetriNet> getNets() {
		if (nets == null) {
			nets = new EObjectContainmentWithInverseEList<PetriNet>(PetriNet.class, this,
					PnmlcoremodelPackage.PETRI_NET_DOC__NETS, PnmlcoremodelPackage.PETRI_NET__CONTAINER_PETRI_NET_DOC);
		}
		return nets;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PnmlcoremodelPackage.PETRI_NET_DOC__NETS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case PnmlcoremodelPackage.PETRI_NET_DOC__NETS:
			return getNets();
		case PnmlcoremodelPackage.PETRI_NET_DOC__XMLNS:
			return getXmlns();
		}
