 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.AnnotationImpl#getAnnotationgraphics <em>Annotationgraphics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AnnotationImpl extends LabelImpl implements Annotation {
	...
	protected EClass eStaticClass() {
		return PnmlcoremodelPackage.Literals.ANNOTATION;
	}
	...
	public NotificationChain basicSetAnnotationgraphics(AnnotationGraphics newAnnotationgraphics, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.ANNOTATION__ANNOTATIONGRAPHICS, oldAnnotationgraphics, newAnnotationgraphics);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newAnnotationgraphics != annotationgraphics) {
			...
			if (annotationgraphics != null)
				msgs = ((InternalEObject) annotationgraphics).eInverseRemove(this,
						PnmlcoremodelPackage.ANNOTATION_GRAPHICS__CONTAINER_ANNOTATION, AnnotationGraphics.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.ANNOTATION__ANNOTATIONGRAPHICS,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PnmlcoremodelPackage.ANNOTATION__ANNOTATIONGRAPHICS:
			if (annotationgraphics != null)
				msgs = ((InternalEObject) annotationgraphics).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PnmlcoremodelPackage.ANNOTATION__ANNOTATIONGRAPHICS, null, msgs);
