...
public class PnmlcoremodelPackageImpl extends EPackageImpl implements PnmlcoremodelPackage {
	 ...
	 * @see fr.lip6.move.pnml.pnmlcoremodel.PnmlcoremodelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static PnmlcoremodelPackage init() {
		if (isInited)
			return (PnmlcoremodelPackage) EPackage.Registry.INSTANCE.getEPackage(PnmlcoremodelPackage.eNS_URI);

		// Obtain or create and register package
		PnmlcoremodelPackageImpl thePnmlcoremodelPackage = (PnmlcoremodelPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof PnmlcoremodelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
				: new PnmlcoremodelPackageImpl());
		...
		EValidator.Registry.INSTANCE.put(thePnmlcoremodelPackage, new EValidator.Descriptor() {
			public EValidator getEValidator() {
				return PnmlcoremodelValidator.INSTANCE;
			}
		});
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPetriNet_Type(), this.getPNType(), "type", null, 1, 1, PetriNet.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation(arcEClass, source, new String[] { "constraints", "samePageSourceTarget" });
	}
