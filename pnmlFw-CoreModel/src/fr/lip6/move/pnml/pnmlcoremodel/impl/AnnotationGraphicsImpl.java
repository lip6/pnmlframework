 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.AnnotationGraphicsImpl#getOffset <em>Offset</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.AnnotationGraphicsImpl#getFill <em>Fill</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.AnnotationGraphicsImpl#getLine <em>Line</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.AnnotationGraphicsImpl#getFont <em>Font</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.AnnotationGraphicsImpl#getContainerAnnotation <em>Container Annotation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnnotationGraphicsImpl extends GraphicsImpl implements AnnotationGraphics {
	...
	public NotificationChain basicSetOffset(Offset newOffset, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.ANNOTATION_GRAPHICS__OFFSET, oldOffset, newOffset);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newOffset != offset) {
			...
			if (offset != null)
				msgs = ((InternalEObject) offset).eInverseRemove(this,
						PnmlcoremodelPackage.OFFSET__CONTAINER_ANNOTATION_GRAPHICS, Offset.class, msgs);
			if (newOffset != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.ANNOTATION_GRAPHICS__OFFSET,
					newOffset, newOffset));
	}
	...
	public NotificationChain basicSetFill(Fill newFill, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.ANNOTATION_GRAPHICS__FILL, oldFill, newFill);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newFill != fill) {
			...
			if (fill != null)
				msgs = ((InternalEObject) fill).eInverseRemove(this,
						PnmlcoremodelPackage.FILL__CONTAINER_ANNOTATION_GRAPHICS, Fill.class, msgs);
			if (newFill != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.ANNOTATION_GRAPHICS__FILL,
					newFill, newFill));
	}
	...
	public NotificationChain basicSetLine(Line newLine, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.ANNOTATION_GRAPHICS__LINE, oldLine, newLine);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newLine != line) {
			...
			if (line != null)
				msgs = ((InternalEObject) line).eInverseRemove(this,
						PnmlcoremodelPackage.LINE__CONTAINER_ANNOTATION_GRAPHICS, Line.class, msgs);
			if (newLine != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.ANNOTATION_GRAPHICS__LINE,
					newLine, newLine));
	}
	...
	public NotificationChain basicSetFont(Font newFont, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.ANNOTATION_GRAPHICS__FONT, oldFont, newFont);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newFont != font) {
			...
			if (font != null)
				msgs = ((InternalEObject) font).eInverseRemove(this,
						PnmlcoremodelPackage.FONT__CONTAINER_ANNOTATION_GRAPHICS, Font.class, msgs);
			if (newFont != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.ANNOTATION_GRAPHICS__FONT,
					newFont, newFont));
	}
	...
	public NotificationChain basicSetContainerAnnotation(Annotation newContainerAnnotation, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerAnnotation,
				PnmlcoremodelPackage.ANNOTATION_GRAPHICS__CONTAINER_ANNOTATION, msgs);
		return msgs;
	}
		...
		if (newContainerAnnotation != eInternalContainer()
			...
			if (newContainerAnnotation != null)
				msgs = ((InternalEObject) newContainerAnnotation).eInverseAdd(this,
						PnmlcoremodelPackage.ANNOTATION__ANNOTATIONGRAPHICS, Annotation.class, msgs);
			msgs = basicSetContainerAnnotation(newContainerAnnotation, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.ANNOTATION_GRAPHICS__CONTAINER_ANNOTATION, newContainerAnnotation,
		...
		case PnmlcoremodelPackage.ANNOTATION_GRAPHICS__OFFSET:
			if (offset != null)
				msgs = ((InternalEObject) offset).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PnmlcoremodelPackage.ANNOTATION_GRAPHICS__OFFSET, null, msgs);
		...
		case PnmlcoremodelPackage.ANNOTATION_GRAPHICS__FILL:
			if (fill != null)
				msgs = ((InternalEObject) fill).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PnmlcoremodelPackage.ANNOTATION_GRAPHICS__FILL, null, msgs);
		...
		case PnmlcoremodelPackage.ANNOTATION_GRAPHICS__LINE:
			if (line != null)
				msgs = ((InternalEObject) line).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PnmlcoremodelPackage.ANNOTATION_GRAPHICS__LINE, null, msgs);
		...
		case PnmlcoremodelPackage.ANNOTATION_GRAPHICS__FONT:
			if (font != null)
				msgs = ((InternalEObject) font).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PnmlcoremodelPackage.ANNOTATION_GRAPHICS__FONT, null, msgs);
			return basicSetFont((Font) otherEnd, msgs);
		case PnmlcoremodelPackage.ANNOTATION_GRAPHICS__CONTAINER_ANNOTATION:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case PnmlcoremodelPackage.ANNOTATION_GRAPHICS__CONTAINER_ANNOTATION:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.ANNOTATION__ANNOTATIONGRAPHICS,
