 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.RefTransitionImpl#getRef <em>Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RefTransitionImpl extends TransitionNodeImpl implements RefTransition {
		...
		if (ref != null && ref.eIsProxy()) {
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PnmlcoremodelPackage.REF_TRANSITION__REF,
							oldRef, ref));
			}
		}
		return ref;
	...
	public NotificationChain basicSetRef(TransitionNode newRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.REF_TRANSITION__REF, oldRef, newRef);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRef != ref) {
			...
			if (ref != null)
				msgs = ((InternalEObject) ref).eInverseRemove(this,
						PnmlcoremodelPackage.TRANSITION_NODE__REFERENCING_TRANSITIONS, TransitionNode.class, msgs);
			if (newRef != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.REF_TRANSITION__REF, newRef,
					newRef));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case PnmlcoremodelPackage.REF_TRANSITION__REF:
			if (ref != null)
				msgs = ((InternalEObject) ref).eInverseRemove(this,
						PnmlcoremodelPackage.TRANSITION_NODE__REFERENCING_TRANSITIONS, TransitionNode.class, msgs);
			return basicSetRef((TransitionNode) otherEnd, msgs);
		}
	...
	public void idRefHang(ArrayList<Object> oList) {
		...
		this.setRef((fr.lip6.move.pnml.pnmlcoremodel.TransitionNode) oList.get(0));
