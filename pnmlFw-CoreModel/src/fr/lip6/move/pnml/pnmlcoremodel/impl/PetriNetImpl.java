 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.PetriNetImpl#getId <em>Id</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.PetriNetImpl#getType <em>Type</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.PetriNetImpl#getPages <em>Pages</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.PetriNetImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.PetriNetImpl#getToolspecifics <em>Toolspecifics</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.PetriNetImpl#getContainerPetriNetDoc <em>Container Petri Net Doc</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PetriNetImpl extends MinimalEObjectImpl implements PetriNet {
	 ...
	 * @ordered
	 */
	protected static final PNType TYPE_EDEFAULT = PNType.COREMODEL;
	...
	public void setType(PNType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.PETRI_NET__TYPE, oldType, type));
	}
	...
	public List<Page> getPages() {
		if (pages == null) {
			pages = new EObjectContainmentWithInverseEList<Page>(Page.class, this,
					PnmlcoremodelPackage.PETRI_NET__PAGES, PnmlcoremodelPackage.PAGE__CONTAINER_PETRI_NET);
		}
		return pages;
	}
	...
	public NotificationChain basicSetName(Name newName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.PETRI_NET__NAME, oldName, newName);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject) name).eInverseRemove(this,
						PnmlcoremodelPackage.NAME__CONTAINER_NAME_PETRI_NET, Name.class, msgs);
			if (newName != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.PETRI_NET__NAME, newName,
					newName));
	}
	...
	public List<ToolInfo> getToolspecifics() {
		if (toolspecifics == null) {
			toolspecifics = new EObjectContainmentWithInverseEList<ToolInfo>(ToolInfo.class, this,
					PnmlcoremodelPackage.PETRI_NET__TOOLSPECIFICS, PnmlcoremodelPackage.TOOL_INFO__CONTAINER_PETRI_NET);
		}
	...
	public PetriNetDoc getContainerPetriNetDoc() {
		if (eContainerFeatureID() != PnmlcoremodelPackage.PETRI_NET__CONTAINER_PETRI_NET_DOC)
			return null;
	...
	public NotificationChain basicSetContainerPetriNetDoc(PetriNetDoc newContainerPetriNetDoc, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerPetriNetDoc,
				PnmlcoremodelPackage.PETRI_NET__CONTAINER_PETRI_NET_DOC, msgs);
		return msgs;
	}
	...
	public void setContainerPetriNetDoc(PetriNetDoc newContainerPetriNetDoc) {
		if (newContainerPetriNetDoc != eInternalContainer()
				|| (eContainerFeatureID() != PnmlcoremodelPackage.PETRI_NET__CONTAINER_PETRI_NET_DOC && newContainerPetriNetDoc != null)) {
			...
			if (newContainerPetriNetDoc != null)
				msgs = ((InternalEObject) newContainerPetriNetDoc).eInverseAdd(this,
						PnmlcoremodelPackage.PETRI_NET_DOC__NETS, PetriNetDoc.class, msgs);
			msgs = basicSetContainerPetriNetDoc(newContainerPetriNetDoc, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.PETRI_NET__CONTAINER_PETRI_NET_DOC, newContainerPetriNetDoc,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PnmlcoremodelPackage.PETRI_NET__PAGES:
		...
		case PnmlcoremodelPackage.PETRI_NET__NAME:
			if (name != null)
				msgs = ((InternalEObject) name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PnmlcoremodelPackage.PETRI_NET__NAME, null, msgs);
			return basicSetName((Name) otherEnd, msgs);
		case PnmlcoremodelPackage.PETRI_NET__TOOLSPECIFICS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getToolspecifics()).basicAdd(otherEnd, msgs);
		case PnmlcoremodelPackage.PETRI_NET__CONTAINER_PETRI_NET_DOC:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case PnmlcoremodelPackage.PETRI_NET__CONTAINER_PETRI_NET_DOC:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.PETRI_NET_DOC__NETS,
	...
	public String toPNML() {
		...
		if (getPages() != null) {
			...
			java.util.List<fr.lip6.move.pnml.pnmlcoremodel.Page> items = getPages();
	...
	public void fromPNML(OMElement locRoot, IdRefLinker idr) throws InnerBuildException, InvalidIDException,
		...
		for (Iterator iterator = locRoot.getChildElements(); iterator.hasNext();) {
			...
			if (type.getLocalName().equals("page")) {
				Page item;
				item = PnmlcoremodelFactoryImpl.eINSTANCE.createPage();
			...
			if (type.getLocalName().equals("name")) {
				Name item;
				item = PnmlcoremodelFactoryImpl.eINSTANCE.createName();
				item.fromPNML(type, idr);
