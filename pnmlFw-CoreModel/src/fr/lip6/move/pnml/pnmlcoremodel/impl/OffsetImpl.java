 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.OffsetImpl#getContainerAnnotationGraphics <em>Container Annotation Graphics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OffsetImpl extends CoordinateImpl implements Offset {
	...
	protected EClass eStaticClass() {
		return PnmlcoremodelPackage.Literals.OFFSET;
	}
	...
	public AnnotationGraphics getContainerAnnotationGraphics() {
		if (eContainerFeatureID() != PnmlcoremodelPackage.OFFSET__CONTAINER_ANNOTATION_GRAPHICS)
			return null;
	...
	public NotificationChain basicSetContainerAnnotationGraphics(AnnotationGraphics newContainerAnnotationGraphics,
		...
		msgs = eBasicSetContainer((InternalEObject) newContainerAnnotationGraphics,
				PnmlcoremodelPackage.OFFSET__CONTAINER_ANNOTATION_GRAPHICS, msgs);
		return msgs;
	}
	...
	public void setContainerAnnotationGraphics(AnnotationGraphics newContainerAnnotationGraphics) {
		if (newContainerAnnotationGraphics != eInternalContainer()
				|| (eContainerFeatureID() != PnmlcoremodelPackage.OFFSET__CONTAINER_ANNOTATION_GRAPHICS && newContainerAnnotationGraphics != null)) {
			...
			if (newContainerAnnotationGraphics != null)
				msgs = ((InternalEObject) newContainerAnnotationGraphics).eInverseAdd(this,
						PnmlcoremodelPackage.ANNOTATION_GRAPHICS__OFFSET, AnnotationGraphics.class, msgs);
			msgs = basicSetContainerAnnotationGraphics(newContainerAnnotationGraphics, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.OFFSET__CONTAINER_ANNOTATION_GRAPHICS, newContainerAnnotationGraphics,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PnmlcoremodelPackage.OFFSET__CONTAINER_ANNOTATION_GRAPHICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case PnmlcoremodelPackage.OFFSET__CONTAINER_ANNOTATION_GRAPHICS:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.ANNOTATION_GRAPHICS__OFFSET,
