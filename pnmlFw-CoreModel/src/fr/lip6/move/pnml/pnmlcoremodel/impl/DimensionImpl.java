 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.DimensionImpl#getContainerDNodeGraphics <em>Container DNode Graphics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DimensionImpl extends CoordinateImpl implements Dimension {
	...
	protected EClass eStaticClass() {
		return PnmlcoremodelPackage.Literals.DIMENSION;
	}
	...
	public NodeGraphics getContainerDNodeGraphics() {
		if (eContainerFeatureID() != PnmlcoremodelPackage.DIMENSION__CONTAINER_DNODE_GRAPHICS)
			return null;
	...
	public NotificationChain basicSetContainerDNodeGraphics(NodeGraphics newContainerDNodeGraphics,
		...
		msgs = eBasicSetContainer((InternalEObject) newContainerDNodeGraphics,
				PnmlcoremodelPackage.DIMENSION__CONTAINER_DNODE_GRAPHICS, msgs);
		return msgs;
	}
	...
	public void setContainerDNodeGraphics(NodeGraphics newContainerDNodeGraphics) {
		if (newContainerDNodeGraphics != eInternalContainer()
				|| (eContainerFeatureID() != PnmlcoremodelPackage.DIMENSION__CONTAINER_DNODE_GRAPHICS && newContainerDNodeGraphics != null)) {
			...
			if (newContainerDNodeGraphics != null)
				msgs = ((InternalEObject) newContainerDNodeGraphics).eInverseAdd(this,
						PnmlcoremodelPackage.NODE_GRAPHICS__DIMENSION, NodeGraphics.class, msgs);
			msgs = basicSetContainerDNodeGraphics(newContainerDNodeGraphics, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.DIMENSION__CONTAINER_DNODE_GRAPHICS, newContainerDNodeGraphics,
					newContainerDNodeGraphics));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PnmlcoremodelPackage.DIMENSION__CONTAINER_DNODE_GRAPHICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case PnmlcoremodelPackage.DIMENSION__CONTAINER_DNODE_GRAPHICS:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.NODE_GRAPHICS__DIMENSION,
