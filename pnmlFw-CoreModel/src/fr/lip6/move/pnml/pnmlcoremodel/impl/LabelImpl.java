 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.LabelImpl#getToolspecifics <em>Toolspecifics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class LabelImpl extends MinimalEObjectImpl implements Label {
	...
	public List<ToolInfo> getToolspecifics() {
		if (toolspecifics == null) {
			toolspecifics = new EObjectContainmentWithInverseEList<ToolInfo>(ToolInfo.class, this,
					PnmlcoremodelPackage.LABEL__TOOLSPECIFICS, PnmlcoremodelPackage.TOOL_INFO__CONTAINER_LABEL);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PnmlcoremodelPackage.LABEL__TOOLSPECIFICS:
