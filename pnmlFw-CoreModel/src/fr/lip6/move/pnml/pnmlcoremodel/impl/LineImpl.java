 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.LineImpl#getColor <em>Color</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.LineImpl#getShape <em>Shape</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.LineImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.LineImpl#getContainerNodeGraphics <em>Container Node Graphics</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.LineImpl#getContainerArcGraphics <em>Container Arc Graphics</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.LineImpl#getContainerAnnotationGraphics <em>Container Annotation Graphics</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.LineImpl#getStyle <em>Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LineImpl extends MinimalEObjectImpl implements Line {
	...
	public NotificationChain basicSetContainerNodeGraphics(NodeGraphics newContainerNodeGraphics, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerNodeGraphics,
				PnmlcoremodelPackage.LINE__CONTAINER_NODE_GRAPHICS, msgs);
		return msgs;
	}
		...
		if (newContainerNodeGraphics != eInternalContainer()
			...
			if (newContainerNodeGraphics != null)
				msgs = ((InternalEObject) newContainerNodeGraphics).eInverseAdd(this,
						PnmlcoremodelPackage.NODE_GRAPHICS__LINE, NodeGraphics.class, msgs);
			msgs = basicSetContainerNodeGraphics(newContainerNodeGraphics, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.LINE__CONTAINER_NODE_GRAPHICS,
	...
	public NotificationChain basicSetContainerArcGraphics(ArcGraphics newContainerArcGraphics, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerArcGraphics,
				PnmlcoremodelPackage.LINE__CONTAINER_ARC_GRAPHICS, msgs);
		return msgs;
	}
		...
		if (newContainerArcGraphics != eInternalContainer()
			...
			if (newContainerArcGraphics != null)
				msgs = ((InternalEObject) newContainerArcGraphics).eInverseAdd(this,
						PnmlcoremodelPackage.ARC_GRAPHICS__LINE, ArcGraphics.class, msgs);
			msgs = basicSetContainerArcGraphics(newContainerArcGraphics, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.LINE__CONTAINER_ARC_GRAPHICS,
	...
	public NotificationChain basicSetContainerAnnotationGraphics(AnnotationGraphics newContainerAnnotationGraphics,
		...
		msgs = eBasicSetContainer((InternalEObject) newContainerAnnotationGraphics,
				PnmlcoremodelPackage.LINE__CONTAINER_ANNOTATION_GRAPHICS, msgs);
		return msgs;
	}
		...
		if (newContainerAnnotationGraphics != eInternalContainer()
			...
			if (newContainerAnnotationGraphics != null)
				msgs = ((InternalEObject) newContainerAnnotationGraphics).eInverseAdd(this,
						PnmlcoremodelPackage.ANNOTATION_GRAPHICS__LINE, AnnotationGraphics.class, msgs);
			msgs = basicSetContainerAnnotationGraphics(newContainerAnnotationGraphics, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.LINE__CONTAINER_ANNOTATION_GRAPHICS, newContainerAnnotationGraphics,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PnmlcoremodelPackage.LINE__CONTAINER_NODE_GRAPHICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetContainerNodeGraphics((NodeGraphics) otherEnd, msgs);
		case PnmlcoremodelPackage.LINE__CONTAINER_ARC_GRAPHICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetContainerArcGraphics((ArcGraphics) otherEnd, msgs);
		case PnmlcoremodelPackage.LINE__CONTAINER_ANNOTATION_GRAPHICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case PnmlcoremodelPackage.LINE__CONTAINER_NODE_GRAPHICS:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.NODE_GRAPHICS__LINE,
					NodeGraphics.class, msgs);
		case PnmlcoremodelPackage.LINE__CONTAINER_ARC_GRAPHICS:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.ARC_GRAPHICS__LINE,
					ArcGraphics.class, msgs);
		case PnmlcoremodelPackage.LINE__CONTAINER_ANNOTATION_GRAPHICS:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.ANNOTATION_GRAPHICS__LINE,
