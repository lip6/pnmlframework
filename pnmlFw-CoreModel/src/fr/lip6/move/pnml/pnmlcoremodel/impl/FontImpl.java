 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.FontImpl#getAlign <em>Align</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.FontImpl#getDecoration <em>Decoration</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.FontImpl#getFamily <em>Family</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.FontImpl#getRotation <em>Rotation</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.FontImpl#getSize <em>Size</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.FontImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.FontImpl#getWeight <em>Weight</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.FontImpl#getContainerAnnotationGraphics <em>Container Annotation Graphics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FontImpl extends MinimalEObjectImpl implements Font {
	...
	public void setDecoration(FontDecoration newDecoration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.FONT__DECORATION, oldDecoration,
					decoration));
	}
	...
	public void setRotation(BigDecimal newRotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.FONT__ROTATION, oldRotation,
					rotation));
	}
	...
	public NotificationChain basicSetContainerAnnotationGraphics(AnnotationGraphics newContainerAnnotationGraphics,
		...
		msgs = eBasicSetContainer((InternalEObject) newContainerAnnotationGraphics,
				PnmlcoremodelPackage.FONT__CONTAINER_ANNOTATION_GRAPHICS, msgs);
		return msgs;
	}
		...
		if (newContainerAnnotationGraphics != eInternalContainer()
			...
			if (newContainerAnnotationGraphics != null)
				msgs = ((InternalEObject) newContainerAnnotationGraphics).eInverseAdd(this,
						PnmlcoremodelPackage.ANNOTATION_GRAPHICS__FONT, AnnotationGraphics.class, msgs);
			msgs = basicSetContainerAnnotationGraphics(newContainerAnnotationGraphics, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.FONT__CONTAINER_ANNOTATION_GRAPHICS, newContainerAnnotationGraphics,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PnmlcoremodelPackage.FONT__CONTAINER_ANNOTATION_GRAPHICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case PnmlcoremodelPackage.FONT__CONTAINER_ANNOTATION_GRAPHICS:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.ANNOTATION_GRAPHICS__FONT,
