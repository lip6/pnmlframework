 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.RefPlaceImpl#getRef <em>Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RefPlaceImpl extends PlaceNodeImpl implements RefPlace {
		...
		if (ref != null && ref.eIsProxy()) {
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PnmlcoremodelPackage.REF_PLACE__REF,
							oldRef, ref));
			}
		}
		return ref;
	...
	public NotificationChain basicSetRef(PlaceNode newRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.REF_PLACE__REF, oldRef, newRef);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRef != ref) {
			...
			if (ref != null)
				msgs = ((InternalEObject) ref).eInverseRemove(this,
						PnmlcoremodelPackage.PLACE_NODE__REFERENCING_PLACES, PlaceNode.class, msgs);
			if (newRef != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.REF_PLACE__REF, newRef, newRef));
	}
	...
	public void idRefHang(ArrayList<Object> oList) {
		...
		this.setRef((fr.lip6.move.pnml.pnmlcoremodel.PlaceNode) oList.get(0));
