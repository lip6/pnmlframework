 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.NodeImpl#getInArcs <em>In Arcs</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.NodeImpl#getOutArcs <em>Out Arcs</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.NodeImpl#getNodegraphics <em>Nodegraphics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NodeImpl extends PnObjectImpl implements Node {
	...
	public List<Arc> getInArcs() {
		if (inArcs == null) {
			inArcs = new EObjectWithInverseResolvingEList<Arc>(Arc.class, this, PnmlcoremodelPackage.NODE__IN_ARCS,
					PnmlcoremodelPackage.ARC__TARGET);
		}
		return inArcs;
	}
	...
	public List<Arc> getOutArcs() {
		if (outArcs == null) {
			outArcs = new EObjectWithInverseResolvingEList<Arc>(Arc.class, this, PnmlcoremodelPackage.NODE__OUT_ARCS,
					PnmlcoremodelPackage.ARC__SOURCE);
		}
		return outArcs;
	}
	...
	public NotificationChain basicSetNodegraphics(NodeGraphics newNodegraphics, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.NODE__NODEGRAPHICS, oldNodegraphics, newNodegraphics);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newNodegraphics != nodegraphics) {
			...
			if (nodegraphics != null)
				msgs = ((InternalEObject) nodegraphics).eInverseRemove(this,
						PnmlcoremodelPackage.NODE_GRAPHICS__CONTAINER_NODE, NodeGraphics.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.NODE__NODEGRAPHICS,
