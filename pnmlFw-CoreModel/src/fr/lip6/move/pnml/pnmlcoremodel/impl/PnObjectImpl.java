 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.PnObjectImpl#getId <em>Id</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.PnObjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.PnObjectImpl#getToolspecifics <em>Toolspecifics</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.PnObjectImpl#getContainerPage <em>Container Page</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class PnObjectImpl extends MinimalEObjectImpl implements PnObject {
	...
	protected EClass eStaticClass() {
		return PnmlcoremodelPackage.Literals.PN_OBJECT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.PN_OBJECT__ID, oldId, id));
	}
	...
	public NotificationChain basicSetName(Name newName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.PN_OBJECT__NAME, oldName, newName);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject) name).eInverseRemove(this,
						PnmlcoremodelPackage.NAME__CONTAINER_NAME_PN_OBJECT, Name.class, msgs);
			if (newName != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.PN_OBJECT__NAME, newName,
					newName));
	}
	...
	public List<ToolInfo> getToolspecifics() {
		if (toolspecifics == null) {
			toolspecifics = new EObjectContainmentWithInverseEList<ToolInfo>(ToolInfo.class, this,
					PnmlcoremodelPackage.PN_OBJECT__TOOLSPECIFICS, PnmlcoremodelPackage.TOOL_INFO__CONTAINER_PN_OBJECT);
		}
	...
	public Page getContainerPage() {
		if (eContainerFeatureID() != PnmlcoremodelPackage.PN_OBJECT__CONTAINER_PAGE)
			return null;
	...
	public NotificationChain basicSetContainerPage(Page newContainerPage, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerPage, PnmlcoremodelPackage.PN_OBJECT__CONTAINER_PAGE,
				msgs);
		return msgs;
	}
	...
	public void setContainerPage(Page newContainerPage) {
		if (newContainerPage != eInternalContainer()
				|| (eContainerFeatureID() != PnmlcoremodelPackage.PN_OBJECT__CONTAINER_PAGE && newContainerPage != null)) {
			...
			if (newContainerPage != null)
				msgs = ((InternalEObject) newContainerPage).eInverseAdd(this, PnmlcoremodelPackage.PAGE__OBJECTS,
						Page.class, msgs);
			msgs = basicSetContainerPage(newContainerPage, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.PN_OBJECT__CONTAINER_PAGE,
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case PnmlcoremodelPackage.PN_OBJECT__CONTAINER_PAGE:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.PAGE__OBJECTS, Page.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PnmlcoremodelPackage.PN_OBJECT__ID:
			return getId();
		case PnmlcoremodelPackage.PN_OBJECT__NAME:
			return getName();
		case PnmlcoremodelPackage.PN_OBJECT__TOOLSPECIFICS:
