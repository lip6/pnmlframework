 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.FillImpl#getColor <em>Color</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.FillImpl#getGradientcolor <em>Gradientcolor</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.FillImpl#getGradientrotation <em>Gradientrotation</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.FillImpl#getImage <em>Image</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.FillImpl#getContainerNodeGraphics <em>Container Node Graphics</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.impl.FillImpl#getContainerAnnotationGraphics <em>Container Annotation Graphics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FillImpl extends MinimalEObjectImpl implements Fill {
	...
	public void setGradientcolor(CSS2Color newGradientcolor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.FILL__GRADIENTCOLOR,
	...
	public void setGradientrotation(Gradient newGradientrotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.FILL__GRADIENTROTATION,
	...
	public NotificationChain basicSetContainerNodeGraphics(NodeGraphics newContainerNodeGraphics, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerNodeGraphics,
				PnmlcoremodelPackage.FILL__CONTAINER_NODE_GRAPHICS, msgs);
		return msgs;
	}
		...
		if (newContainerNodeGraphics != eInternalContainer()
			...
			if (newContainerNodeGraphics != null)
				msgs = ((InternalEObject) newContainerNodeGraphics).eInverseAdd(this,
						PnmlcoremodelPackage.NODE_GRAPHICS__FILL, NodeGraphics.class, msgs);
			msgs = basicSetContainerNodeGraphics(newContainerNodeGraphics, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PnmlcoremodelPackage.FILL__CONTAINER_NODE_GRAPHICS,
	...
	public NotificationChain basicSetContainerAnnotationGraphics(AnnotationGraphics newContainerAnnotationGraphics,
		...
		msgs = eBasicSetContainer((InternalEObject) newContainerAnnotationGraphics,
				PnmlcoremodelPackage.FILL__CONTAINER_ANNOTATION_GRAPHICS, msgs);
		return msgs;
	}
		...
		if (newContainerAnnotationGraphics != eInternalContainer()
			...
			if (newContainerAnnotationGraphics != null)
				msgs = ((InternalEObject) newContainerAnnotationGraphics).eInverseAdd(this,
						PnmlcoremodelPackage.ANNOTATION_GRAPHICS__FILL, AnnotationGraphics.class, msgs);
			msgs = basicSetContainerAnnotationGraphics(newContainerAnnotationGraphics, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PnmlcoremodelPackage.FILL__CONTAINER_ANNOTATION_GRAPHICS, newContainerAnnotationGraphics,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PnmlcoremodelPackage.FILL__CONTAINER_NODE_GRAPHICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetContainerNodeGraphics((NodeGraphics) otherEnd, msgs);
		case PnmlcoremodelPackage.FILL__CONTAINER_ANNOTATION_GRAPHICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case PnmlcoremodelPackage.FILL__CONTAINER_NODE_GRAPHICS:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.NODE_GRAPHICS__FILL,
					NodeGraphics.class, msgs);
		case PnmlcoremodelPackage.FILL__CONTAINER_ANNOTATION_GRAPHICS:
			return eInternalContainer().eInverseRemove(this, PnmlcoremodelPackage.ANNOTATION_GRAPHICS__FILL,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case PnmlcoremodelPackage.FILL__COLOR:
			return getColor();
		case PnmlcoremodelPackage.FILL__GRADIENTCOLOR:
