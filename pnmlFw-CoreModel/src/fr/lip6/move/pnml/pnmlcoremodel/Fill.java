 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.Fill#getColor <em>Color</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.Fill#getGradientcolor <em>Gradientcolor</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.Fill#getGradientrotation <em>Gradientrotation</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.Fill#getImage <em>Image</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.Fill#getContainerNodeGraphics <em>Container Node Graphics</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.Fill#getContainerAnnotationGraphics <em>Container Annotation Graphics</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.lip6.move.pnml.pnmlcoremodel.PnmlcoremodelPackage#getFill()
...
public interface Fill extends EObject {
	 ...
	 * @see fr.lip6.move.pnml.pnmlcoremodel.PnmlcoremodelPackage#getFill_Color()
	...
	/**
	 * Sets the value of the '{@link fr.lip6.move.pnml.pnmlcoremodel.Fill#getColor <em>Color</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fr.lip6.move.pnml.pnmlcoremodel.PnmlcoremodelPackage#getFill_Gradientcolor()
	 * @model default="black" ordered="false"
	...
	/**
	 * Sets the value of the '{@link fr.lip6.move.pnml.pnmlcoremodel.Fill#getGradientcolor <em>Gradientcolor</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link fr.lip6.move.pnml.pnmlcoremodel.Gradient}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see fr.lip6.move.pnml.pnmlcoremodel.PnmlcoremodelPackage#getFill_Gradientrotation()
	 * @model ordered="false"
	...
	/**
	 * Sets the value of the '{@link fr.lip6.move.pnml.pnmlcoremodel.Fill#getGradientrotation <em>Gradientrotation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setImage(URI)
	 * @see fr.lip6.move.pnml.pnmlcoremodel.PnmlcoremodelPackage#getFill_Image()
	...
	/**
	 * Sets the value of the '{@link fr.lip6.move.pnml.pnmlcoremodel.Fill#getImage <em>Image</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link fr.lip6.move.pnml.pnmlcoremodel.NodeGraphics#getFill <em>Fill</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see fr.lip6.move.pnml.pnmlcoremodel.PnmlcoremodelPackage#getFill_ContainerNodeGraphics()
	...
	/**
	 * Sets the value of the '{@link fr.lip6.move.pnml.pnmlcoremodel.Fill#getContainerNodeGraphics <em>Container Node Graphics</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link fr.lip6.move.pnml.pnmlcoremodel.AnnotationGraphics#getFill <em>Fill</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see fr.lip6.move.pnml.pnmlcoremodel.PnmlcoremodelPackage#getFill_ContainerAnnotationGraphics()
	...
	/**
	 * Sets the value of the '{@link fr.lip6.move.pnml.pnmlcoremodel.Fill#getContainerAnnotationGraphics <em>Container Annotation Graphics</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
