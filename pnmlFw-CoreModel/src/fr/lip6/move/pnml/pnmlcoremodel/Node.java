 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.Node#getInArcs <em>In Arcs</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.Node#getOutArcs <em>Out Arcs</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.Node#getNodegraphics <em>Nodegraphics</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.lip6.move.pnml.pnmlcoremodel.PnmlcoremodelPackage#getNode()
 * @model abstract="true"
 * @generated
 */
public interface Node extends PnObject {
	 ...
	 * The list contents are of type {@link fr.lip6.move.pnml.pnmlcoremodel.Arc}.
	 * It is bidirectional and its opposite is '{@link fr.lip6.move.pnml.pnmlcoremodel.Arc#getTarget <em>Target</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see fr.lip6.move.pnml.pnmlcoremodel.PnmlcoremodelPackage#getNode_InArcs()
	 ...
	 * The list contents are of type {@link fr.lip6.move.pnml.pnmlcoremodel.Arc}.
	 * It is bidirectional and its opposite is '{@link fr.lip6.move.pnml.pnmlcoremodel.Arc#getSource <em>Source</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see fr.lip6.move.pnml.pnmlcoremodel.PnmlcoremodelPackage#getNode_OutArcs()
	 ...
	 * It is bidirectional and its opposite is '{@link fr.lip6.move.pnml.pnmlcoremodel.NodeGraphics#getContainerNode <em>Container Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see fr.lip6.move.pnml.pnmlcoremodel.PnmlcoremodelPackage#getNode_Nodegraphics()
	...
	/**
	 * Sets the value of the '{@link fr.lip6.move.pnml.pnmlcoremodel.Node#getNodegraphics <em>Nodegraphics</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
