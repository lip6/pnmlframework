 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.ArcGraphics#getPositions <em>Positions</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.ArcGraphics#getLine <em>Line</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.pnmlcoremodel.ArcGraphics#getContainerArc <em>Container Arc</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.lip6.move.pnml.pnmlcoremodel.PnmlcoremodelPackage#getArcGraphics()
...
public interface ArcGraphics extends Graphics {
	 ...
	 * The list contents are of type {@link fr.lip6.move.pnml.pnmlcoremodel.Position}.
	 * It is bidirectional and its opposite is '{@link fr.lip6.move.pnml.pnmlcoremodel.Position#getContainerArcGraphics <em>Container Arc Graphics</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see fr.lip6.move.pnml.pnmlcoremodel.PnmlcoremodelPackage#getArcGraphics_Positions()
	 ...
	 * It is bidirectional and its opposite is '{@link fr.lip6.move.pnml.pnmlcoremodel.Line#getContainerArcGraphics <em>Container Arc Graphics</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setLine(Line)
	 * @see fr.lip6.move.pnml.pnmlcoremodel.PnmlcoremodelPackage#getArcGraphics_Line()
	...
	/**
	 * Sets the value of the '{@link fr.lip6.move.pnml.pnmlcoremodel.ArcGraphics#getLine <em>Line</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link fr.lip6.move.pnml.pnmlcoremodel.Arc#getArcgraphics <em>Arcgraphics</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see fr.lip6.move.pnml.pnmlcoremodel.PnmlcoremodelPackage#getArcGraphics_ContainerArc()
	...
	/**
	 * Sets the value of the '{@link fr.lip6.move.pnml.pnmlcoremodel.ArcGraphics#getContainerArc <em>Container Arc</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
