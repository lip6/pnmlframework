 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.partitions.impl.PartitionElementOfImpl#getRefpartition <em>Refpartition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PartitionElementOfImpl extends PartitionOperatorImpl implements PartitionElementOf {
			...
			if (refpartition != oldRefpartition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PartitionsPackage.PARTITION_ELEMENT_OF__REFPARTITION, oldRefpartition, refpartition));
			}
		}
		return refpartition;
	}
	...
	public void setRefpartition(Partition newRefpartition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PartitionsPackage.PARTITION_ELEMENT_OF__REFPARTITION,
					oldRefpartition, refpartition));
	}
	...
	public String toPNML() {
		...
		if (getRefpartition() != null) {
			...
			sb.append("=\"");
			sb.append(getRefpartition().getId());
			sb.append("\"");
		}
	...
	public void idRefHang(ArrayList<Object> oList) {
		...
		this.setRefpartition((fr.lip6.move.pnml.symmetricnet.partitions.Partition) oList.get(0));
