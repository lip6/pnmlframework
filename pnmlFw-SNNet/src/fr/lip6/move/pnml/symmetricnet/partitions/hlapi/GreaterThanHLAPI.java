...
public class GreaterThanHLAPI implements HLAPIClass,TermHLAPI,OperatorHLAPI{
	 ...
	 */
	private fr.lip6.move.pnml.symmetricnet.partitions.GreaterThan item;
    ...
    */
	 ...
	 */
	public GreaterThanHLAPI(fr.lip6.move.pnml.symmetricnet.partitions.GreaterThan lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public fr.lip6.move.pnml.symmetricnet.partitions.GreaterThan getContainedItem(){
		return item;
	}
