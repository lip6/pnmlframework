 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.terms.impl.SortImpl#getMulti <em>Multi</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.terms.impl.SortImpl#getContainerNamedSort <em>Container Named Sort</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.terms.impl.SortImpl#getContainerVariableDecl <em>Container Variable Decl</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.terms.impl.SortImpl#getContainerProductSort <em>Container Product Sort</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.terms.impl.SortImpl#getContainerType <em>Container Type</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.terms.impl.SortImpl#getContainerAll <em>Container All</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.terms.impl.SortImpl#getContainerEmpty <em>Container Empty</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.terms.impl.SortImpl#getContainerPartition <em>Container Partition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
