    ...
    */
	...
	//getters giving HLAPI object
		...
		public OperatorDeclHLAPI getDeclarationHLAPI(){
			...
			if(object.getClass().equals(fr.lip6.move.pnml.symmetricnet.terms.impl.NamedOperatorImpl.class)){
				return new fr.lip6.move.pnml.symmetricnet.terms.hlapi.NamedOperatorHLAPI((fr.lip6.move.pnml.symmetricnet.terms.NamedOperator)object);
			}
			
			if(object.getClass().equals(fr.lip6.move.pnml.symmetricnet.finiteEnumerations.impl.FEConstantImpl.class)){
				return new fr.lip6.move.pnml.symmetricnet.finiteEnumerations.hlapi.FEConstantHLAPI((fr.lip6.move.pnml.symmetricnet.finiteEnumerations.FEConstant)object);
			}
			
			if(object.getClass().equals(fr.lip6.move.pnml.symmetricnet.partitions.impl.PartitionElementImpl.class)){
				return new fr.lip6.move.pnml.symmetricnet.partitions.hlapi.PartitionElementHLAPI((fr.lip6.move.pnml.symmetricnet.partitions.PartitionElement)object);
			}
