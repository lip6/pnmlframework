 ...
 */
package fr.lip6.move.pnml.symmetricnet.multisets.impl;
 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.multisets.impl.EmptyImpl#getRefsort <em>Refsort</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EmptyImpl extends MultisetOperatorImpl implements Empty {
	...
	public NotificationChain basicSetRefsort(Sort newRefsort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MultisetsPackage.EMPTY__REFSORT, oldRefsort, newRefsort);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setRefsort(Sort newRefsort) {
		if (newRefsort != refsort) {
			...
			if (refsort != null)
				msgs = ((InternalEObject) refsort).eInverseRemove(this, TermsPackage.SORT__CONTAINER_EMPTY, Sort.class,
						msgs);
			if (newRefsort != null)
				msgs = ((InternalEObject) newRefsort).eInverseAdd(this, TermsPackage.SORT__CONTAINER_EMPTY, Sort.class,
						msgs);
			msgs = basicSetRefsort(newRefsort, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MultisetsPackage.EMPTY__REFSORT, newRefsort,
					newRefsort));
	}
