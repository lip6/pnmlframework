 ...
 * <!-- end-user-doc -->
 * @see fr.lip6.move.pnml.symmetricnet.hlcorestructure.HlcorestructurePackage#getPNType()
 * @model
 * @generated
 */
public enum PNType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final PNType[] VALUES_ARRAY = new PNType[] { SYMNET, COREMODEL, PTNET, HLPN, };
