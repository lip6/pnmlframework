 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.RefPlaceImpl#getRef <em>Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RefPlaceImpl extends PlaceNodeImpl implements RefPlace {
	...
	protected EClass eStaticClass() {
		return HlcorestructurePackage.Literals.REF_PLACE;
	}
		...
		if (ref != null && ref.eIsProxy()) {
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, HlcorestructurePackage.REF_PLACE__REF,
							oldRef, ref));
			}
		}
		return ref;
	...
	public NotificationChain basicSetRef(PlaceNode newRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.REF_PLACE__REF, oldRef, newRef);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRef != ref) {
			...
			if (ref != null)
				msgs = ((InternalEObject) ref).eInverseRemove(this,
						HlcorestructurePackage.PLACE_NODE__REFERENCING_PLACES, PlaceNode.class, msgs);
			if (newRef != null)
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case HlcorestructurePackage.REF_PLACE__REF:
			if (ref != null)
				msgs = ((InternalEObject) ref).eInverseRemove(this,
						HlcorestructurePackage.PLACE_NODE__REFERENCING_PLACES, PlaceNode.class, msgs);
	...
	public void idRefHang(ArrayList<Object> oList) {
		...
		this.setRef((fr.lip6.move.pnml.symmetricnet.hlcorestructure.PlaceNode) oList.get(0));
