 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.NodeGraphicsImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.NodeGraphicsImpl#getDimension <em>Dimension</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.NodeGraphicsImpl#getFill <em>Fill</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.NodeGraphicsImpl#getLine <em>Line</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.NodeGraphicsImpl#getContainerNode <em>Container Node</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.NodeGraphicsImpl#getContainerPage <em>Container Page</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NodeGraphicsImpl extends GraphicsImpl implements NodeGraphics {
	...
	public NotificationChain basicSetPosition(Position newPosition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.NODE_GRAPHICS__POSITION, oldPosition, newPosition);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newPosition != position) {
			...
			if (position != null)
				msgs = ((InternalEObject) position).eInverseRemove(this,
						HlcorestructurePackage.POSITION__CONTAINER_PNODE_GRAPHICS, Position.class, msgs);
			if (newPosition != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.NODE_GRAPHICS__POSITION,
	...
	public NotificationChain basicSetDimension(Dimension newDimension, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.NODE_GRAPHICS__DIMENSION, oldDimension, newDimension);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newDimension != dimension) {
			...
			if (dimension != null)
				msgs = ((InternalEObject) dimension).eInverseRemove(this,
						HlcorestructurePackage.DIMENSION__CONTAINER_DNODE_GRAPHICS, Dimension.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.NODE_GRAPHICS__DIMENSION,
	...
	public NotificationChain basicSetFill(Fill newFill, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.NODE_GRAPHICS__FILL, oldFill, newFill);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newFill != fill) {
			...
			if (fill != null)
				msgs = ((InternalEObject) fill).eInverseRemove(this,
						HlcorestructurePackage.FILL__CONTAINER_NODE_GRAPHICS, Fill.class, msgs);
			if (newFill != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.NODE_GRAPHICS__FILL, newFill,
					newFill));
	}
	...
	public NotificationChain basicSetLine(Line newLine, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.NODE_GRAPHICS__LINE, oldLine, newLine);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newLine != line) {
			...
			if (line != null)
				msgs = ((InternalEObject) line).eInverseRemove(this,
						HlcorestructurePackage.LINE__CONTAINER_NODE_GRAPHICS, Line.class, msgs);
			if (newLine != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.NODE_GRAPHICS__LINE, newLine,
					newLine));
	}
	...
	public NotificationChain basicSetContainerNode(Node newContainerNode, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerNode,
				HlcorestructurePackage.NODE_GRAPHICS__CONTAINER_NODE, msgs);
		return msgs;
	}
	...
	public void setContainerNode(Node newContainerNode) {
		if (newContainerNode != eInternalContainer()
			...
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.NODE_GRAPHICS__CONTAINER_NODE,
	...
	public NotificationChain basicSetContainerPage(Page newContainerPage, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerPage,
				HlcorestructurePackage.NODE_GRAPHICS__CONTAINER_PAGE, msgs);
		return msgs;
	}
	...
	public void setContainerPage(Page newContainerPage) {
		if (newContainerPage != eInternalContainer()
			...
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.NODE_GRAPHICS__CONTAINER_PAGE,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case HlcorestructurePackage.NODE_GRAPHICS__CONTAINER_PAGE:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case HlcorestructurePackage.NODE_GRAPHICS__CONTAINER_NODE:
			return eInternalContainer().eInverseRemove(this, HlcorestructurePackage.NODE__NODEGRAPHICS, Node.class,
					msgs);
		case HlcorestructurePackage.NODE_GRAPHICS__CONTAINER_PAGE:
			return eInternalContainer().eInverseRemove(this, HlcorestructurePackage.PAGE__NODEGRAPHICS, Page.class,
					msgs);
		}
