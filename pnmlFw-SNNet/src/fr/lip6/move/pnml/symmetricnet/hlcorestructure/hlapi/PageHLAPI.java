...
public class PageHLAPI implements HLAPIClass,PnObjectHLAPI{
    ...
    */
	...
	//getters giving HLAPI object
		...
		public java.util.List<PnObjectHLAPI> getObjectsHLAPI(){
			...
			for (PnObject elemnt : getObjects()) {
				...
				if(elemnt.getClass().equals(fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PageImpl.class)){
					retour.add(new fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.PageHLAPI(
						(fr.lip6.move.pnml.symmetricnet.hlcorestructure.Page)elemnt
						));
					continue;
				}
				
				if(elemnt.getClass().equals(fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.ArcImpl.class)){
					retour.add(new fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.ArcHLAPI(
						(fr.lip6.move.pnml.symmetricnet.hlcorestructure.Arc)elemnt
						));
					continue;
				}
				
				if(elemnt.getClass().equals(fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PlaceImpl.class)){
					retour.add(new fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.PlaceHLAPI(
						(fr.lip6.move.pnml.symmetricnet.hlcorestructure.Place)elemnt
						));
					continue;
				}
				
				if(elemnt.getClass().equals(fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.RefTransitionImpl.class)){
					retour.add(new fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.RefTransitionHLAPI(
						(fr.lip6.move.pnml.symmetricnet.hlcorestructure.RefTransition)elemnt
						));
					continue;
				}
				
				if(elemnt.getClass().equals(fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.TransitionImpl.class)){
					retour.add(new fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.TransitionHLAPI(
						(fr.lip6.move.pnml.symmetricnet.hlcorestructure.Transition)elemnt
						));
					continue;
				}
				
				if(elemnt.getClass().equals(fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.RefPlaceImpl.class)){
					retour.add(new fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.RefPlaceHLAPI(
						(fr.lip6.move.pnml.symmetricnet.hlcorestructure.RefPlace)elemnt
						));
					continue;
				}
	...
	//Special getter for list of generics object, return only one object type.
		 ...
		 */
		public java.util.List<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.PageHLAPI> getObjects_hlcorestructure_PageHLAPI(){
			java.util.List<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.PageHLAPI> retour = new ArrayList<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.PageHLAPI>();
			for (PnObject elemnt : getObjects()) {
				if(elemnt.getClass().equals(fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PageImpl.class)){
					retour.add(new fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.PageHLAPI(
						(fr.lip6.move.pnml.symmetricnet.hlcorestructure.Page)elemnt
		 ...
		 * WARNING : this method can creates a lot of new object in memory.
		 */
		public java.util.List<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.ArcHLAPI> getObjects_hlcorestructure_ArcHLAPI(){
			java.util.List<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.ArcHLAPI> retour = new ArrayList<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.ArcHLAPI>();
			for (PnObject elemnt : getObjects()) {
				if(elemnt.getClass().equals(fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.ArcImpl.class)){
					retour.add(new fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.ArcHLAPI(
						(fr.lip6.move.pnml.symmetricnet.hlcorestructure.Arc)elemnt
		 ...
		 * WARNING : this method can creates a lot of new object in memory.
		 */
		public java.util.List<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.PlaceHLAPI> getObjects_hlcorestructure_PlaceHLAPI(){
			java.util.List<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.PlaceHLAPI> retour = new ArrayList<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.PlaceHLAPI>();
			for (PnObject elemnt : getObjects()) {
				if(elemnt.getClass().equals(fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PlaceImpl.class)){
					retour.add(new fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.PlaceHLAPI(
						(fr.lip6.move.pnml.symmetricnet.hlcorestructure.Place)elemnt
		 ...
		 * WARNING : this method can creates a lot of new object in memory.
		 */
		public java.util.List<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.RefTransitionHLAPI> getObjects_hlcorestructure_RefTransitionHLAPI(){
			java.util.List<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.RefTransitionHLAPI> retour = new ArrayList<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.RefTransitionHLAPI>();
			for (PnObject elemnt : getObjects()) {
				if(elemnt.getClass().equals(fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.RefTransitionImpl.class)){
					retour.add(new fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.RefTransitionHLAPI(
						(fr.lip6.move.pnml.symmetricnet.hlcorestructure.RefTransition)elemnt
		 ...
		 * WARNING : this method can creates a lot of new object in memory.
		 */
		public java.util.List<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.TransitionHLAPI> getObjects_hlcorestructure_TransitionHLAPI(){
			java.util.List<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.TransitionHLAPI> retour = new ArrayList<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.TransitionHLAPI>();
			for (PnObject elemnt : getObjects()) {
				if(elemnt.getClass().equals(fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.TransitionImpl.class)){
					retour.add(new fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.TransitionHLAPI(
						(fr.lip6.move.pnml.symmetricnet.hlcorestructure.Transition)elemnt
		 ...
		 * WARNING : this method can creates a lot of new object in memory.
		 */
		public java.util.List<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.RefPlaceHLAPI> getObjects_hlcorestructure_RefPlaceHLAPI(){
			java.util.List<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.RefPlaceHLAPI> retour = new ArrayList<fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.RefPlaceHLAPI>();
			for (PnObject elemnt : getObjects()) {
				if(elemnt.getClass().equals(fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.RefPlaceImpl.class)){
					retour.add(new fr.lip6.move.pnml.symmetricnet.hlcorestructure.hlapi.RefPlaceHLAPI(
						(fr.lip6.move.pnml.symmetricnet.hlcorestructure.RefPlace)elemnt
