 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.TransitionImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransitionImpl extends TransitionNodeImpl implements Transition {
	...
	protected EClass eStaticClass() {
		return HlcorestructurePackage.Literals.TRANSITION;
	}
	...
	public NotificationChain basicSetCondition(Condition newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.TRANSITION__CONDITION, oldCondition, newCondition);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject) condition).eInverseRemove(this,
						HlcorestructurePackage.CONDITION__CONTAINER_TRANSITION, Condition.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.TRANSITION__CONDITION,
	...
	public String toPNML() {
		...
		if (getCondition() != null) {
			...
			String top = getCondition().toPNML();
			if (!top.equals("")) {
	...
	public void fromPNML(OMElement locRoot, IdRefLinker idr) throws InnerBuildException, InvalidIDException,
		...
		for (Iterator iterator = locRoot.getChildElements(); iterator.hasNext();) {
			...
			if (type.getLocalName().equals("condition")) {
				Condition item;
				item = HlcorestructureFactoryImpl.eINSTANCE.createCondition();
				item.fromPNML(type, idr);
	...
	public boolean validateOCL(DiagnosticChain diagnostics) {
		...
		if (getCondition() != null) {
			retour &= getCondition().validateOCL(diagnostics);
		}
