 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.TransitionNodeImpl#getReferencingTransitions <em>Referencing Transitions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TransitionNodeImpl extends NodeImpl implements TransitionNode {
	...
	public List<RefTransition> getReferencingTransitions() {
		if (referencingTransitions == null) {
			referencingTransitions = new EObjectWithInverseResolvingEList<RefTransition>(RefTransition.class, this,
					HlcorestructurePackage.TRANSITION_NODE__REFERENCING_TRANSITIONS,
					HlcorestructurePackage.REF_TRANSITION__REF);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case HlcorestructurePackage.TRANSITION_NODE__REFERENCING_TRANSITIONS:
