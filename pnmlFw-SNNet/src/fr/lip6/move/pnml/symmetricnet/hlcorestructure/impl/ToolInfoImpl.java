 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.ToolInfoImpl#getTool <em>Tool</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.ToolInfoImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.ToolInfoImpl#getFormattedXMLBuffer <em>Formatted XML Buffer</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.ToolInfoImpl#getToolInfoGrammarURI <em>Tool Info Grammar URI</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.ToolInfoImpl#getContainerPetriNet <em>Container Petri Net</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.ToolInfoImpl#getContainerPnObject <em>Container Pn Object</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.ToolInfoImpl#getContainerLabel <em>Container Label</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.ToolInfoImpl#getToolInfoModel <em>Tool Info Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ToolInfoImpl extends MinimalEObjectImpl implements ToolInfo {
	...
	public void setFormattedXMLBuffer(StringBuffer newFormattedXMLBuffer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.TOOL_INFO__FORMATTED_XML_BUFFER, oldFormattedXMLBuffer, formattedXMLBuffer));
	}
	...
	public NotificationChain basicSetContainerPetriNet(PetriNet newContainerPetriNet, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerPetriNet,
				HlcorestructurePackage.TOOL_INFO__CONTAINER_PETRI_NET, msgs);
		return msgs;
	}
		...
		if (newContainerPetriNet != eInternalContainer()
			...
			if (newContainerPetriNet != null)
				msgs = ((InternalEObject) newContainerPetriNet).eInverseAdd(this,
						HlcorestructurePackage.PETRI_NET__TOOLSPECIFICS, PetriNet.class, msgs);
	...
	public NotificationChain basicSetContainerPnObject(PnObject newContainerPnObject, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerPnObject,
				HlcorestructurePackage.TOOL_INFO__CONTAINER_PN_OBJECT, msgs);
		return msgs;
	}
		...
		if (newContainerPnObject != eInternalContainer()
			...
			if (newContainerPnObject != null)
				msgs = ((InternalEObject) newContainerPnObject).eInverseAdd(this,
						HlcorestructurePackage.PN_OBJECT__TOOLSPECIFICS, PnObject.class, msgs);
	...
	public NotificationChain basicSetContainerLabel(Label newContainerLabel, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerLabel,
				HlcorestructurePackage.TOOL_INFO__CONTAINER_LABEL, msgs);
		return msgs;
	}
		...
		if (newContainerLabel != eInternalContainer()
			...
			if (newContainerLabel != null)
				msgs = ((InternalEObject) newContainerLabel).eInverseAdd(this,
						HlcorestructurePackage.LABEL__TOOLSPECIFICS, Label.class, msgs);
			msgs = basicSetContainerLabel(newContainerLabel, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.TOOL_INFO__CONTAINER_LABEL,
	...
	public NotificationChain basicSetToolInfoModel(AnyObject newToolInfoModel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.TOOL_INFO__TOOL_INFO_MODEL, oldToolInfoModel, newToolInfoModel);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newToolInfoModel != toolInfoModel) {
			...
			if (toolInfoModel != null)
				msgs = ((InternalEObject) toolInfoModel).eInverseRemove(this,
						HlcorestructurePackage.ANY_OBJECT__CONTAINER_TOOL_INFO, AnyObject.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.TOOL_INFO__TOOL_INFO_MODEL,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case HlcorestructurePackage.TOOL_INFO__CONTAINER_PETRI_NET:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetContainerPetriNet((PetriNet) otherEnd, msgs);
		case HlcorestructurePackage.TOOL_INFO__CONTAINER_PN_OBJECT:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetContainerPnObject((PnObject) otherEnd, msgs);
		case HlcorestructurePackage.TOOL_INFO__CONTAINER_LABEL:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case HlcorestructurePackage.TOOL_INFO__CONTAINER_PETRI_NET:
			return eInternalContainer().eInverseRemove(this, HlcorestructurePackage.PETRI_NET__TOOLSPECIFICS,
					PetriNet.class, msgs);
		case HlcorestructurePackage.TOOL_INFO__CONTAINER_PN_OBJECT:
			return eInternalContainer().eInverseRemove(this, HlcorestructurePackage.PN_OBJECT__TOOLSPECIFICS,
					PnObject.class, msgs);
		case HlcorestructurePackage.TOOL_INFO__CONTAINER_LABEL:
			return eInternalContainer().eInverseRemove(this, HlcorestructurePackage.LABEL__TOOLSPECIFICS, Label.class,
					msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case HlcorestructurePackage.TOOL_INFO__TOOL:
			return getTool();
