 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PetriNetImpl#getId <em>Id</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PetriNetImpl#getType <em>Type</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PetriNetImpl#getPages <em>Pages</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PetriNetImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PetriNetImpl#getToolspecifics <em>Toolspecifics</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PetriNetImpl#getContainerPetriNetDoc <em>Container Petri Net Doc</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PetriNetImpl#getDeclaration <em>Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PetriNetImpl extends MinimalEObjectImpl implements PetriNet {
	 ...
	 * @ordered
	 */
	protected static final PNType TYPE_EDEFAULT = PNType.SYMNET;
