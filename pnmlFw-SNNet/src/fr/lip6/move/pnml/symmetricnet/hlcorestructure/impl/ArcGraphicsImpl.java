 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.ArcGraphicsImpl#getPositions <em>Positions</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.ArcGraphicsImpl#getLine <em>Line</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.ArcGraphicsImpl#getContainerArc <em>Container Arc</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArcGraphicsImpl extends GraphicsImpl implements ArcGraphics {
	...
	public List<Position> getPositions() {
		if (positions == null) {
			positions = new EObjectContainmentWithInverseEList<Position>(Position.class, this,
					HlcorestructurePackage.ARC_GRAPHICS__POSITIONS,
					HlcorestructurePackage.POSITION__CONTAINER_ARC_GRAPHICS);
		}
		return positions;
	}
	...
	public NotificationChain basicSetLine(Line newLine, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.ARC_GRAPHICS__LINE, oldLine, newLine);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLine != line) {
			...
			if (line != null)
				msgs = ((InternalEObject) line).eInverseRemove(this,
						HlcorestructurePackage.LINE__CONTAINER_ARC_GRAPHICS, Line.class, msgs);
			if (newLine != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.ARC_GRAPHICS__LINE, newLine,
					newLine));
	}
	...
	public void setContainerArc(Arc newContainerArc) {
		if (newContainerArc != eInternalContainer()
			...
			if (newContainerArc != null)
				msgs = ((InternalEObject) newContainerArc).eInverseAdd(this, HlcorestructurePackage.ARC__ARCGRAPHICS,
						Arc.class, msgs);
			msgs = basicSetContainerArc(newContainerArc, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.ARC_GRAPHICS__CONTAINER_ARC,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case HlcorestructurePackage.ARC_GRAPHICS__POSITIONS:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case HlcorestructurePackage.ARC_GRAPHICS__CONTAINER_ARC:
			return eInternalContainer().eInverseRemove(this, HlcorestructurePackage.ARC__ARCGRAPHICS, Arc.class, msgs);
		}
	...
	public String toPNML() {
		...
		if (getPositions() != null) {
			...
			java.util.List<fr.lip6.move.pnml.symmetricnet.hlcorestructure.Position> items = getPositions();
