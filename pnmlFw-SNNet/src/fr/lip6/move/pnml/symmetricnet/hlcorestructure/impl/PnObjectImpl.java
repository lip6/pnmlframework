 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PnObjectImpl#getId <em>Id</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PnObjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PnObjectImpl#getToolspecifics <em>Toolspecifics</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PnObjectImpl#getContainerPage <em>Container Page</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class PnObjectImpl extends MinimalEObjectImpl implements PnObject {
	...
	protected EClass eStaticClass() {
		return HlcorestructurePackage.Literals.PN_OBJECT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.PN_OBJECT__ID, oldId, id));
	}
	...
	public NotificationChain basicSetName(Name newName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.PN_OBJECT__NAME, oldName, newName);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject) name).eInverseRemove(this,
						HlcorestructurePackage.NAME__CONTAINER_NAME_PN_OBJECT, Name.class, msgs);
			if (newName != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.PN_OBJECT__NAME, newName,
					newName));
	}
	...
	public List<ToolInfo> getToolspecifics() {
		if (toolspecifics == null) {
			toolspecifics = new EObjectContainmentWithInverseEList<ToolInfo>(ToolInfo.class, this,
					HlcorestructurePackage.PN_OBJECT__TOOLSPECIFICS,
					HlcorestructurePackage.TOOL_INFO__CONTAINER_PN_OBJECT);
		}
	...
	public NotificationChain basicSetContainerPage(Page newContainerPage, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerPage, HlcorestructurePackage.PN_OBJECT__CONTAINER_PAGE,
				msgs);
		return msgs;
	}
	...
	public void setContainerPage(Page newContainerPage) {
		if (newContainerPage != eInternalContainer()
			...
			if (newContainerPage != null)
				msgs = ((InternalEObject) newContainerPage).eInverseAdd(this, HlcorestructurePackage.PAGE__OBJECTS,
						Page.class, msgs);
			msgs = basicSetContainerPage(newContainerPage, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.PN_OBJECT__CONTAINER_PAGE,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case HlcorestructurePackage.PN_OBJECT__CONTAINER_PAGE:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case HlcorestructurePackage.PN_OBJECT__CONTAINER_PAGE:
			return eInternalContainer().eInverseRemove(this, HlcorestructurePackage.PAGE__OBJECTS, Page.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case HlcorestructurePackage.PN_OBJECT__ID:
			return getId();
		case HlcorestructurePackage.PN_OBJECT__NAME:
			return getName();
		case HlcorestructurePackage.PN_OBJECT__TOOLSPECIFICS:
