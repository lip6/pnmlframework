 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.CoordinateImpl#getX <em>X</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.CoordinateImpl#getY <em>Y</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CoordinateImpl extends MinimalEObjectImpl implements Coordinate {
	...
	protected EClass eStaticClass() {
		return HlcorestructurePackage.Literals.COORDINATE;
	}
	...
	public void setX(Integer newX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.COORDINATE__X, oldX, x));
	}
	...
	public void setY(Integer newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.COORDINATE__Y, oldY, y));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case HlcorestructurePackage.COORDINATE__X:
			return getX();
		case HlcorestructurePackage.COORDINATE__Y:
			return getY();
		}
