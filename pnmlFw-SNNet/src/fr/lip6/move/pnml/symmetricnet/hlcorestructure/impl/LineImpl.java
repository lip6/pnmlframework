 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.LineImpl#getColor <em>Color</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.LineImpl#getShape <em>Shape</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.LineImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.LineImpl#getContainerNodeGraphics <em>Container Node Graphics</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.LineImpl#getContainerArcGraphics <em>Container Arc Graphics</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.LineImpl#getContainerAnnotationGraphics <em>Container Annotation Graphics</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.LineImpl#getStyle <em>Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LineImpl extends MinimalEObjectImpl implements Line {
	...
	protected EClass eStaticClass() {
		return HlcorestructurePackage.Literals.LINE;
	}
	...
	public void setColor(CSS2Color newColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.LINE__COLOR, oldColor, color));
	}
	...
	public void setShape(LineShape newShape) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.LINE__SHAPE, oldShape, shape));
	}
	...
	public void setWidth(Integer newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.LINE__WIDTH, oldWidth, width));
	}
	...
	public void setContainerNodeGraphics(NodeGraphics newContainerNodeGraphics) {
		if (newContainerNodeGraphics != eInternalContainer()
			...
			if (newContainerNodeGraphics != null)
				msgs = ((InternalEObject) newContainerNodeGraphics).eInverseAdd(this,
						HlcorestructurePackage.NODE_GRAPHICS__LINE, NodeGraphics.class, msgs);
			msgs = basicSetContainerNodeGraphics(newContainerNodeGraphics, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.LINE__CONTAINER_NODE_GRAPHICS,
	...
	public NotificationChain basicSetContainerArcGraphics(ArcGraphics newContainerArcGraphics, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerArcGraphics,
				HlcorestructurePackage.LINE__CONTAINER_ARC_GRAPHICS, msgs);
		return msgs;
	}
		...
		if (newContainerArcGraphics != eInternalContainer()
			...
			if (newContainerArcGraphics != null)
				msgs = ((InternalEObject) newContainerArcGraphics).eInverseAdd(this,
						HlcorestructurePackage.ARC_GRAPHICS__LINE, ArcGraphics.class, msgs);
			msgs = basicSetContainerArcGraphics(newContainerArcGraphics, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.LINE__CONTAINER_ARC_GRAPHICS,
	...
	public NotificationChain basicSetContainerAnnotationGraphics(AnnotationGraphics newContainerAnnotationGraphics,
		...
		msgs = eBasicSetContainer((InternalEObject) newContainerAnnotationGraphics,
				HlcorestructurePackage.LINE__CONTAINER_ANNOTATION_GRAPHICS, msgs);
		return msgs;
	}
		...
		if (newContainerAnnotationGraphics != eInternalContainer()
			...
			if (newContainerAnnotationGraphics != null)
				msgs = ((InternalEObject) newContainerAnnotationGraphics).eInverseAdd(this,
						HlcorestructurePackage.ANNOTATION_GRAPHICS__LINE, AnnotationGraphics.class, msgs);
			msgs = basicSetContainerAnnotationGraphics(newContainerAnnotationGraphics, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.LINE__CONTAINER_ANNOTATION_GRAPHICS, newContainerAnnotationGraphics,
	...
	public void setStyle(LineStyle newStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.LINE__STYLE, oldStyle, style));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case HlcorestructurePackage.LINE__CONTAINER_NODE_GRAPHICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetContainerNodeGraphics((NodeGraphics) otherEnd, msgs);
		case HlcorestructurePackage.LINE__CONTAINER_ARC_GRAPHICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetContainerArcGraphics((ArcGraphics) otherEnd, msgs);
		case HlcorestructurePackage.LINE__CONTAINER_ANNOTATION_GRAPHICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case HlcorestructurePackage.LINE__CONTAINER_NODE_GRAPHICS:
			return eInternalContainer().eInverseRemove(this, HlcorestructurePackage.NODE_GRAPHICS__LINE,
					NodeGraphics.class, msgs);
		case HlcorestructurePackage.LINE__CONTAINER_ARC_GRAPHICS:
			return eInternalContainer().eInverseRemove(this, HlcorestructurePackage.ARC_GRAPHICS__LINE,
					ArcGraphics.class, msgs);
		case HlcorestructurePackage.LINE__CONTAINER_ANNOTATION_GRAPHICS:
			return eInternalContainer().eInverseRemove(this, HlcorestructurePackage.ANNOTATION_GRAPHICS__LINE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case HlcorestructurePackage.LINE__COLOR:
			return getColor();
		case HlcorestructurePackage.LINE__SHAPE:
			return getShape();
		case HlcorestructurePackage.LINE__WIDTH:
			return getWidth();
		case HlcorestructurePackage.LINE__CONTAINER_NODE_GRAPHICS:
		...
		case HlcorestructurePackage.LINE__STYLE:
			return getStyle();
		}
