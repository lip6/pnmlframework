 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.HLCoreAnnotationImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class HLCoreAnnotationImpl extends AnnotationImpl implements HLCoreAnnotation {
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.HL_CORE_ANNOTATION__TEXT,
					oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case HlcorestructurePackage.HL_CORE_ANNOTATION__TEXT:
			return getText();
		}
