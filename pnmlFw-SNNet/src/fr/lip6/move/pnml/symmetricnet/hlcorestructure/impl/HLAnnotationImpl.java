 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.HLAnnotationImpl#getStructure <em>Structure</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.HLAnnotationImpl#getContainerArc <em>Container Arc</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HLAnnotationImpl extends HLCoreAnnotationImpl implements HLAnnotation {
	...
	public NotificationChain basicSetStructure(Term newStructure, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.HL_ANNOTATION__STRUCTURE, oldStructure, newStructure);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setStructure(Term newStructure) {
		if (newStructure != structure) {
			...
			if (structure != null)
				msgs = ((InternalEObject) structure).eInverseRemove(this, TermsPackage.TERM__CONTAINER_HL_ANNOTATION,
						Term.class, msgs);
			if (newStructure != null)
				msgs = ((InternalEObject) newStructure).eInverseAdd(this, TermsPackage.TERM__CONTAINER_HL_ANNOTATION,
						Term.class, msgs);
			msgs = basicSetStructure(newStructure, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.HL_ANNOTATION__STRUCTURE,
	...
	public NotificationChain basicSetContainerArc(Arc newContainerArc, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerArc,
				HlcorestructurePackage.HL_ANNOTATION__CONTAINER_ARC, msgs);
		return msgs;
	}
	...
	public void setContainerArc(Arc newContainerArc) {
		if (newContainerArc != eInternalContainer()
			...
			if (newContainerArc != null)
				msgs = ((InternalEObject) newContainerArc).eInverseAdd(this, HlcorestructurePackage.ARC__HLINSCRIPTION,
						Arc.class, msgs);
			msgs = basicSetContainerArc(newContainerArc, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.HL_ANNOTATION__CONTAINER_ARC,
	...
	public void fromPNML(OMElement locRoot, IdRefLinker idr) throws InnerBuildException, InvalidIDException,
		...
		for (Iterator iterator = locRoot.getChildElements(); iterator.hasNext();) {
			...
			if (type.getLocalName().equals("structure")) {
				...
				fr.lip6.move.pnml.symmetricnet.terms.Term item = null;
