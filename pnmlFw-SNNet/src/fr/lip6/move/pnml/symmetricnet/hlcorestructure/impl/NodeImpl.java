 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.NodeImpl#getInArcs <em>In Arcs</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.NodeImpl#getOutArcs <em>Out Arcs</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.NodeImpl#getNodegraphics <em>Nodegraphics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NodeImpl extends PnObjectImpl implements Node {
	...
	protected EClass eStaticClass() {
		return HlcorestructurePackage.Literals.NODE;
	}
	...
	public List<Arc> getInArcs() {
		if (inArcs == null) {
			inArcs = new EObjectWithInverseResolvingEList<Arc>(Arc.class, this, HlcorestructurePackage.NODE__IN_ARCS,
					HlcorestructurePackage.ARC__TARGET);
		}
		return inArcs;
	}
	...
	public List<Arc> getOutArcs() {
		if (outArcs == null) {
			outArcs = new EObjectWithInverseResolvingEList<Arc>(Arc.class, this, HlcorestructurePackage.NODE__OUT_ARCS,
					HlcorestructurePackage.ARC__SOURCE);
		}
		return outArcs;
	}
	...
	public NotificationChain basicSetNodegraphics(NodeGraphics newNodegraphics, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.NODE__NODEGRAPHICS, oldNodegraphics, newNodegraphics);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newNodegraphics != nodegraphics) {
			...
			if (nodegraphics != null)
				msgs = ((InternalEObject) nodegraphics).eInverseRemove(this,
						HlcorestructurePackage.NODE_GRAPHICS__CONTAINER_NODE, NodeGraphics.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.NODE__NODEGRAPHICS,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case HlcorestructurePackage.NODE__IN_ARCS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getInArcs()).basicAdd(otherEnd, msgs);
		case HlcorestructurePackage.NODE__OUT_ARCS:
