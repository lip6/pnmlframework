 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PetriNetDocImpl#getNets <em>Nets</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.PetriNetDocImpl#getXmlns <em>Xmlns</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PetriNetDocImpl extends MinimalEObjectImpl implements PetriNetDoc {
	...
	public List<PetriNet> getNets() {
		if (nets == null) {
			nets = new EObjectContainmentWithInverseEList<PetriNet>(PetriNet.class, this,
					HlcorestructurePackage.PETRI_NET_DOC__NETS,
					HlcorestructurePackage.PETRI_NET__CONTAINER_PETRI_NET_DOC);
		}
		return nets;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case HlcorestructurePackage.PETRI_NET_DOC__NETS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case HlcorestructurePackage.PETRI_NET_DOC__NETS:
			return getNets();
		case HlcorestructurePackage.PETRI_NET_DOC__XMLNS:
			return getXmlns();
		}
	...
	public String toPNML() {
		...
		if (getNets() != null) {
			...
			java.util.List<fr.lip6.move.pnml.symmetricnet.hlcorestructure.PetriNet> items = getNets();
	...
	public void fromPNML(OMElement locRoot, IdRefLinker idr) throws InnerBuildException, InvalidIDException,
		...
		for (Iterator iterator = locRoot.getChildElements(); iterator.hasNext();) {
			...
			if (type.getLocalName().equals("net")) {
				PetriNet item;
				item = HlcorestructureFactoryImpl.eINSTANCE.createPetriNet();
