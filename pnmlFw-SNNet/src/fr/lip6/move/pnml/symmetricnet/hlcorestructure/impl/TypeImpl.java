 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.TypeImpl#getStructure <em>Structure</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.TypeImpl#getContainerPlace <em>Container Place</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public void fromPNML(OMElement locRoot, IdRefLinker idr) throws InnerBuildException, InvalidIDException,
		...
		for (Iterator iterator = locRoot.getChildElements(); iterator.hasNext();) {
			...
			if (type.getLocalName().equals("structure")) {
				...
				fr.lip6.move.pnml.symmetricnet.terms.Sort item = null;
