 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.AnnotationGraphicsImpl#getOffset <em>Offset</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.AnnotationGraphicsImpl#getFill <em>Fill</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.AnnotationGraphicsImpl#getLine <em>Line</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.AnnotationGraphicsImpl#getFont <em>Font</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.AnnotationGraphicsImpl#getContainerAnnotation <em>Container Annotation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnnotationGraphicsImpl extends GraphicsImpl implements AnnotationGraphics {
	...
	protected EClass eStaticClass() {
		return HlcorestructurePackage.Literals.ANNOTATION_GRAPHICS;
	}
	...
	public NotificationChain basicSetOffset(Offset newOffset, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.ANNOTATION_GRAPHICS__OFFSET, oldOffset, newOffset);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newOffset != offset) {
			...
			if (offset != null)
				msgs = ((InternalEObject) offset).eInverseRemove(this,
						HlcorestructurePackage.OFFSET__CONTAINER_ANNOTATION_GRAPHICS, Offset.class, msgs);
			if (newOffset != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.ANNOTATION_GRAPHICS__OFFSET,
					newOffset, newOffset));
	}
	...
	public NotificationChain basicSetFill(Fill newFill, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.ANNOTATION_GRAPHICS__FILL, oldFill, newFill);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newFill != fill) {
			...
			if (fill != null)
				msgs = ((InternalEObject) fill).eInverseRemove(this,
						HlcorestructurePackage.FILL__CONTAINER_ANNOTATION_GRAPHICS, Fill.class, msgs);
			if (newFill != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.ANNOTATION_GRAPHICS__FILL,
					newFill, newFill));
	}
	...
	public NotificationChain basicSetLine(Line newLine, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.ANNOTATION_GRAPHICS__LINE, oldLine, newLine);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newLine != line) {
			...
			if (line != null)
				msgs = ((InternalEObject) line).eInverseRemove(this,
						HlcorestructurePackage.LINE__CONTAINER_ANNOTATION_GRAPHICS, Line.class, msgs);
			if (newLine != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.ANNOTATION_GRAPHICS__LINE,
					newLine, newLine));
	}
	...
	public NotificationChain basicSetFont(Font newFont, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.ANNOTATION_GRAPHICS__FONT, oldFont, newFont);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newFont != font) {
			...
			if (font != null)
				msgs = ((InternalEObject) font).eInverseRemove(this,
						HlcorestructurePackage.FONT__CONTAINER_ANNOTATION_GRAPHICS, Font.class, msgs);
			if (newFont != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, HlcorestructurePackage.ANNOTATION_GRAPHICS__FONT,
					newFont, newFont));
	}
	...
	public Annotation getContainerAnnotation() {
		if (eContainerFeatureID() != HlcorestructurePackage.ANNOTATION_GRAPHICS__CONTAINER_ANNOTATION)
			return null;
	...
	public NotificationChain basicSetContainerAnnotation(Annotation newContainerAnnotation, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newContainerAnnotation,
				HlcorestructurePackage.ANNOTATION_GRAPHICS__CONTAINER_ANNOTATION, msgs);
		return msgs;
	}
		...
		if (newContainerAnnotation != eInternalContainer()
			...
			if (newContainerAnnotation != null)
				msgs = ((InternalEObject) newContainerAnnotation).eInverseAdd(this,
						HlcorestructurePackage.ANNOTATION__ANNOTATIONGRAPHICS, Annotation.class, msgs);
			msgs = basicSetContainerAnnotation(newContainerAnnotation, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.ANNOTATION_GRAPHICS__CONTAINER_ANNOTATION, newContainerAnnotation,
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case HlcorestructurePackage.ANNOTATION_GRAPHICS__CONTAINER_ANNOTATION:
			return eInternalContainer().eInverseRemove(this, HlcorestructurePackage.ANNOTATION__ANNOTATIONGRAPHICS,
	...
	public void fromPNML(OMElement locRoot, IdRefLinker idr) throws InnerBuildException, InvalidIDException,
		...
		for (Iterator iterator = locRoot.getChildElements(); iterator.hasNext();) {
			...
			if (type.getLocalName().equals("offset")) {
				Offset item;
				item = HlcorestructureFactoryImpl.eINSTANCE.createOffset();
			...
			if (type.getLocalName().equals("font")) {
				Font item;
				item = HlcorestructureFactoryImpl.eINSTANCE.createFont();
				item.fromPNML(type, idr);
