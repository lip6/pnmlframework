 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.ArcImpl#getSource <em>Source</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.ArcImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.ArcImpl#getArcgraphics <em>Arcgraphics</em>}</li>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.ArcImpl#getHlinscription <em>Hlinscription</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArcImpl extends PnObjectImpl implements Arc {
	...
	public void idRefHang(ArrayList<Object> oList) {
		...
		this.setSource((fr.lip6.move.pnml.symmetricnet.hlcorestructure.Node) oList.get(0));

		this.setTarget((fr.lip6.move.pnml.symmetricnet.hlcorestructure.Node) oList.get(1));
