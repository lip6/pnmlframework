 ...
 * <ul>
 *   <li>{@link fr.lip6.move.pnml.symmetricnet.hlcorestructure.impl.DimensionImpl#getContainerDNodeGraphics <em>Container DNode Graphics</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DimensionImpl extends CoordinateImpl implements Dimension {
	...
	protected EClass eStaticClass() {
		return HlcorestructurePackage.Literals.DIMENSION;
	}
	...
	public NotificationChain basicSetContainerDNodeGraphics(NodeGraphics newContainerDNodeGraphics,
		...
		msgs = eBasicSetContainer((InternalEObject) newContainerDNodeGraphics,
				HlcorestructurePackage.DIMENSION__CONTAINER_DNODE_GRAPHICS, msgs);
		return msgs;
	}
		...
		if (newContainerDNodeGraphics != eInternalContainer()
			...
			if (newContainerDNodeGraphics != null)
				msgs = ((InternalEObject) newContainerDNodeGraphics).eInverseAdd(this,
						HlcorestructurePackage.NODE_GRAPHICS__DIMENSION, NodeGraphics.class, msgs);
			msgs = basicSetContainerDNodeGraphics(newContainerDNodeGraphics, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					HlcorestructurePackage.DIMENSION__CONTAINER_DNODE_GRAPHICS, newContainerDNodeGraphics,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case HlcorestructurePackage.DIMENSION__CONTAINER_DNODE_GRAPHICS:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case HlcorestructurePackage.DIMENSION__CONTAINER_DNODE_GRAPHICS:
			return eInternalContainer().eInverseRemove(this, HlcorestructurePackage.NODE_GRAPHICS__DIMENSION,
