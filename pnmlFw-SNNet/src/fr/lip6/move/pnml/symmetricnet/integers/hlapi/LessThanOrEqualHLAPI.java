...
public class LessThanOrEqualHLAPI implements HLAPIClass,TermHLAPI,OperatorHLAPI{
	 ...
	 */
	private fr.lip6.move.pnml.symmetricnet.integers.LessThanOrEqual item;
    ...
    */
	 ...
	 */
	public LessThanOrEqualHLAPI(fr.lip6.move.pnml.symmetricnet.integers.LessThanOrEqual lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public fr.lip6.move.pnml.symmetricnet.integers.LessThanOrEqual getContainedItem(){
		return item;
	}
