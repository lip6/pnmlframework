...
public class GreaterThanHLAPI implements HLAPIClass,TermHLAPI,OperatorHLAPI{
	 ...
	 */
	private fr.lip6.move.pnml.symmetricnet.integers.GreaterThan item;
    ...
    */
	 ...
	 */
	public GreaterThanHLAPI(fr.lip6.move.pnml.symmetricnet.integers.GreaterThan lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public fr.lip6.move.pnml.symmetricnet.integers.GreaterThan getContainedItem(){
		return item;
	}
