...
public class GreaterThanOrEqualHLAPI implements HLAPIClass,TermHLAPI,OperatorHLAPI{
	 ...
	 */
	private fr.lip6.move.pnml.symmetricnet.integers.GreaterThanOrEqual item;
    ...
    */
	 ...
	 */
	public GreaterThanOrEqualHLAPI(fr.lip6.move.pnml.symmetricnet.integers.GreaterThanOrEqual lowLevelAPI){
		item = lowLevelAPI;
	}
	 ...
	 */
	public fr.lip6.move.pnml.symmetricnet.integers.GreaterThanOrEqual getContainedItem(){
		return item;
	}
